...
secondary_topics:
- models/multimodal
summary: Sentence Transformers v5+ adds multimodal embedding and reranker models (shared
  text/image embedding space, mixed-modality cross-encoder scoring) for visual document
  retrieval, cross-modal search and multimodal RAG; covers the API and model choices.
triage: null
skip_reason: null
source: huggingface
...
fetched: '2026-07-14T22:08:47Z'
classifier: claude
taxonomy_rev: 1
words: 2906
content_sha256: 6baa9ebfb44ff23715060ffeebeb54a93a9e821d2e614d007b7a90a408381936
---

# Multimodal Embedding & Reranker Models with Sentence Transformers

Sentence Similarity •  8B • Updated   •  76  •  23  
...
If you want to train your own multimodal models, check out the companion blogpost:
...
- [What are Multimodal Models?](https://huggingface.co#what-are-multimodal-models)
- [Installation](https://huggingface.co#installation)
- [Multimodal Embedding Models](https://huggingface.co#multimodal-embedding-models)
- [Multimodal Reranker Models](https://huggingface.co#multimodal-reranker-models)
- [Retrieve and Rerank](https://huggingface.co#retrieve-and-rerank)
- [Input Formats and Configuration](https://huggingface.co#input-formats-and-configuration)
- [Supported Models](https://huggingface.co#supported-models)
...
`revision`argument for now if the integration pull requests for the model is still pending. Once they're merged, you'll be able to load them without specifying a revision, like above.

The model automatically detects which modalities it supports, so there's nothing extra to configure. See [Processor and Model kwargs](https://huggingface.co#processor-and-model-kwargs) if you want to control things like image resolution or model precision.

With a multimodal model loaded, [ model.encode()](https://sbert.net/docs/package_reference/sentence_transformer/SentenceTransformer.html#sentence_transformers.SentenceTransformer.encode) accepts images alongside text. Images can be provided as URLs, local file paths, or PIL Image objects (see 
...
For retrieval tasks, [ encode_query()](https://sbert.net/docs/package_reference/sentence_transformer/SentenceTransformer.html#sentence_transformers.SentenceTransformer.encode_query) and 

`encode_document()``encode_query()` / `encode_document()` automatically load and apply the correct one:- `encode_query()`uses the model's- `"query"`prompt (if available) and sets- `task="query"`.
...
You can also check which modalities a reranker supports using [ modalities](https://sbert.net/docs/package_reference/cross_encoder/cross_encoder.html#sentence_transformers.cross_encoder.CrossEncoder.modalities) and 
...
You can check which modalities a model supports using the [ modalities](https://sbert.net/docs/package_reference/sentence_transformer/SentenceTransformer.html#sentence_transformers.SentenceTransformer.modalities) property and 
...
`tokenizer_kwargs`has been renamed to`processor_kwargs`to reflect that multimodal models use processors rather than just tokenizers. The old name is still accepted but deprecated.
...
| [LCO-Embedding/LCO-Embedding-Omni-3B](https://huggingface.co/LCO-Embedding/LCO-Embedding-Omni-3B) | 5B | Text, Image, Audio, Video | No `revision`needed | 
| [LCO-Embedding/LCO-Embedding-Omni-7B](https://huggingface.co/LCO-Embedding/LCO-Embedding-Omni-7B) | 9B | Text, Image, Audio, Video | No `revision`needed | 
| [BidirLM/BidirLM-Omni-2.5B-Embedding](https://huggingface.co/BidirLM/BidirLM-Omni-2.5B-Embedding) | 2.5B | Text, Image, Audio | No `revision`needed | 
...
| [BAAI/BGE-VL-v1.5-zs](https://huggingface.co/BAAI/BGE-VL-v1.5-zs) | 8B | Text, Image | No `revision`needed | 
| [BAAI/BGE-VL-v1.5-mmeb](https://huggingface.co/BAAI/BGE-VL-v1.5-mmeb) | 8B | Text, Image | No `revision`needed | 
| [BAAI/BGE-VL-Screenshot](https://huggingface.co/BAAI/BGE-VL-Screenshot) | 4B | Text, Image | No `revision`needed | 
| [royokong/e5-v](https://huggingface.co/royokong/e5-v) | 8B | Text, Image | No `revision`needed | 
| [eagerworks/eager-embed-v1](https://huggingface.co/eagerworks/eager-embed-v1) | 4B | Text, Image | `revision="refs/pr/2"` | 
| [nomic-ai/nomic-embed-multimodal-3b](https://huggingface.co/nomic-ai/nomic-embed-multimodal-3b) | 5B | Text, Image | `revision="refs/pr/4"` | 
| [nomic-ai/nomic-embed-multimodal-7b](https://huggingface.co/nomic-ai/nomic-embed-multimodal-7b) | 9B | Text, Image | `revision="refs/pr/3"` | 
| [Haon-Chen/e5-omni-3B](https://huggingface.co/Haon-Chen/e5-omni-3B) | 5B | Text, Image, Audio, Video | `revision="refs/pr/2"` | 
| [Haon-Chen/e5-omni-7B](https://huggingface.co/Haon-Chen/e5-omni-7B) | 9B | Text, Image, Audio, Video | `revision="refs/pr/1"` | 
...
| [ContextualAI/ctxl-rerank-v2-instruct-multilingual-1b](https://huggingface.co/ContextualAI/ctxl-rerank-v2-instruct-multilingual-1b) | 1B | `revision="refs/pr/2"` | 
| [ContextualAI/ctxl-rerank-v2-instruct-multilingual-2b](https://huggingface.co/ContextualAI/ctxl-rerank-v2-instruct-multilingual-2b) | 3B | `revision="refs/pr/1"` | 
| [ContextualAI/ctxl-rerank-v2-instruct-multilingual-6b](https://huggingface.co/ContextualAI/ctxl-rerank-v2-instruct-multilingual-6b) | 7B | `revision="refs/pr/1"` | 
...
- [Binary and Scalar Embedding Quantization for Significantly Faster & Cheaper Retrieval](https://huggingface.co/blog/embedding-quantization): post-training compression of embedding vectors.
 ...
 Sentence Similarity •  0.1B • Updated   •  2.72k  •  31 

 Sentence Similarity •  0.4B • Updated   •  3.17k  •  23 

 Sentence Similarity •  2B • Updated   •  704  •  45 

 Feature Extraction •  5B • Updated   •  7.19k  •  15 

 Feature Extraction •  9B • Updated   •  1.15k  •  26 

 Sentence Similarity •  2B • Updated   •  1.32M  •  429 

 Sentence Similarity •  8B • Updated   •  1.48M  •  455 

 Sentence Similarity •  2B • Updated   •  127k  •  92 

 Sentence Similarity •  5B • Updated   •  3.8k  •  126 
...
multimodalnlpcommunity
 ...
 April 16, 2026 nlpcommunityresearch
...
- +5
 ...
 May 24, 2024 Cool Intro to multimodality in sentenceTransforners! Thanks!
