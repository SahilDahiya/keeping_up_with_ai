...
secondary_topics:
- models/multimodal
summary: vdr-2b-multi-v1 is a ColPali-style visual document retrieval embedding model
  trained on a new 500k multilingual query/page synthetic dataset across 5 languages,
  beating the English-only baseline on multilingual and cross-lingual document retrieval
  benchmarks.
triage: null
skip_reason: null
source: huggingface
...
fetched: '2026-07-14T22:09:17Z'
classifier: claude
taxonomy_rev: 1
words: 2473
content_sha256: 3b55661fe0e1cfafd01617403c0f5f9e9cf03d03cabb6bbd8cde73280f21fad9
---

# Visual Document Retrieval Goes Multilingual

Visual Document Retrieval •  Updated   •  26k  •  68  

# 
	[
		
	](https://huggingface.co#visual-document-retrieval-goes-multilingual)
...
[  Upvote 77 ](https://huggingface.co/login?next=%2Fblog%2Fvdr-2b-multilingual)

![Marco Cimolai's avatar](https://cdn-avatars.huggingface.co/v1/production/uploads/608c698a33a86d1a1a84b4da/9TjyQyys2Zn_9J_ABEb8O.jpeg) 

  [Marco Cimolaimarco    ](https://huggingface.co/marco)

![LlamaIndex's avatar](https://cdn-avatars.huggingface.co/v1/production/uploads/6424f2be988b8b19edba5b73/NHVYrW0BnfWgrxt6Thh9C.png)

[llamaindex](https://huggingface.co/llamaindex)

![Logan Markewich's avatar](https://cdn-avatars.huggingface.co/v1/production/uploads/6424f2be988b8b19edba5b73/pgJK3TMNZWJRlAXP3vSCu.jpeg) 

  [Logan MarkewichcheesyFishes    ](https://huggingface.co/cheesyFishes)

![LlamaIndex's avatar](https://cdn-avatars.huggingface.co/v1/production/uploads/6424f2be988b8b19edba5b73/NHVYrW0BnfWgrxt6Thh9C.png)

[llamaindex](https://huggingface.co/llamaindex)

TL;DR: We present[, the best multilingual embedding model for visual document retrieval. We also release its English-only twin](https://huggingface.co/llamaindex/vdr-2b-multi-v1)`vdr-2b-multi-v1`[and open-source the new](https://huggingface.co/llamaindex/vdr-2b-v1)`vdr-2b-v1`[dataset. With 500k high-quality samples, it's the largest open-source multilingual synthetic dataset for visual document retrieval.](https://huggingface.co/datasets/llamaindex/vdr-multilingual-train)`vdr-multilingual-train`
...
The `vdr-2b-multi-v1` model is based on [ MrLight/dse-qwen2-2b-mrl-v1](https://huggingface.co/MrLight/dse-qwen2-2b-mrl-v1) and is trained on an extensive self-made dataset of multilingual query-image pairs. This model is built in collaboration with LlamaIndex and is the next iteration of 

[. Our](https://huggingface.co/marco/mcdse-2b-v1)

`mcdse-2b-v1``vdr-2b-multi-v1` extends and improves the learning and methods used to train it, resulting in a much more powerful and better model.- **Trained on 🇮🇹 Italian, 🇪🇸 Spanish, 🇬🇧 English, 🇫🇷 French and 🇩🇪 German:**Together they form a new large, open-source, multilingual training dataset of 500k high-quality samples.
...
`vdr-2b-multi-v1`now, available on this[Hugging Face Space](https://huggingface.co/spaces/llamaindex/multimodal_vdr_demo)!
...
### 
	...
	](https://huggingface.co#data-gathering)
...
### 
	...
	](https://huggingface.co#synthetic-generation)
...
### 
	...
	](https://huggingface.co#filtering-and-hard-negative-mining)
...
### 
	...
	](https://huggingface.co#faster-inference)
...
### 
	...
	](https://huggingface.co#mrl-and-binary-embeddings)
...
#### 
	...
	](https://huggingface.co#ndcg5-float)
...
#### 
	...
	](https://huggingface.co#ndcg5-binary)
