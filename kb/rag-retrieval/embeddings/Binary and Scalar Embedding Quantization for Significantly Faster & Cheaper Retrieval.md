...
summary: Binary (1-bit) and int8 scalar quantization of embeddings cuts retrieval
  memory/cost ~32x and ~4x while retaining ~92-96% of performance; covers rescoring
  with float embeddings and combining binary search + int8 rescoring in FAISS/usearch.
triage: null
skip_reason: null
source: huggingface
url: https://huggingface.co/blog/embedding-quantization
author: Aamir Shakir; Tom Aarsen; SeanLee
published: '2024-03-22'
fetched: '2026-07-14T22:06:36Z'
classifier: claude
taxonomy_rev: 1
words: 3324
content_sha256: 61a64227a5a76a9df3c5a1887cb78c17f7d51f606c6e1ab481d8cc95f8b85de2
---
...
- [Why Embeddings?](https://huggingface.co#why-embeddings)
- [Improving scalability](https://huggingface.co#improving-scalability)
...
| `int8` | 2.99x speedup | 3.66xspeedup | 4.8x speedup | 
| `binary` | 15.05x speedup | 24.76xspeedup | 45.8x speedup | 
...
- [Train 400x faster Static Embedding Models with Sentence Transformers](https://huggingface.co/blog/static-embeddings): another route to cheap retrieval, trading model quality for throughput instead of bits-per-dim.
 ...
 Sentence Similarity •  Updated   •  1.81M  •  156 

 Feature Extraction •  0.3B • Updated   •  166k  •  43 
