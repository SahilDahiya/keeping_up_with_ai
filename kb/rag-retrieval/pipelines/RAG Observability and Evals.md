...
summary: Explains observability and evaluation for RAG systems, including tracing
  retrieval/generation steps and measuring answer and context quality.
source: langfuse
url: https://langfuse.com/blog/2025-10-28-rag-observability-and-evals
author: null
published: '2025-10-28'
fetched: '2026-07-11T04:35:47Z'
classifier: codex
taxonomy_rev: 1
words: 1279
content_sha256: 8d9aab18b8a96e35ec88caff7b65a5872633ade39f390d900d8de4606f49de15
---
...
[1. Tracing RAG Applications](https://langfuse.com#1-tracing-rag-applications)
...
![Tracing RAG Applications](https://langfuse.com/_next/image?url=%2Fimages%2Fblog%2F2025-10-28-rag-observability-and-evals%2Frag-trace.png&w=3840&q=75)
...
```
[2. Running Evaluations on RAG Pipelines](https://langfuse.com#2-running-evaluations-on-rag-pipelines)

[2.1 Evaluating RAG Components: Optimizing Chunk Size](https://langfuse.com#21-evaluating-rag-components-optimizing-chunk-size)
...
To start, you need a dataset of questions and expected answers. You create this directly in the UI by adding items to a [Langfuse Dataset](https://langfuse.com/docs/evaluation/experiments/datasets). Each item contains a question as input and the expected answer as the reference output. We also have a [cookbook](https://langfuse.com/guides/cookbook/example_synthetic_datasets#example-5-rag-dataset-generation) that shows you how to generate a dataset of questions and expected answers.

![Creating a Dataset](https://langfuse.com/_next/image?url=%2Fimages%2Fblog%2F2025-10-28-rag-observability-and-evals%2Frag-dataset.png&w=3840&q=75)


With your dataset ready, you can run experiments with [Langfuse's Experiment Runner](https://langfuse.com/docs/evaluation/experiments/experiments-via-sdk) testing different chunk configurations. You can make a combination of chunk size and chunk overlap to test different strategies. For example:
...
![Experiments Results](https://langfuse.com/_next/image?url=%2Fimages%2Fblog%2F2025-10-28-rag-observability-and-evals%2Fchunk-size-performance.png&w=3840&q=75)


[2.2 Evaluating the Complete RAG Application](https://langfuse.com#22-evaluating-the-complete-rag-application)
...
![Complete RAG Pipeline Evaluation](https://langfuse.com/_next/image?url=%2Fimages%2Fblog%2F2025-10-28-rag-observability-and-evals%2Frelevance-result.png&w=3840&q=75)
...
[3. Conclusion](https://langfuse.com#3-conclusion)
...
[Acknowledgments](https://langfuse.com#acknowledgments)
