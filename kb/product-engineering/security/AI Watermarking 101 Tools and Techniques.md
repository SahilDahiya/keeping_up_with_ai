...
subtopic: security
secondary_topics: []
summary: 'Surveys watermarking for AI-generated content: for images, in-generation
  methods (Stable Signature) vs post-hoc (Truepic/Imatag, C2PA metadata); for LLM
  text, logit-biasing green/red token lists at sampling time and the detection statistics
  behind them, plus SynthID-Text in transformers. Discusses robustness to editing
  and the short-text detection confidence limit.'
triage: null
skip_reason: null
source: huggingface
url: https://huggingface.co/blog/watermarking
author: Sasha Luccioni; Yacine Jernite; Derek Thomas; Emily Witko; Ezi Ozoani; Josef
  Fukano; Vaibhav Srivastav; Brigitte Tousignant; Margaret Mitchell
published: '2024-02-26'
fetched: '2026-07-14T22:04:42Z'
classifier: claude
taxonomy_rev: 1
words: 1894
content_sha256: b33bf2833d303a3d4236598851118ea07d0f58cbe00ab4d937c6bef3b2ebd9a7
---

# AI Watermarking 101: Tools and Techniques

Text-to-Image •  Updated   •  794k  •  2.6k  
