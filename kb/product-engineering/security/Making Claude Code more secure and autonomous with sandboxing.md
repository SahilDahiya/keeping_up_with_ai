...
secondary_topics:
- agents/tool-use
summary: Introduces sandboxed bash execution and filesystem/network isolation in Claude
  Code, reducing permission prompts while containing what the agent can touch.
source: anthropic-engineering
url: https://www.anthropic.com/engineering/claude-code-sandboxing
author: null
published: '2025-10-20'
fetched: '2026-07-11T03:45:05Z'
classifier: claude
taxonomy_rev: 1
words: 1000
content_sha256: c20b35c4ee6c3aebdd7aaa8a4ef8977cb9a36a15cff52ceaf44cd082aada6411
---
...
- Run `/sandbox` in Claude and check out [our docs](https://docs.claude.com/en/docs/claude-code/sandboxing)on how to configure this sandbox.
- Go to [claude.com/code](http://claude.ai/redirect/website.v1.a23c2e9e-ccfe-4a56-aed3-c4cdbd962cc4/code)to try out Claude Code on the web.
