...
secondary_topics:
- models/benchmarks
summary: 'Cloudflare''s findings from running Anthropic''s Mythos Preview (Project
  Glasswing) against 50+ of its own repos: the model constructs multi-primitive exploit
  chains and compiles/runs its own proofs-of-concept, but its organic refusals are
  inconsistent and false-positive rates spike in C/C++ codebases.'
source: cloudflare-ai
url: https://blog.cloudflare.com/cyber-frontier-models/
author: Grant Bourzikas
published: '2026-05-18'
fetched: '2026-07-11T04:13:08Z'
classifier: claude
taxonomy_rev: 1
words: 2730
content_sha256: acce123c249c5fd972ad14a209ddbc3352b58856359ba4d365db3471c37f5bf5
---
...
If your team is doing similar work and would like to compare notes, reach out to us at [ security-ai-research@cloudflare.com](https://blog.cloudflare.com).
