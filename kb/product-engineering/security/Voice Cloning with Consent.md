...
subtopic: security
secondary_topics: []
summary: 'Proposes a ''voice consent gate'': before any voice cloning runs, the speaker
  must record a spoken consent phrase, which is verified with ASR (and speaker verification)
  against the same audio used for cloning — a concrete, implementable design pattern
  (with a demo Space and code) for making consent a hard gate rather than a checkbox.'
triage: null
skip_reason: null
source: huggingface
...
fetched: '2026-07-14T22:03:41Z'
classifier: claude
taxonomy_rev: 1
words: 1327
content_sha256: 75afacb7ea8f85bfe3aa854e7b64ffb119e97d56499786a8fc4a2de3058e6e08
---
...
[  Upvote 41 ](https://huggingface.co/login?next=%2Fblog%2Fvoice-consent-gate)

![Margaret Mitchell's avatar](https://cdn-avatars.huggingface.co/v1/production/uploads/1626214544196-60c757ea5f9a76ab3f844f12.png) 

  ![Lucie-Aimée Kaffee's avatar](https://cdn-avatars.huggingface.co/v1/production/uploads/noauth/ux7NRFAbgnlIVNh-Cbv9s.png) 

  *In this blog post, we introduce the idea of a 'voice consent gate' to support voice cloning with consent. We provide*

[an example Space](https://huggingface.co/spaces/society-ethics/RepeatAfterMe)and[accompanying code](https://huggingface.co/spaces/society-ethics/RepeatAfterMe/tree/main)to start the ball rolling on the idea.![Line-drawing/clipart of a gate, where the family name says Consent](https://huggingface.co/spaces/society-ethics/RepeatAfterMe/resolve/main/assets/voice_consent_gate.png) 
...
- An *automatic speech recognition (ASR) system*that recognizes the sentence conveying consent.
...
[Check our demo out here!](https://huggingface.co/spaces/society-ethics/RepeatAfterMe)You can copy the code to suit your own use.
