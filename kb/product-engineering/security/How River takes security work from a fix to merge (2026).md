...
# How River takes security work from a fix to merge (2026)
...
This is the part of agentic patching we’ve seen discussed the least: operating the remediation pipeline around the diff. It’s also where the [defensive asymmetry](https://stratechery.com/2026/autonomy-and-innovation/) becomes concrete. Attackers can tolerate repeated failure but defenders, especially organizations, have to preserve production-intended behavior with every fix.
...
![River diagram](https://cdn.shopify.com/s/files/1/0779/4361/files/River_diagram_2.png?v=1788366621)
