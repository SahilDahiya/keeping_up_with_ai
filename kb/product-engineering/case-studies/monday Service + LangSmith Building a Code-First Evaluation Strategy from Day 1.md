...
summary: monday Service case study on building a code-first evaluation strategy for
  AI product quality from day one.
source: langchain
url: https://www.langchain.com/blog/customers-monday
author: The LangChain Team
published: '2026-02-18'
fetched: '2026-07-11T04:39:55Z'
classifier: codex
taxonomy_rev: 1
words: 1802
content_sha256: 10683d1573357b62dd1a8f4943260ce989555f51c30728fe02df03853d6fe84c
---

# monday Service + LangSmith: Building a Code-First Evaluation Strategy from Day 1

![](https://cdn.prod.website-files.com/65c81e88c254bb0f97633a71/69cba9e2d3aab32815f7cb48_3--2-.png)
...
[ monday Service](https://monday.com/lp/service/blog-contactus?ref=blog.langchain.com) is an AI Native Enterprise Service Management (ESM) platform designed to automate and resolve inquiries across all service departments. When building our new

[AI service workforce](https://monday.com/lp/service/blog-contactus?ref=blog.langchain.com)(a workforce of customizable,

**role-based**AI agents that take the ticket load off human reps), we embedded evaluations into the development cycle from the start instead of waiting for Alpha users to find the gaps.
...
- **LLM-as-a-Judge:**Semantic grading against a "Golden Dataset". We leverage open-source libraries like- **OpenEvals**- **AgentEvals**- **correctness**and- **groundedness**.
...
We found a perfect fit in **LangSmith's **[ Multi-Turn Evaluator](https://docs.langchain.com/langsmith/online-evaluations?ref=blog.langchain.com#configure-multi-turn-online-evaluators), which leverages

[to score end-to-end threads. Instead of evaluating individual runs in isolation, we can now use custom prompts to grade the entire conversation trajectory—measuring high-level outcomes like](https://www.langchain.com/resources/llm-as-a-judge?ref=blog.langchain.com)

**LLM-as-a-judge****user satisfaction, tone, and goal resolution.**
...
The migration was relatively easy thanks to LangChain's IDE integrations. We used the[  Documentation MCP](https://docs.langchain.com/use-these-docs?ref=blog.langchain.com) to pull library context into our editor and the

[to fetch runs and feedback directly. The](https://github.com/langchain-ai/langsmith-mcp-server?ref=blog.langchain.com)

**LangSmith MCP**[was also a useful reference for clarifying specific implementation details.](https://chat.langchain.com/?ref=blog.langchain.com)

**LangChain Chat**#### Deployment
