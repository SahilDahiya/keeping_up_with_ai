...
secondary_topics:
- agents/tool-use
summary: Case study of how Langfuse uses LLMs internally to build and scale the product,
  including practical workflows for AI-assisted engineering and operations.
source: langfuse
url: https://langfuse.com/blog/2025-04-24-how-we-use-llms-to-scale-langfuse
author: null
published: '2025-04-24'
fetched: '2026-07-11T04:35:17Z'
classifier: codex
taxonomy_rev: 1
words: 1971
content_sha256: 618430674a4141414a703aec108ad06b48820859bcf49e58150400fbfe02c9c0
---
...
Marc KlingenAt [Langfuse](https://langfuse.com) we've built a culture of aggressively adopting AI tooling. Mostly because we really enjoy it, but also because we want to move fast with a lean/excellent team. As a result, friends often ask what AI tools and workflows work best for our team and for me personally.
...
This post is not covering how to build applications with LLMs/GenAI (the core focus of Langfuse). Please check out many of our [posts](https://langfuse.com/blog) on this if that's what you're looking for.

[Email Management](https://langfuse.com#email-management)
...
[Global Text Improvement](https://langfuse.com#global-text-improvement)
...
[Using ChatGPT well for research and writing](https://langfuse.com#using-chatgpt-well-for-research-and-writing)
...
post](https://langfuse.com/_next/image?url=%2Fimages%2Fblog%2F2025-04-24-how-we-use-llms-to-scale-langfuse%2Fo3-canvas.png&w=3840&q=75)


[Programming Workflow in Cursor](https://langfuse.com#programming-workflow-in-cursor)
...
[Documentation & Changelogs](https://langfuse.com#documentation--changelogs)
...
Recently, I added more cursor rules to simplify prompting for new [changelog posts](https://github.com/langfuse/langfuse-docs/blob/main/.agents/cursor/rules/changelog-posts.mdc) and [adding cross-references](https://github.com/langfuse/langfuse-docs/blob/main/.agents/cursor/rules/available-internal-links.mdc).
...
- generate an llms.txt ([source](https://github.com/langfuse/langfuse-docs/blob/main/scripts/generate_llms_txt.js))
- check if all internal links actually work ([source](https://github.com/langfuse/langfuse-docs/blob/8eb3a5ffae25b9e95727b7ccd9450c7aff6cbc8a/.github/workflows/ci.yml#L46-L64))
- update the cross-reference cursor rule on a schedule ([source](https://github.com/langfuse/langfuse-docs/blob/main/.github/workflows/update-available-internal-links-cursor-rule.yml))
- mirror all Langfuse github discussions in a json in order to [render](https://langfuse.com/changelog/2024-09-23-github-discussion-across-documentation)them within the docs without a network call ([source](https://github.com/langfuse/langfuse-docs/blob/main/scripts/load_github_discussions.py))
...
[AI-Assisted Code Reviews](https://langfuse.com#ai-assisted-code-reviews)
...
Ellipsis](https://langfuse.com/_next/image?url=%2Fimages%2Fblog%2F2025-04-24-how-we-use-llms-to-scale-langfuse%2Fai-pr-review.png&w=3840&q=75)
...
[Scaling Community Support](https://langfuse.com#scaling-community-support)
...
- Private support channels: For shared Slack channels, MS Teams channels, website chat, and support@ emails, we route everything through [Pylon](https://usepylon.com). Pylon indexes the docs and GitHub discussions and helps with in-flow AI drafts.

*Example: Dosu resolving a thread in GitHub Discussions*

![Example Dosu resolving a thread in GitHub
Discussions](https://langfuse.com/_next/image?url=%2Fimages%2Fblog%2F2025-04-24-how-we-use-llms-to-scale-langfuse%2Fdosu-answer.png&w=3840&q=75)
