...
# Bringing my LED display to life with GPT-Live-1 and Codex | OpenAI Developers
...
![The user talks with GPT-Live-1 through a Raspberry Pi. The Pi sends research and tool tasks to GPT-5.6 Luna, gets results back, and sends pixels from its local renderer to the LED wall.](https://developers.openai.com/images/blog/bringing-my-led-display-to-life/architecture.webp) 
