...
summary: 'Banque des Territoires (CDC) x Polyconseil build a sovereign, on-prem RAG
  assistant for the EduRénov program using open models (Mistral-7B-Instruct, Sentence
  Transformers, TGI): retriever/reader architecture, data-sovereignty constraints,
  and production lessons.'
triage: null
skip_reason: null
source: huggingface
url: https://huggingface.co/blog/sovereign-data-solution-case-study
author: Anthony Truchet; Jeremy Cailton; RAMAHERISON; Florent Gbelidji; Violette
published: '2024-07-09'
fetched: '2026-07-14T22:04:05Z'
classifier: claude
taxonomy_rev: 1
words: 3708
content_sha256: 27ace5b334ee92e081a024feb0a740c0a7b49fa9b03a48aed874e1ef48fae3cc
---
...
The following diagram illustrates this:
    ...
    ![RLHF](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/llama2-non-engineers/diagram_en.png) 
...
Elle est illustrée par le schéma suivant :
    ...
    ![RLHF](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/llama2-non-engineers/diagram_fr.png) 
...
llmexpert-support-programexpert-support
...
- +3
 ...
 December 3, 2024 RAGllmexpert-support-program
