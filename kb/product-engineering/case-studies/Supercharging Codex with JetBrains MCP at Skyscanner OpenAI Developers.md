...
secondary_topics:
- agents/tool-use
summary: 'Skyscanner wires Codex CLI to the JetBrains MCP server so the agent gets
  IDE feedback loops: get_file_problems surfaced a non-compiling Databricks SDK NotFound
  constructor immediately instead of after a test run, cutting iteration time.'
source: openai-devs
url: https://developers.openai.com/blog/skyscanner-codex-jetbrains-mcp/
author: null
published: '2026-01-11'
fetched: '2026-07-11T04:12:21Z'
classifier: claude
taxonomy_rev: 1
words: 950
content_sha256: 326ab6b5ed014e6203f63a3e6b6f12731fc556a4c364d4f2a7ecf896b98500a9
---
...
`var stubError = new NotFound("dummy error");`At first glance, that looks reasonable—we want to simulate a `NotFound` error. But moments later, IntelliJ highlighted that line with a big red underline.
