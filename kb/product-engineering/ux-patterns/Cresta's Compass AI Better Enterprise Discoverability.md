---
title: 'Cresta''s Compass AI: Better Enterprise Discoverability'
kind: blog
topic: product-engineering
subtopic: ux-patterns
secondary_topics:
- agents/harness
summary: 'Rethinks enterprise navigation around an embedded support agent: instead
  of answering ''where is this feature'', Compass answers ''what is the next step
  toward my goal'' and carries context as users move between Insights, Opera automations,
  and quality management. Notes building an agent inside your own product differs
  from shipping one to customers, though the requirements/evals/iterate loop stays
  the same.'
triage: null
skip_reason: null
source: cresta
...
fetched: '2026-08-20T06:10:38Z'
classifier: claude
taxonomy_rev: 2
words: 1286
content_sha256: 09673607478a75779b4aa41baa34d891c94d54c54c5ef9823c6088a64da8cffd
---

# Cresta's Compass AI: Better Enterprise Discoverability
...
<sup>Traditionally, users had difficulty navigating between product areas. Compass agentically bridges that gap.</sup>
...
<sup>Cresta’s Compass Support Agent helps users find the next step in their workflow.</sup>
...
<sup>After chatting with the Compass Support Agent about an issue, the user decides to file a support ticket, and Compass automatically pre-fills the form with their conversation and relevant context.</sup>

*"Compass is also the first Cresta AI Agent to support more complex customer support workflows, such as filing support tickets with attachments directly from the conversation, with seamless integration into external ticketing systems." 
<sub>– Di Lu, Forward Deployed Engineer</sub>*
...
<sup>The previous UI limited interaction to one area at a time, while the updated UI introduces a layered navigation model with clearer visual hierarchy.</sup>
...
<sup>Compass Search (left) implicitly understands what the user wants through context and recommendations, while Compass Support Agent (right) uses the same knowledge, but handles requests explicitly stated by the user.</sup> 
