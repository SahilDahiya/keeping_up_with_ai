...
secondary_topics:
- models/releases
summary: 'Prompting guide for steering GPT-5.4 toward non-generic frontend design:
  the model was trained for UI work, native image search/generation (e.g. prompt it
  to build mood boards first), and computer use for self-verification with tools like
  Playwright.'
source: openai-devs
url: https://developers.openai.com/blog/designing-delightful-frontends-with-gpt-5-4/
author: null
published: '2026-03-20'
fetched: '2026-07-11T04:11:56Z'
classifier: claude
taxonomy_rev: 1
words: 2870
content_sha256: 84c8d79c0203af467b23f8c79c47e8631e869e2d957aa4d2a68cd03cf1d1cc79
---
...
`Default to using any uploaded/pre-generated images. Otherwise use the image generation tool to create visually stunning image artifacts. Do not reference or link to web images unless the user explicitly asks for them.`### Functionality improvements
...
`Keep fixed or floating UI elements from overlapping text, buttons, or other key content across screen sizes. Place them in safe areas, behind primary content where appropriate, and maintain sufficient spacing.`### Dial back the reasoning
...
`$skill-installer frontend-skill`Here are a few example websites generated with the help of the Frontend Design skill.
