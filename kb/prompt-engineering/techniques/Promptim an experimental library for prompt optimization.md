...
summary: Introduces Promptim as an experimental prompt-optimization library that uses
  evaluation feedback to improve prompts.
source: langchain
url: https://www.langchain.com/blog/promptim
author: The LangChain Team
published: '2024-11-13'
fetched: '2026-07-11T04:39:31Z'
classifier: codex
taxonomy_rev: 1
words: 883
content_sha256: 4910fa15f1914632a612c306c92a4352ccac38d6373354cac6dfb161549318e3
---

# Promptim: an experimental library for prompt optimization

![](https://cdn.prod.website-files.com/65c81e88c254bb0f97633a71/69cbae45f4d459ecdf5f3e13_Screenshot-2024-11-13-at-7.39.25-AM.png)
...
A useful way to approach this is through **evaluation-driven development**. This involves first creating a dataset of inputs (and optionally, expected outputs) and then defining a number of [evaluation metrics](https://www.langchain.com/resources/llm-evaluation-metrics). Every time you make a change to the prompt, you can run it over the dataset and then score the outputs. In this way, you can measure the performance of your prompt and make sure its improving, or at the very least not regressing. Tools like [LangSmith](https://smith.langchain.com/?ref=blog.langchain.com) help with dataset curation and evaluation.
