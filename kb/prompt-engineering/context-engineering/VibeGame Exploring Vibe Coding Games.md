...
summary: 'Case study on why vibe-coded games fall apart as they grow: the context
  window fills and model performance degrades. Compares Roblox MCP, Unity MCP and
  web stacks for LLM-friendliness, and introduces Shallot, a lightweight /peel + /nourish
  context-management system for Claude Code, arguing for high-level abstractions (ECS/declarative)
  that keep the codebase small enough to fit in context.'
triage: null
skip_reason: null
source: huggingface
...
fetched: '2026-07-14T22:05:12Z'
classifier: claude
taxonomy_rev: 1
words: 1705
content_sha256: 245cbd73f65968c88d8e011c4af6412a733ebaf8cf5ef70ca8dbd99daff65694
---

# VibeGame: Exploring Vibe Coding Games

Text Generation •  81B • Updated   •  264k  •  1.03k  
...
Incremental grass cutting game
...
- +4
 ...
 March 27, 2026 agentstransformersevaluation

  19

 June 18, 2026 Thanks for the post ! If you have feedback or feature requests the Roblox MCP server, feel free to submit issues on the project page:

[https://github.com/Roblox/studio-rust-mcp-server](https://github.com/Roblox/studio-rust-mcp-server)

Also it is open source, so you can hack on it and add more context management tools here:[https://github.com/Roblox/studio-rust-mcp-server/tree/main/plugin/src/Tools](https://github.com/Roblox/studio-rust-mcp-server/tree/main/plugin/src/Tools)

Thanks, its very informative

•

 This is very cool! A mini-engine with API designed for LLMs may be able to supercharge game development.

When I went to that jsfiddle/live demo site my threat detection system alarmed.

[https://urlquery.net/report/08590583-4f70-4098-b269-48e3c8d25f4f](https://urlquery.net/report/08590583-4f70-4098-b269-48e3c8d25f4f)
