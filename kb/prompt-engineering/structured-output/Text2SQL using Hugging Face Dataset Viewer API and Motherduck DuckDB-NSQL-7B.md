...
summary: 'Text-to-SQL walkthrough using MotherDuck''s DuckDB-NSQL-7B (Llama-2-7B fine-tuned
  on DuckDB SQL pairs) with the HF Dataset Viewer parquet API: schema-in-prompt templating,
  generation, and executing the SQL against DuckDB.'
triage: null
skip_reason: null
source: huggingface
...
fetched: '2026-07-14T22:06:32Z'
classifier: claude
taxonomy_rev: 1
words: 1431
content_sha256: 30a6810846f5496b621f3f8af900d0c9cf6c6413b13d56137a866b0f002c52f4
---
...
In this article, we will learn how to deal with text2sql tasks using the DuckDB-NSQL-7B model, the Hugging Face dataset viewer API for parquet files and duckdb for data retrieval.
 ...
 ![text2sql flow](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/duckdb-nsql-7b/text2sql-flow.png)
...
For this demo, we will be using the [world-cities-geo](https://huggingface.co/datasets/jamescalam/world-cities-geo) dataset.
 ...
 ![dataset viewer](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/duckdb-nsql-7b/dataset-viewer.png)
...
First, [download](https://huggingface.co/motherduckdb/DuckDB-NSQL-7B-v0.1-GGUF/blob/main/DuckDB-NSQL-7B-v0.1-q8_0.gguf) the quantized models version of DuckDB-NSQL-7B-v0.1
 ...
 ![download model](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/duckdb-nsql-7b/download.png)
...
The [parquet file](https://huggingface.co/api/datasets/jamescalam/world-cities-geo/parquet/default/train/0.parquet) is hosted in Hugging Face viewer under `refs/convert/parquet` revision:
 ...
 ![parquet file](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/duckdb-nsql-7b/parquet.png)
...
And, as you can see, it matches the columns in the dataset viewer:
 ...
 ![dataset columns](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/duckdb-nsql-7b/columns.png)
...
And here we have the results (100 rows):
 ...
 ![sql command result](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/duckdb-nsql-7b/result.png)
...
Let's compare this result with the dataset viewer using the "search function" for **Albania** country, it should be the same:
 ...
 ![search result](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/duckdb-nsql-7b/search.png)
...
And the Hugging Face Space [here](https://huggingface.co/spaces/asoria/datasets-text2sql)
 ...
 Text Generation •  7B • Updated   •  158  •  105 

  7B • Updated   •  102  •  23 

 Viewer • Updated  •  9.08k •  171  •  15 
...
- +1
 ...
 September 29, 2025 transformersllmguide
