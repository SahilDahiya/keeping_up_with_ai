...
- •Serverless & Dedicated API: [Get started](https://fireworks.ai/models/deepseek-ai/deepseek-v4p1-flash) with DeepSeek-V4.1-Flash directly on Fireworks serverless or use dedicated capacity for your production workloads.
  - •Stay Tuned, US-Hosted Endpoints coming soon for regulated industries
- •Training Support is coming soon! [Reach out](https://fireworks.ai/contact) to our team if you are interested.
