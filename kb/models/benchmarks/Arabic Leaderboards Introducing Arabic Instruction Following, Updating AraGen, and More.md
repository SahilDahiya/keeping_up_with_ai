...
summary: 'Updates the Arabic LLM evaluation stack: the 3C3H generative scoring metric
  (correctness, completeness, conciseness + helpfulness, honesty, harmlessness) behind
  AraGen-03-25, plus Arabic IFEval, the first public instruction-following benchmark
  for Arabic, consolidated in one Arabic-Leaderboards Space with MBZUAI.'
triage: null
skip_reason: null
source: huggingface
url: https://huggingface.co/blog/leaderboard-3c3h-aragen-ifeval
author: Ali El Filali; Sarah AlBarri; Abouelseoud; Samta Kamboj; Neha Sengupta; Preslav
  Nakov
published: '2025-04-08'
fetched: '2026-07-14T22:09:07Z'
classifier: claude
taxonomy_rev: 1
words: 3383
content_sha256: d87c785f7117ec977a0ba12ee3e958d142523cfff824ff35f3c70c95b9183d7f
---
...
# 
	...
	](https://huggingface.co#arabic-leaderboards-introducing-arabic-instruction-following-updating-aragen-and-more)
	
		Arabic Leaderboards: Introducing Arabic Instruction Following, Updating AraGen, and More
	

 [Update on GitHub](https://github.com/huggingface/blog/blob/main/leaderboard-3c3h-aragen-ifeval.md)

[  Upvote 20 ](https://huggingface.co/login?next=%2Fblog%2Fleaderboard-3c3h-aragen-ifeval)

![Ali El Filali's avatar](https://cdn-avatars.huggingface.co/v1/production/uploads/626237d9bbcbd1c34f1bb231/EJrOjvAL-68qMCYdnvOrq.png) 

  [Ali El Filalialielfilali01    ](https://huggingface.co/alielfilali01)

![Inception's avatar](https://cdn-avatars.huggingface.co/v1/production/uploads/6429100588215cee63b9334e/YzcaVzr2ZWhmc5e2dgkgC.png)

[inceptionai](https://huggingface.co/inceptionai)

[Sarah AlBarriSarahAlBarri    ](https://huggingface.co/SarahAlBarri)

![Inception's avatar](https://cdn-avatars.huggingface.co/v1/production/uploads/6429100588215cee63b9334e/YzcaVzr2ZWhmc5e2dgkgC.png)

[inceptionai](https://huggingface.co/inceptionai)

[AbouelseoudArwa88    ](https://huggingface.co/Arwa88)

![Inception's avatar](https://cdn-avatars.huggingface.co/v1/production/uploads/6429100588215cee63b9334e/YzcaVzr2ZWhmc5e2dgkgC.png)

[inceptionai](https://huggingface.co/inceptionai)

[samta kambojsamta-kamboj    ](https://huggingface.co/samta-kamboj)

![Inception's avatar](https://cdn-avatars.huggingface.co/v1/production/uploads/6429100588215cee63b9334e/YzcaVzr2ZWhmc5e2dgkgC.png)

[inceptionai](https://huggingface.co/inceptionai)

![Neha Sengupta's avatar](https://cdn-avatars.huggingface.co/v1/production/uploads/6429100588215cee63b9334e/L5-CPVDsIC_1mI_izizyX.jpeg) 

  [Neha Senguptaneha1710    ](https://huggingface.co/neha1710)

![Inception's avatar](https://cdn-avatars.huggingface.co/v1/production/uploads/6429100588215cee63b9334e/YzcaVzr2ZWhmc5e2dgkgC.png)

[inceptionai](https://huggingface.co/inceptionai)

[Preslav Nakovpreslavnakov    ](https://huggingface.co/preslavnakov)

![Mohamed Bin Zayed University of Artificial Intelligence's avatar](https://cdn-avatars.huggingface.co/v1/production/uploads/1643879908583-603ab5664a944b99e81476e8.jpeg)

[MBZUAI](https://huggingface.co/MBZUAI)

**AraGen**, one of the first generative Arabic leaderboards, serving as a benchmark for evaluating Arabic LLMs on generative tasks.
...
## 
	...
	](https://huggingface.co#arabic-leaderboards-space)
...
## 
	...
	](https://huggingface.co#latest-updates-in-aragen-leaderboard)
...
### 
	...
	](https://huggingface.co#aragen-03-25-release)
...
### 
	...
	](https://huggingface.co#dynamic-evaluation-and-ranking-analysis)
...
#### 
	...
	](https://huggingface.co#analysis-of-ranking-changes)
...
###### 
	...
	](https://huggingface.co#couple-1-system-prompt-effect-aragen-03-25-sp1-vs-aragen-03-25-sp2)
...
###### 
	...
	](https://huggingface.co#couple-2-dataset-and-prompt-update-effect-aragen-12-24-sp1-old-vs-aragen-03-25-sp2-new)
...
#### 
	...
	](https://huggingface.co#analysis-of-3c3h)
...
## 
	...
	](https://huggingface.co#instruction-following-leaderboard)
...
### 
	...
	](https://huggingface.co#what-is-instruction-following-as-a-benchmark)
...
### 
	...
	](https://huggingface.co#dataset-arabic-ifeval)
...
### 
	...
	](https://huggingface.co#evaluation-methodology--metrics)
...
### 
	...
	](https://huggingface.co#results--analysis)
...
## 
	...
	](https://huggingface.co#upcoming-work)
