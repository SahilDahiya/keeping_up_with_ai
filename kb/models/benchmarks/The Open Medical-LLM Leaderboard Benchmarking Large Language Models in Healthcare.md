...
summary: The Open Medical-LLM Leaderboard aggregates MedQA (USMLE), MedMCQA, PubMedQA
  and MMLU medical subsets into a standardized accuracy benchmark for clinical LLMs,
  motivated by failure cases like GPT-3 recommending tetracycline to a pregnant patient
  while correctly explaining its contraindication.
triage: null
skip_reason: null
source: huggingface
...
fetched: '2026-07-14T22:21:13Z'
classifier: claude
taxonomy_rev: 1
words: 1757
content_sha256: 09250a1ffcfa334c71f3662853e8ff7e7e4c1e3defb58d44f58a54aa51cf2d67
---

# The Open Medical-LLM Leaderboard: Benchmarking Large Language Models in Healthcare

Text Generation •  7B • Updated   •  1.66k  •  343  

#### Nexusflow/Starling-LM-7B-beta

![](https://cdn-avatars.huggingface.co/v1/production/uploads/64e0f2f03209bf41948e1838/QxlEl98DOsWOHcavbVQ8h.png) 
...
- A few efforts are already underway in this direction. If you are interested in collaborating on the next benchmark we are planning to propose, please join our [Discord community](https://discord.gg/A5Fjf5zC69)to learn more and get involved. We would love to collaborate and brainstorm ideas!
...
```
 ...
 Text Generation •  7B • Updated   •  3.03k  •  506 
...
- +8
 ...
 November 20, 2024 Hello everyone, I would like to ask how long it takes from submitting the model to completing the test

Leader board on HF is down for months till this day...

Still down, Is this still a thing or does someone need to come take over the project?

Hopefully some volunteers to take over the project - wink wink nudge nudge
