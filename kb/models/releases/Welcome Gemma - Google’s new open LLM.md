...
subtopic: releases
secondary_topics: []
summary: 'Google''s Gemma 2B/7B open LLMs: architecture notes (multi-query attention
  for 2B, GeGLU, RMSNorm, 8k context, 256k vocab), benchmark results, and the integration
  surface for fine-tuning with PEFT/TRL and serving with TGI.'
triage: null
skip_reason: null
source: huggingface
url: https://huggingface.co/blog/gemma
author: Philipp Schmid; Omar Sanseviero; Pedro Cuenca
published: '2024-02-21'
fetched: '2026-07-14T22:10:47Z'
classifier: claude
taxonomy_rev: 1
words: 1973
content_sha256: 813e6a7be1b22ed908e43976b6cb78bdcb2298604b687731de50695fdb2c2705
---

# Welcome Gemma - Google’s new open LLM

Text Generation •  7B • Updated   •  451  •  226  

#### Deci/DeciLM-7B

![](https://cdn-avatars.huggingface.co/v1/production/uploads/604bc69e0fe8ff3ec13d71cd/KeKH2YPsgToBIZtLWNCrU.jpeg) 
...
An update to the Gemma models was released two months after this post, see the latest versions[in this collection](https://huggingface.co/collections/google/gemma-release-65d5efbccdbb8c4202ec078b).
...
- [What is Gemma?](https://huggingface.co#what-is-gemma)
...
- [Fine-tuning with 🤗 TRL](https://huggingface.co#fine-tuning-with-%F0%9F%A4%97-trl)
...
You can chat with the Gemma Instruct model on Hugging Chat! Check out the link here: [https://huggingface.co/chat/models/google/gemma-1.1-7b-it](https://huggingface.co/chat/models/google/gemma-1.1-7b-it)
...
![deploy on GCP](https://huggingface.co/blog/assets/gemma/gcp-deploy.png)
...
![train on GCP](https://huggingface.co/blog/assets/gemma/gcp-train-gemma.png)
...
And Thank you to the Google Team for releasing Gemma and making it available to the open-source AI community!
 ...
 Text Generation •  3B • Updated   •  207k  •  173 

 Text Generation •  9B • Updated   •  31.4k  •  275 

 Text Generation •  3B • Updated   •  105k  •  1.21k 

 Text Generation •  3B • Updated   •  78.7k  •  933 

 Text Generation •  9B • Updated   •  26.9k  •  3.38k 

 Text Generation •  9B • Updated   •  21.4k  •  1.25k 

 Text Generation •  69B • Updated   •  6.98k  •  854 

 Text Generation •  3B • Updated   •  861k  •  3.48k 
