...
summary: 'Release notes for four December 2025 audio model snapshots (gpt-4o-mini-transcribe,
  ...
  broader Custom Voices access at unchanged pricing.'
source: openai-devs
url: https://developers.openai.com/blog/updates-audio-models/
author: null
published: '2025-12-15'
fetched: '2026-07-11T04:12:33Z'
classifier: claude
taxonomy_rev: 1
words: 927
content_sha256: a107f850b0c98aaa662b774241eda6727228a7b02f045c003c69f3acea3fcfd1
---

# Updates for developers building with voice | OpenAI Developers

AI audio capabilities unlock an exciting new frontier of user experiences. Earlier this year we released several new audio models, including [ gpt-realtime](https://platform.openai.com/docs/models/gpt-realtime), along with

[new API features](https://developers.openai.com/blog/realtime-api)to enable developers to build these experiences.
...
- `gpt-4o-mini-transcribe-2025-12-15`- [Transcription](https://platform.openai.com/docs/guides/speech-to-text)or- [Realtime API](https://platform.openai.com/docs/guides/realtime-transcription)
- `gpt-4o-mini-tts-2025-12-15`- [Speech API](https://platform.openai.com/docs/guides/text-to-speech)
- `gpt-realtime-mini-2025-12-15`- [Realtime API](https://platform.openai.com/docs/guides/realtime)
- `gpt-audio-mini-2025-12-15`- [Chat Completions API](https://platform.openai.com/docs/api-reference/chat/create)
...
- **More natural and stable voice output**, including when using- [Custom Voices](https://developers.openai.com#custom-voices)
...
![Speech-to-speech eval chart 1](https://developers.openai.com/images/blog/updates-audio/s2s-eval1.webp)

![Speech-to-speech eval chart 2](https://developers.openai.com/images/blog/updates-audio/s2s-eval2.webp)

![Speech-to-speech eval chart 3](https://developers.openai.com/images/blog/updates-audio/s2s-eval3.webp)
...
![Text-to-speech eval chart 1](https://developers.openai.com/images/blog/updates-audio/tts-eval1.webp)

![Text-to-speech eval chart 2](https://developers.openai.com/images/blog/updates-audio/tts-eval2.webp)

![Text-to-speech eval chart 3](https://developers.openai.com/images/blog/updates-audio/tts-eval3.webp)
...
![Transcription eval chart 1](https://developers.openai.com/images/blog/updates-audio/stt-eval1.webp)

![Transcription eval chart 2](https://developers.openai.com/images/blog/updates-audio/stt-eval2.webp)

![Transcription eval chart 3](https://developers.openai.com/images/blog/updates-audio/stt-eval3.webp)
