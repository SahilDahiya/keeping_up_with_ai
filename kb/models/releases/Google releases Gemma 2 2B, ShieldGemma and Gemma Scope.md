...
summary: 'Google''s July 2024 Gemma drop: Gemma 2 2B distilled from larger models
  for on-device use, ShieldGemma safety classifiers for filtering app inputs/outputs,
  and Gemma Scope sparse autoencoders for interpretability.'
triage: null
skip_reason: null
source: huggingface
url: https://huggingface.co/blog/gemma-july-update
author: Joshua; Pedro Cuenca; Vaibhav Srivastav; Joao Gante
published: '2024-07-31'
fetched: '2026-07-14T22:09:59Z'
classifier: claude
taxonomy_rev: 1
words: 2361
content_sha256: 80569a91a626386eafdc354b8a9464f3ce417dc410eed8bed31e9a0ec95b5aa0
---

# Google releases Gemma 2 2B, ShieldGemma and Gemma Scope

Text Generation •  2B • Updated   •  3.89M  •  163  
...
On a Mac you can directly install llama.cpp with brew. To set up llama.cpp on other devices, please take a look here: [https://github.com/ggerganov/llama.cpp?tab=readme-ov-file#usage](https://github.com/ggerganov/llama.cpp?tab=readme-ov-file#usage)
...
```
This format has to be exactly reproduced for effective use. In [a previous section](https://huggingface.co#use-with-transformers) we showed how easy it is to reproduce the instruct prompt with the chat template available in `transformers`. 
...
- Preamble, establishing the model as a policy expert, based on the [LLM-as-a-judge](https://arxiv.org/abs/2306.05685)technique.
- User prompt, wrapped with `<start_of_turn>`and`<end_of_turn>`control tokens.
- Enumeration and description of the safety policies.
- Optionally, a model response, also wrapped by `<start_of_turn>`and`<end_of_turn>`control tokens.
...
- [Mishax](https://github.com/google-deepmind/mishax), a GDM internal tool used to expose the internal activations inside Gemma 2 models.
 ...
 Text Generation •  3B • Updated   •  296k  •  671 

 Text Generation •  3B • Updated   •  577k  •  1.42k 

 Text Generation •  27B • Updated   •  240  •  29 

 Text Generation •  3B • Updated   •  5.3k  •  125 

 Text Generation •  9B • Updated   •  3.22k  •  28 
...
- +2
 ...
 June 27, 2024 nlpcommunityresearch
