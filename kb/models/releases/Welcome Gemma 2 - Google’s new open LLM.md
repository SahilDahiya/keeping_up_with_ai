...
subtopic: releases
secondary_topics: []
summary: Google's Gemma 2 (9B/27B, 8K context, 13T/8T training tokens) introduces
  interleaved sliding-window and full attention, logit soft-capping, and knowledge
  distillation from a larger teacher for the 9B model, plus WARP-style model merging.
  Explains why soft-capping must be disabled to use Flash Attention 2, and covers
  transformers/TRL fine-tuning support.
triage: null
skip_reason: null
source: huggingface
url: https://huggingface.co/blog/gemma2
author: Philipp Schmid; Omar Sanseviero; Pedro Cuenca; Lewis Tunstall; Tom Aarsen;
  Vaibhav Srivastav
published: '2024-06-27'
fetched: '2026-07-14T22:10:11Z'
classifier: claude
taxonomy_rev: 1
words: 2423
content_sha256: 80f2b61a4dd9c0da3be00e1d6e78e69fe3b3dfa2aca53af82011bf7156a0684f
---
...
- [What is Gemma 2?](https://huggingface.co#what-is-gemma-2)
- [Technical advances in Gemma 2](https://huggingface.co#technical-advances-in-gemma-2)
- [Gemma 2 evaluation](https://huggingface.co#gemma-2-evaluation)
- [How to prompt Gemma 2](https://huggingface.co#how-to-prompt-gemma-2)
- [Demo](https://huggingface.co#demo)
- [Using Hugging Face Transformers](https://huggingface.co#using-hugging-facetransformers)
- [Integration with Google Cloud](https://huggingface.co#integration-with-google-cloud)
- [Integration with Inference Endpoints](https://huggingface.co#integration-with-inference-endpoints)
- [Fine-tuning with 🤗 TRL](https://huggingface.co#fine-tuning-with-trl)
...
- [Sliding window attention](https://huggingface.co#sliding-window-attention): Interleave sliding window and full-quadratic attention for quality generation.
- [Logit soft-capping](https://huggingface.co#soft-capping-and-attention-implementations): Prevents logits from growing excessively by scaling them to a fixed range, improving training.
- [Knowledge Distillation](https://huggingface.co#knowledge-distillation): Leverage a larger teacher model to train a smaller model (for the 9B model).
- [Model Merging](https://huggingface.co#model-merging): Combines two or more LLMs into a single new model
...
You can chat with the Gemma 27B Instruct model on Hugging Chat! Check out the link here: [https://huggingface.co/chat/models/google/gemma-2-27b-it](https://huggingface.co/chat/models/google/gemma-2-27b-it).
...
```
  ![image_tooltip alt_text](https://huggingface.co/datasets/trl-internal-testing/example-images/resolve/main/blog/gemma2/lora.png?download=true) 
...
accelerate launch --config_file=examples/accelerate_configs/deepspeed_zero3.yaml \
    ...
    --output_dir models/gemma2
```
  ![image_tooltip alt_text](https://huggingface.co/datasets/trl-internal-testing/example-images/resolve/main/blog/gemma2/ds3.png?download=true?download=true) 
...
And Thank you to the Google Team for releasing Gemma 2 and making it available to the open-source AI community!
 ...
 Text Generation •  27B • Updated   •  4.53k  •  209 

 Text Generation •  27B • Updated   •  60.4k  •  567 

 Text Generation •  9B • Updated   •  80.4k  •  714 

 Text Generation •  9B • Updated   •  290k  •  837 
