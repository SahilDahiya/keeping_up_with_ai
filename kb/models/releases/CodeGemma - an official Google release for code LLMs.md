...
subtopic: releases
secondary_topics: []
summary: Google's CodeGemma ships 2B (infilling-specialized), 7B base and 7B instruct
  code models built on Gemma, trained with fill-in-the-middle (FIM) objectives on
  ~500B tokens of code. Details the FIM prompt formatting/tokens needed to actually
  use the base models plus HumanEval/MBPP/GSM8K results.
triage: null
skip_reason: null
source: huggingface
url: https://huggingface.co/blog/codegemma
author: Pedro Cuenca; Omar Sanseviero; Vaibhav Srivastav; Philipp Schmid; Mishig Davaadorj;
  Loubna Ben Allal
published: '2024-04-09'
fetched: '2026-07-14T22:10:34Z'
classifier: claude
taxonomy_rev: 1
words: 1693
content_sha256: 8a77ac9cdf724df81cfb0d5a4dba491fef16940a297b410fce9a29f9d91c14ca
---

# CodeGemma - an official Google release for code LLMs

Text Generation •  3B • Updated   •  33.7k  •  101  
...
![The CodeGemma family The CodeGemma family](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/codegemma/codegemma-family.png)
...
![CodeGemma quality across languages CodeGemma quality across languages](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/codegemma/codegemma-table4.png)
...
![GCP Integration GCP Integration](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/codegemma/gcp_integration.png)
...
```
 ...
 Text Generation •  9B • Updated   •  2.49k  •  220 

 Text Generation •  9B • Updated   •  1.26k  •  256 
