...
title: 'Falcon 2: An 11B parameter pretrained language model and VLM, trained on over
  5000B tokens and 11 languages'
kind: blog
topic: models
subtopic: releases
secondary_topics: []
summary: 'Falcon2-11B: 11B params trained on 5,000B tokens of RefinedWeb in a four-stage
  curriculum that raises context length 2048 -> 4096 -> 8192 with a final high-quality-data
  stage, plus a VLM variant; benchmarked against Llama 3 8B and Gemma 7B.'
triage: null
skip_reason: null
source: huggingface
url: https://huggingface.co/blog/falcon2-11b
author: Quentin Malartic; Nilabhra Roy Chowdhury; Ruxandra Cojocaru; Mughaira; Giulia
  Campesan; Sanath Narayan; Ankit Singh; Clémentine Fourrier; Nathan Habib
published: '2024-05-24'
fetched: '2026-07-14T22:10:13Z'
classifier: claude
taxonomy_rev: 1
words: 1883
content_sha256: e69068c966176a7f6f2eb19a74dd6f4f63479e793230a8bab7ab0c2946fca294
---

# Falcon 2: An 11B parameter pretrained language model and VLM, trained on over 5000B tokens and 11 languages

Text Generation •  11B • Updated   •  5.29k  •  219  
...
- [The Falcon 2 Models](https://huggingface.co#the-falcon-models)
- Falcon 2 11B LLM
- Falcon 2 11B VLM
- [Licensing information](https://huggingface.co#license-information)
...
```
    ![](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/179_falcon2-11b/falcon_example_tiny.png) 
...
The Falcon 2 models are made available under the [TII Falcon 2 License](https://falconllm-staging.tii.ae/falcon-2-terms-and-conditions.html), a permissive Apache 2.0-based software license which includes an [acceptable use policy](https://falconllm-staging.tii.ae/falcon-2-acceptable-use-policy.html) that promotes the responsible use of AI. This license was crafted within the spirit of TII's commitment to the open source community.
 ...
 Text Generation •  180B • Updated   •  108  •  1.15k 
...
multimodalnlpcommunity
 ...
 April 9, 2026 This comment has been hidden (marked as Off-Topic)        

      ![swagger.png](https://cdn-uploads.huggingface.co/production/uploads/6801fe9505521ab22c5d3b60/FF7TaFGVNbtR3An1PzDix.png)
