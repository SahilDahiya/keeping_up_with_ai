...
secondary_topics:
- industry/trends
summary: Simon Willison discussion of open-source AI as a wakeup call to closed AI
  and the implications for builders.
source: latent-space
url: https://www.latent.space/p/no-moat
author: Latent Space; Alessio Fanelli; Simon Willison
published: '2023-05-05'
fetched: '2026-07-11T05:23:16Z'
classifier: codex
taxonomy_rev: 1
words: 10517
content_sha256: 32a4555b31f0fec1fad34494378c68cbd38a4b05bc2a7dfde1ea8a9d5f0dc39b
---

# No Moat: Closed AI gets its Open Source wakeup call — ft. Simon Willison

It’s now almost 6 months since [Google declared Code Red](https://www.latent.space/p/google-vs-openai?utm_source=%2Fsearch%2Fcode%2520red&utm_medium=reader2)[1](https://www.latent.space#footnote-1), and the results — Jeff Dean’s [recap of 2022 achievements](https://twitter.com/JeffDean/status/1615796030611820545?s=20) and a mass exodus of the [top](https://twitter.com/hwchung27/status/1625583734086045696?s=20) [research](https://twitter.com/_jasonwei/status/1625575747401441280?s=20) [talent](https://twitter.com/shaneguML/status/1617594053079760896) that contributed to it in January, Bard’s rushed launch in Feb[2](https://www.latent.space#footnote-2), a slick video showing [Google Workspace AI features](https://workspace.google.com/blog/product-announcements/generative-ai) and [confusing doubly linked blogposts](https://developers.googleblog.com/2023/03/announcing-palm-api-and-makersuite.html) about PaLM API in March[3](https://www.latent.space#footnote-3), and [merging Google Brain and DeepMind](https://www.deepmind.com/blog/announcing-google-deepmind) in April[4](https://www.latent.space#footnote-4) — have not been inspiring.

Google’s internal panic is in full display now with the surfacing of [a well written memo](https://www.semianalysis.com/p/google-we-have-no-moat-and-neither), [written by software engineer Luke Sernau](https://www.bloomberg.com/news/articles/2023-05-05/google-staffer-claims-in-leaked-ai-warning-we-have-no-secret-sauce?accessToken=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzb3VyY2UiOiJTdWJzY3JpYmVyR2lmdGVkQXJ0aWNsZSIsImlhdCI6MTY4MzI1MTU3MSwiZXhwIjoxNjgzODU2MzcxLCJhcnRpY2xlSWQiOiJSVTVTRFdUMEcxS1cwMSIsImJjb25uZWN0SWQiOiJFNzAxNENGQzIzNTI0MzU0QTVENUY2QkREMDAxOEU3NiJ9.diI94QzMN7WY6tuJNvXD_XIvxKjCR9PqcVA9Uw7vwPo) written in early April, revealing internal distress not seen since Steve Yegge’s infamous [Google Platforms Rant](https://www.businessinsider.com/steve-yegge-google-platform-rant-2011-10). Similar to 2011, the company’s response to an external challenge has been to mobilize the entire company to go all-in on a (from the outside) vague vision.
...
![](https://substackcdn.com/image/fetch/$s_!cXkT!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F578b1ab5-f40f-4d3c-8c86-21fb00bd7d58_1534x686.png)

Combine this with news [this morning](https://twitter.com/amir/status/1654218677074681858?s=20) that OpenAI **lost $540m last year** and will need as much as $100b more funding (after the complex [$10b Microsoft deal](https://www.bloomberg.com/news/articles/2023-01-23/microsoft-makes-multibillion-dollar-investment-in-openai) in Jan), and the memo’s assertion that *both* Google and OpenAI have “no moat” against the mighty open source horde have gained some credibility in the past 24 hours.

Many are criticising this memo privately:

- A CEO commented to me yesterday that - [Luke Sernau](https://www.linkedin.com/in/luke-sernau-40394648/)does not seem to work in AI related parts of Google and “software engineers don’t understand moats”.
- Emad Mostaque, himself a perma-champion of open source and open models, has - [repeatedly](https://twitter.com/search?q=from%3Aemostaque%20closed%20always%20open&src=typed_query&f=top)stated that “Closed models will always outperform open models” because closed models can just wrap open ones- [5](https://www.latent.space#footnote-5).
- Emad has also - [commented on](https://twitter.com/EMostaque/status/1612662263642738688?s=20)the moats he does see: “- *Unique usage data, Unique content, Unique talent, Unique product, Unique business model*”, most of which Google does have, and OpenAI less so (though it is winning on the talent front)
- Sam Altman famously - [said](https://twitter.com/JayaGup10/status/1587618737611411456)that “very few to no one is Silicon Valley has a moat - not even Facebook” (implying that moats don’t actually matter, and you should spend your time thinking about more important things- [6](https://www.latent.space#footnote-6))
- It is not actually clear what race the memo thinks Google and OpenAI are in vs Open Source. Neither are particularly concerned about running models locally on phones, and they are perfectly happy to let “ - [a crazy European alpha male](https://changelog.com/podcast/532)”- [7](https://www.latent.space#footnote-7)run the last mile for them while they build actually monetizable cloud infrastructure.

However moats are of intense interest by everybody keen on productized AI, cropping up in every [Harvey](https://news.ycombinator.com/item?id=35735496), [Jasper](https://txt.cohere.ai/ai-is-eating-the-world/), and general [AI startup vs incumbent](https://blog.eladgil.com/p/ai-startup-vs-incumbent-value) debate. It is *also *interesting to take the memo at face value and discuss the searing hot pace of AI progress in open source.

We hosted this discussion yesterday with Simon Willison, who apart from being an incredible communicator also wrote [a great recap of the No Moat](https://simonwillison.net/2023/May/4/no-moat/) memo. 2,800 have [now tuned in on Twitter Spaces](https://twitter.com/swyx/status/1654350693027958784?s=20), but we have taken the audio and cleaned it up here. Enjoy!
...
Sundar [denies](https://twitter.com/swyx/status/1641968311863857155) personally calling the Code Red. Perhaps we need to put him on the stand for Tom Cruise to cross examine?

[2](https://www.latent.space#footnote-anchor-2)

Google rushed to demo Bard the same day as Microsoft Bing on Feb 8, and Bard’s demo of inaccurate information (on the [JWST](https://twitter.com/IsabelNAngelo/status/1623013720011194368)) caused [a $100b dive in market value](http://costing $100b in market value). We now know that Bing’s demo also had inaccuracies and that it does [compare favorably](https://overcast.fm/+-Myp4gDKU) on some dimensions, but first impressions are sticky.

[3](https://www.latent.space#footnote-anchor-3)

To my knowledge, all these items are yet unlaunched.

[4](https://www.latent.space#footnote-anchor-4)

A friend recently commented that Google X, Brain, and DeepMind have collectively been the Xerox PARC of our era, birthing Aurora, Nuro, Skydio, Transformers, Chinchilla, and more.

[5](https://www.latent.space#footnote-anchor-5)

But of course, open will continue to progress regardless, like the proverbial [immortal snail](https://www.reddit.com/r/AskReddit/comments/5ipinn/you_and_a_super_intelligent_snail_both_get_1/).

[6](https://www.latent.space#footnote-anchor-6)

My internal Paul Graham cannot resist adding, “like making something people want”.

[7](https://www.latent.space#footnote-anchor-7)

[Anon AI Twitter](https://twitter.com/yacineMTB/status/1634602943319080960) is best Twitter.
