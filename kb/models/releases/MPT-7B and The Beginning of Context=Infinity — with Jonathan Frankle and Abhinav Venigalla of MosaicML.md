---
title: MPT-7B and The Beginning of Context=Infinity — with Jonathan Frankle and Abhinav
  Venigalla of MosaicML
topic: models
subtopic: releases
secondary_topics:
- prompt-engineering/context-engineering
summary: MosaicML interview on MPT-7B and the beginning of long-context open models.
source: latent-space
url: https://www.latent.space/p/mosaic-mpt-7b
author: Alessio Fanelli; Latent Space
published: '2023-05-20'
fetched: '2026-07-11T05:23:09Z'
classifier: codex
taxonomy_rev: 1
words: 16610
content_sha256: 1350d0fd5de67b8f9d4dfe39c958a083468f61e563798152b063010e10038ff7
---
...
![](https://substackcdn.com/image/fetch/$s_!OUDL!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fdb7ee31b-a845-4f99-9780-8b11bd8cac88_1546x811.png)

This transformer model, trained from scratch on 1 trillion tokens of text and code (compared to 300B for Pythia and OpenLLaMA, and 800B for StableLM), matches the quality of LLaMA-7B. It was trained on the MosaicML platform in 9.5 days on 440 GPUs with no human intervention, costing approximately $200,000. Unlike many open models, MPT-7B is licensed for commercial use and it’s optimized for fast training and inference through [FlashAttention](https://arxiv.org/abs/2205.14135) and [FasterTransformer](https://github.com/NVIDIA/FasterTransformer).

![](https://substackcdn.com/image/fetch/$s_!wYPn!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fbfd488ee-b256-4b1e-9dea-32d525d987d9_1999x916.png)

They also released 3 finetuned models starting from the base MPT-7B:

- [MPT-7B-Instruct](https://huggingface.co/mosaicml/mpt-7b-instruct)- [dolly_hhrlhf](https://huggingface.co/datasets/mosaicml/dolly_hhrlhf), a dataset built on top of dolly-5k (- [see our Dolly episode for more details](https://www.latent.space/p/mike-conover#details)).
- [MPT-7B-Chat](https://huggingface.co/mosaicml/mpt-7b-chat):- [ShareGPT-Vicuna](https://huggingface.co/datasets/jeffwan/sharegpt_vicuna),- [HC3](https://huggingface.co/datasets/Hello-SimpleAI/HC3),- [Alpaca](https://huggingface.co/datasets/tatsu-lab/alpaca),- [Helpful and Harmless](https://huggingface.co/datasets/Anthropic/hh-rlhf), and- [Evol-Instruct](https://huggingface.co/datasets/victor123/evol_instruct_70k)datasets.
- [MPT-7B-StoryWriter-65k+](https://huggingface.co/mosaicml/mpt-7b-storywriter)- **a context length of 65k tokens**on a filtered fiction subset of the- [books3 dataset](https://huggingface.co/datasets/the_pile_books3). While 65k is the advertised size, the team has gotten up to 84k tokens in response when running on a single node A100-80GB GPUs.- [ALiBi](https://arxiv.org/abs/2108.12409)is the dark magic that makes this possible. Turns out- *The Great Gatsby*is only about 68k tokens, so the team used the model to create new epilogues for it!

![](https://substackcdn.com/image/fetch/$s_!mqsL!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F24ad065c-7b8c-4bd0-9ce6-8ee1c0ded9d3_1189x1182.png)

On top of the model checkpoints, the team also open-sourced the entire codebase for pretraining, finetuning, and evaluating MPT via their new MosaicML [LLM Foundry](https://github.com/mosaicml/llm-foundry). The table we showed above was created using LLM Foundry in-context-learning eval framework itself!

In this episode, we chatted with the leads of MPT-7B at Mosaic: [Jonathan Frankle](http://www.jfrankle.com/), Chief Scientist, and [Abhinav Venigalla](https://www.linkedin.com/in/avenigalla), Research Scientist who spearheaded the MPT-7B training run. We talked about some of the innovations they’ve brought into the training process to remove the need for 2am on-call PagerDutys, why the LLM dataset mix is [such an important yet dark art](https://twitter.com/swyx/status/1653064637611651077), and why some of the traditional multiple-choice benchmarks might not be very helpful for the type of technology we are building.
...
![Image Image](https://substackcdn.com/image/fetch/$s_!1jOx!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fa7c06117-98b4-4ed7-ac25-d60b4046bc34_1536x2048.jpeg)
