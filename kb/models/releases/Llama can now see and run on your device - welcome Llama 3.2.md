...
secondary_topics:
- infra-platform/edge
summary: Llama 3.2 adds 11B/90B vision models (cross-attention adapter over a frozen
  text backbone, via the new MllamaForConditionalGeneration) and 1B/3B on-device text
  models, plus a vision-capable Llama Guard 3 and a 1B Llama Guard for input/output
  safety classification.
triage: null
skip_reason: null
source: huggingface
url: https://huggingface.co/blog/llama32
author: Merve; Philipp Schmid; Omar Sanseviero; Vaibhav Srivastav; Lewis Tunstall;
  Aritra Roy Gosthipaty; Pedro Cuenca
published: '2024-09-25'
fetched: '2026-07-14T22:09:47Z'
classifier: claude
taxonomy_rev: 1
words: 3513
content_sha256: 5d117a981d394b90814157ce7f00ad853c3ca783680faab834f1e22a96b6c3c1
---
...
- [What is Llama 3.2 Vision?](https://huggingface.co#what-is-llama-32-vision)
- [Llama 3.2 license changes. Sorry, EU :(](https://huggingface.co#llama-32-license-changes-sorry-eu-)
- [What is special about Llama 3.2 1B and 3B?](https://huggingface.co#what-is-special-about-llama-32-1b-and-3b)
- [Demo](https://huggingface.co#demo)
- [Using Hugging Face Transformers](https://huggingface.co#using-hugging-face-transformers)
- [Llama 3.2 1B & 3B Language Models](https://huggingface.co#llama-32-1b--3b-language-models)
- [Llama 3.2 Vision](https://huggingface.co#llama-32-vision)
- [On-device](https://huggingface.co#on-device)
- [Llama.cpp & Llama-cpp-python](https://huggingface.co#llamacpp--llama-cpp-python)
- [Transformers.js](https://huggingface.co#transformersjs)
- [Fine-tuning Llama 3.2](https://huggingface.co#fine-tuning-llama-32)
...
- +1
 ...
 November 26, 2024 This comment has been hidden (marked as Off-Topic)        
