...
secondary_topics:
- infra-platform/edge
summary: Gemma 4 (Apache 2.0, up to 256K context) mixes alternating local sliding-window
  and global attention layers, dual RoPE configs, MoE (26B total / 4B active, LMArena
  ~1441) alongside a 31B dense model at ~1452, plus a USM-style conformer audio encoder
  and a variable-aspect-ratio image encoder with configurable image-token budget.
triage: null
skip_reason: null
source: huggingface
url: https://huggingface.co/blog/gemma4
author: Merve; Pedro Cuenca; Sergio Paniego; Ben Burtenshaw; Steven Zheng; Alvaro
  Bartolome; Nathan Habib
published: '2026-04-02'
fetched: '2026-07-14T22:05:02Z'
classifier: claude
taxonomy_rev: 1
words: 6847
content_sha256: 6a76ff5d544a904e4ca75acbcee415e5d322af116c9d56cde061452ac1a02eda
---

# Welcome Gemma 4: Frontier multimodal intelligence on device

Any-to-Any •  12B • Updated   •  305k  •  655  
...
- [What is New with Gemma 4?](https://huggingface.co#what-is-new-with-gemma-4)
- [Overview of Capabilities and Architecture](https://huggingface.co#overview-of-capabilities-and-architecture)
- [Multimodal Capabilities](https://huggingface.co#multimodal-capabilities)
- [Deploy Anywhere](https://huggingface.co#deploy-anywhere)
- [Multi-Token Prediction Drafters](https://huggingface.co#multi-token-prediction-drafters)
- [DiffusionGemma: Text Generation via Diffusion](https://huggingface.co#diffusiongemma-text-generation-via-diffusion)
- [Fine-tuning & Demos](https://huggingface.co#fine-tuning--demos)
- [Try Gemma 4](https://huggingface.co#try-gemma-4)
- [Benchmark Results](https://huggingface.co#benchmark-results)
...
- **Unified encoder-free multimodality (12B only)**: the 12B Unified variant drops the separate vision and audio encoders and projects raw image patches and audio waveforms directly into the LLM's embedding space. See- [Unified Multimodal (12B)](https://huggingface.co#unified-multimodal-12b).
...
- **Image content goes**in your prompt.- *before*the text
- **Audio content goes**in your prompt.- *after*the text
...
Alongside the autoregressive Gemma 4 family, Google DeepMind is releasing [ DiffusionGemma](https://huggingface.co/google/diffusiongemma-26B-A4B-it), a multimodal model that generates text using 
...
```
You can find the complete example in the "Hugging Face on Google Cloud" docs at [https://hf.co/docs/google-cloud/examples/vertex-ai-notebooks-fine-tune-gemma-4](https://hf.co/docs/google-cloud/examples/vertex-ai-notebooks-fine-tune-gemma-4).
...
Source: Google ([blog.google](https://blog.google/innovation-and-ai/technology/developers-tools/gemma-4/))
...
This work wouldn't have been possible without Google's extensive contribution with the model artefact, but also the significant effort contributing the model to transformers in an effort to standardize it. The open-source ecosystem is now more complete, with a very capable, freely-licensed, open-source model. The Gemma 4 transformers integration was handled by Cyril, Raushan, Eustache, Arthur, Lysandre. We thank Joshua for the transformers.js integration and demo, Eric for mistral.rs integration, Son for Llama.cpp, Prince for MLX, Quentin, Albert and Kashif for TRL, Adarsh for SGLang transformers backend, and Toshihiro for building several demos.
 ...
 Any-to-Any •  12B • Updated   •  2.84M  •  1.29k 

 Image-Text-to-Text •  27B • Updated   •  1.06M  •  340 

 Image-Text-to-Text •  27B • Updated   •  14.2M  •  1.27k 

 Image-Text-to-Text •  33B • Updated   •  817k  •  463 

 Image-Text-to-Text •  33B • Updated   •  12.3M  •  3.2k 

 Any-to-Any •  5B • Updated   •  111k  •  391 

 Any-to-Any •  5B • Updated   •  2.78M  •  816 

 Any-to-Any •  8B • Updated   •  466k  •  357 

 Any-to-Any •  8B • Updated   •  5.77M  •  1.37k 

 Benchmark • Updated  •  1.25k •  93.6k  •  482 

 Benchmark • Updated  •  30 •  16.7k  •  47 

 Benchmark • Updated  •  12.1k •  150k  •  498 

 Benchmark • Updated  •  2.5k •  30.1k  •  865 

 Viewer • Updated  •  31 •  20.8k  •  9 
...
Chat with an AI that understands text, images, and video
...
guidetransformers.jsjavascript
 ...
 April 23, 2026 multimodalnlpcommunity

  74

 April 16, 2026 Thank you all for your efforts!
...
This exactly fits our kid education domain! Great job and i deeply appreciate for your work! I will put it into our pipeline now!!!
...
appreciate that your efforts on it.

This kind of release notes are really useful, thank you
...
Struggling to find a way to addLiteRT-LM to an ios build? is it not possible?

This comment has been hidden        

      The link to the mistralrs models returns 404. This one worked:
...
I did some further testing on these models for multi-modal reasoning, building on your evaluation. And wrote about them here [https://januverma.substack.com/p/research-briefings-gemma-4](https://januverma.substack.com/p/research-briefings-gemma-4). Solid models for building visual reasoning projects. 
