...
summary: Explains large multimodal model architecture and training patterns, modality
  fusion, data challenges, and product capabilities unlocked by image, text, audio,
  and video models.
source: chip-huyen
url: https://huyenchip.com/2023/10/10/multimodal.html
author: Chip Huyen
published: '2023-10-10'
fetched: '2026-07-11T05:08:52Z'
classifier: codex
taxonomy_rev: 1
words: 5089
content_sha256: a40d99fa297fc4851528a845e97c2eb4830ac8d45138ac117b8421b478934d5a
---
...
[Part 1. Understanding Multimodal](https://huyenchip.com#part_1_understanding_multimodal)

…. [Why multimodal](https://huyenchip.com#why_multimodal)

…. [Data modalities](https://huyenchip.com#data_modalities)

…. [Multimodal tasks](https://huyenchip.com#multimodal_tasks)

…….. [Generation](https://huyenchip.com#generation)

…….. [Vision-language understanding](https://huyenchip.com#vision_language_understanding)

[Part 2. Fundamentals of Multimodal Training](https://huyenchip.com#part_2_multimodal_training)

…. [CLIP: Contrastive Language-Image Pre-training](https://huyenchip.com#clip)

…….. [CLIP’s high-level architecture](https://huyenchip.com#clip_s_high_level_architecture)

…….. [Natural language supervision](https://huyenchip.com#natural_language_supervision)

…….. [Contrastive learning](https://huyenchip.com#contrastive_learning)

…….. [CLIP applications](https://huyenchip.com#clip_applications)

…. [Flamingo: the dawns of LMMs](https://huyenchip.com#flamingo)

…….. [Flamingo’s high-level architecture](https://huyenchip.com#flamingo_s_high_level_architecture)

…….. [Data](https://huyenchip.com#data)

…….. [Flamingo’s vision encoder](https://huyenchip.com#flamingo_s_vision_encoder)

…….. [Flamingo’s language model](https://huyenchip.com#flamingo_s_language_model)

…. [TL;DR: CLIP vs. Flamingo](https://huyenchip.com#clip_vs_flamingo)

[Part 3. Research Directions for LMMs](https://huyenchip.com#part_3_research_directions_for_lmms)

…. [Incorporating more data modalities](https://huyenchip.com#incorporating_more_data_modalities)

…. [Multimodal systems for instruction-following](https://huyenchip.com#multimodal_systems_for_instruction_following)

…. [Adapters for more efficient multimodal training](https://huyenchip.com#adapters_for_more_efficient_multimodal_training)

…. [Generating multimodal outputs](https://huyenchip.com#generating_multimodal_outputs)

[Conclusion](https://huyenchip.com#conclusion)

[Resources](https://huyenchip.com#resources)
...
![Multiple captions for the same image](https://huyenchip.com/assets/pics/multimodal/6-multiple-captions.png)
...
![How CLIP works](https://huyenchip.com/assets/pics/multimodal/7-clip.png)

    Another way to look at this is that each training batch of CLIP is two classification tasks.

-
    Each image can be paired with N possible texts, and the model tries to predict the correct one. This is the same setup as image-to-text retrieval. \[L_{\text{contrastive:txt2im}} = -\frac{1}{N}\sum_i^N\log(\frac{\exp(L_i^TV_i\beta)}{\sum_j^N\exp(L_i^TV_j\beta)})\]
-
    Each text can be paired with N possible images, and the model tries to predict the correct image. This is the same setup as text-to-image retrieval. \[L_{\text{contrastive:im2txt}} = -\frac{1}{N}\sum_i^N\log(\frac{\exp(V_i^TL_i\beta)}{\sum_j^N\exp(V_i^TL_j\beta)})\]
...
![CLIP constrastive learning](https://huyenchip.com/assets/pics/multimodal/9-contrastive-learning-efficiency.png)
...
![CLIP as a strong baseline for image classification](https://huyenchip.com/assets/pics/multimodal/10-clip-perf.png)
...
![unCLIP](https://huyenchip.com/assets/pics/multimodal/11-unCLIP.png)
...
![Conversations with Flamingo LMMs](https://huyenchip.com/assets/pics/multimodal/12-flamingo-chatbots.png)
...
![Flamingo high level architecture](https://huyenchip.com/assets/pics/multimodal/13-flamingo-architecture.png)

    ### Data

Flamingo used 4 datasets: 2 (image, text) pair datasets, 1 (video, text) pair dataset, and 1 interleaved image and text dataset.

![Flamingo's 4 datasets](https://huyenchip.com/assets/pics/multimodal/14-flamingo-data.png)
...
![Flamingo's 4 datasets](https://huyenchip.com/assets/pics/multimodal/15-lmm-text-generation.png)
...
![Flamingo's Perceiver Resampler](https://huyenchip.com/assets/pics/multimodal/16-flamingo-perceiver-resampler.png)
...
![Flamingo's GATED ATTN-DENSE layers](https://huyenchip.com/assets/pics/multimodal/17-gated xattn-dense.png)
...
![Flamingo's 4 datasets](https://huyenchip.com/assets/pics/multimodal/18-clip-flamingo.png)
...
![Imagebind](https://huyenchip.com/assets/pics/multimodal/19-imagebind.png)
...
![LaVIN](https://huyenchip.com/assets/pics/multimodal/20-LaVIN.png)
...
![Adapters for LMMs](https://huyenchip.com/assets/pics/multimodal/21-adapters-1.png)

    ![Adapters for LMMs](https://huyenchip.com/assets/pics/multimodal/22-adapters-2.png)
...
![CM3](https://huyenchip.com/assets/pics/multimodal/23-cm3.png)
    ...
    ![GPT-4V generating LaTeX](https://huyenchip.com/assets/pics/multimodal/24-gpt-4v-latex.png)
...
![LMMs generating text and images](https://huyenchip.com/assets/pics/multimodal/27-lmms-generating-images.png)
