---
title: Training a SOTA Code LLM in 1 week and Quantifying the Vibes — with Reza Shabani
  of Replit
topic: models
subtopic: fine-tuning
secondary_topics:
- agents/computer-use
summary: Replit interview on training a state-of-the-art code LLM quickly and quantifying
  coding-model quality.
source: latent-space
url: https://www.latent.space/p/reza-shabani
author: Latent Space; Alessio Fanelli
published: '2023-05-03'
fetched: '2026-07-11T05:23:20Z'
classifier: codex
taxonomy_rev: 1
words: 14641
content_sha256: fa5b18926f1560b0e2933de345f531838c5c4acb4b397083ba890e54716d4e9c
---
...
As [announced during their Developer Day](https://twitter.com/swyx/status/1651020776689262592) celebrating their [$100m fundraise](https://www.finsmes.com/2023/04/replit-raises-97-4m-in-funding-at-1-16b-valuation.html) following [their Google partnership](https://blog.replit.com/google-partnership), Replit is [now open sourcing](https://twitter.com/pirroh/status/1653586734641471490) its own state of the art code LLM: `replit-code-v1-3b `([model card](https://huggingface.co/replit/replit-code-v1-3b), [HF Space](https://huggingface.co/spaces/replit/replit-code-v1-3b-demo)), which beats OpenAI’s Codex model on the industry standard HumanEval [benchmark](https://www.latent.space/p/benchmarks-101#details) when finetuned on Replit data (despite being 77% smaller[1](https://www.latent.space#footnote-1)) and more importantly passes AmjadEval (we’ll explain!)

![](https://substackcdn.com/image/fetch/$s_!kQYc!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fee0774fc-96da-4a2f-a0d2-709c56a5c444_1156x1114.png)

[replit announcement](https://twitter.com/Replit/status/1651344182425051136)

We got an exclusive interview with ** Reza Shabani**, Replit’s Head of AI, to tell the story of Replit’s journey into building a data platform, building GhostWriter, and now

[training their own LLM](https://blog.replit.com/llm-training), for 22 million developers!

![](https://substackcdn.com/image/fetch/$s_!2W0w!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F1adf5508-128c-46e5-8280-d3b98d161ded_2530x1422.png)

8 minutes of this discussion go into a live demo discussing generated code samples - which is always awkward on audio. So we’ve again gone multimodal and put up a screen recording [here](https://youtu.be/sSK5JtHhruA) where you can follow along on the code samples!
...
- Reza on - [how to train your own LLMs](https://blog.replit.com/llm-training)(their top blog of all time)
- [Our Benchmarks 101 episode](https://www.latent.space/p/benchmarks-101#details)where we discussed HumanEval
- [Replit’s AI team is hiring](https://replit.com/site/careers)in North America timezone - Fullstack engineer, Applied AI/ML, and other roles!
...
A 7b model is also [on the way](https://twitter.com/amasad/status/1651022169953173506?s=20).
