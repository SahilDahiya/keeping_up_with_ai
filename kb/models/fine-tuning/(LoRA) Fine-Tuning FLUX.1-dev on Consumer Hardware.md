...
summary: Fine-tunes FLUX.1-dev with QLoRA under ~10GB of VRAM on a single RTX 4090
  using bitsandbytes NF4, 8-bit optimizers and gradient checkpointing, and compares
  FP8 training with torchao for extra speed on compatible hardware.
triage: null
skip_reason: null
source: huggingface
...
fetched: '2026-07-14T22:05:30Z'
classifier: claude
taxonomy_rev: 1
words: 2616
content_sha256: da216d0219c4562b61abb968daf76cfeeccd77918ed1d82ab1cd52b790c2d67f
---

# (LoRA) Fine-Tuning FLUX.1-dev on Consumer Hardware

Viewer • Updated  •  13 •  27    

# 
	[
		
	](https://huggingface.co#lora-fine-tuning-flux1-dev-on-consumer-hardware)
	
		(LoRA) Fine-Tuning FLUX.1-dev on Consumer Hardware
	

 [Update on GitHub](https://github.com/huggingface/blog/blob/main/flux-qlora.md)

[  Upvote 107 ](https://huggingface.co/login?next=%2Fblog%2Fflux-qlora)
...
![Marc Sun's avatar](https://cdn-avatars.huggingface.co/v1/production/uploads/63ce875d199b36f7552d4f07/bpUrvhXDagzRqZ3vxTcSF.jpeg) 
  ...
  ![Sayak Paul's avatar](https://cdn-avatars.huggingface.co/v1/production/uploads/1649681653581-5f7fbd813e94f16a85448745.jpeg) 
  ...
  ![Linoy Tsaban's avatar](https://cdn-avatars.huggingface.co/v1/production/uploads/638f308fc4444c6ca870b60a/Q11NK-8-JbiilJ-vk2LAR.png) 
...
- [FLUX Architecture](https://huggingface.co#flux-architecture)
- [QLoRA Fine-tuning FLUX.1-dev with diffusers](https://huggingface.co#qlora-fine-tuning-flux1-dev-with-diffusers)
- [FP8 Fine-tuning with](https://huggingface.co#fp8-fine-tuning-with-torchao)- `torchao`
- [Inference with Trained LoRA Adapters](https://huggingface.co#inference-with-trained-lora-adapters)
- [Running on Google Colab](https://huggingface.co#running-on-google-colab)
...
## 
	...
	](https://huggingface.co#flux-architecture)
...
## 
	...
	](https://huggingface.co#qlora-fine-tuning-flux1-dev-with-diffusers)
...
### 
	...
	](https://huggingface.co#key-optimization-techniques)
...
### 
	...
	](https://huggingface.co#pre-computing-text-embeddings-clipt5)
...
### 
	...
	](https://huggingface.co#setup--results)
...
|---|---|---|
| "Serene raven-haired woman, moonlit lilies, swirling botanicals, alphonse mucha style" | ![Base model output for the first prompt](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/quantization-backends-diffusers2/alphonse_mucha_base2_bf16.png) | ![QLoRA model output for the first prompt](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/quantization-backends-diffusers2/alphonse_mucha_merged2_qlora_bf16.png) | 
| "a puppy in a pond, alphonse mucha style" | ![Base model output for the second prompt](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/quantization-backends-diffusers2/alphonse_mucha_base3_bf16.png) | ![QLoRA model output for the second prompt](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/quantization-backends-diffusers2/alphonse_mucha_merged3_qlora_bf16.png) | 
| "Ornate fox with a collar of autumn leaves and berries, amidst a tapestry of forest foliage, alphonse mucha style" | ![Base model output for the third prompt](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/quantization-backends-diffusers2/alphonse_mucha_base5_bf16.png) | ![QLoRA model output for the third prompt](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/quantization-backends-diffusers2/alphonse_mucha_merged5_qlora_bf16.png) | 
...
### 
	...
	](https://huggingface.co#model-comparison-base-vs-qlora-fine-tuned-fp16)
...
| Prompt | Base Model Output | QLoRA Fine-tuned Output (Mucha Style) | 
|---|---|---|
| "Serene raven-haired woman, moonlit lilies, swirling botanicals, alphonse mucha style" | ![Base model output for the first prompt](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/quantization-backends-diffusers2/alphonse_mucha_base2.png) | ![QLoRA model output for the first prompt](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/quantization-backends-diffusers2/alphonse_mucha_merged2.png) | 
| "a puppy in a pond, alphonse mucha style" | ![Base model output for the second prompt](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/quantization-backends-diffusers2/alphonse_mucha_base3.png) | ![QLoRA model output for the second prompt](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/quantization-backends-diffusers2/alphonse_mucha_merged3.png) | 
| "Ornate fox with a collar of autumn leaves and berries, amidst a tapestry of forest foliage, alphonse mucha style" | ![Base model output for the third prompt](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/quantization-backends-diffusers2/alphonse_mucha_base5.png) | ![QLoRA model output for the third prompt](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/quantization-backends-diffusers2/alphonse_mucha_merged5.png) | 

## 
	[
		
	](https://huggingface.co#fp8-fine-tuning-with-torchao)
...
We fine-tuned FLUX.1-dev LoRA on an H100 SXM GPU slightly modified`diffusers-torchao`[training scripts](https://gist.github.com/sayakpaul/f0358dd4f4bcedf14211eba5704df25a#file-train_dreambooth_lora_flux-py). The following command was used:
...
- **Injecting FP8 layers**into the model using- `convert_to_float8_training`from- `torchao.float8`.
- **Defining a**to specify which modules should and should not be converted to FP8.- `module_filter_fn`
...
## 
	...
	](https://huggingface.co#inference-with-trained-lora-adapters)
...
### 
	...
	](https://huggingface.co#option-1-loading-lora-adapters)
...
### 
	...
	](https://huggingface.co#option-2-merging-lora-into-base-model)
...
## 
	...
	](https://huggingface.co#running-on-google-colab)
...
### 
	...
	](https://huggingface.co#share-your-creations-on-the-hub)
