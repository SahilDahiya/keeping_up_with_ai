...
secondary_topics: []
summary: Benchmarks PEFT methods beyond LoRA (LoHa, LoKr, OFT, BOFT, VeRA, FourierFT,
  prompt tuning, adapters) on a common task using the MetaMathQA benchmark suite in
  the PEFT repo, comparing accuracy, memory and checkpoint size to show when LoRA
  is and isn't the right default.
triage: null
skip_reason: null
source: huggingface
...
fetched: '2026-07-14T22:04:52Z'
classifier: claude
taxonomy_rev: 1
words: 2696
content_sha256: aebd314c49845e18f0a6759a2b4d997f754be2ad229194c44a477c5ecf235ce9
---

# Beyond LoRA: Can you beat the most popular fine-tuning technique?

Viewer • Updated  •  660k •  1.03k  •  24  

# 
	[
		
	](https://huggingface.co#beyond-lora-can-you-beat-the-most-popular-fine-tuning-technique)
	
		Beyond LoRA: Can you beat the most popular fine-tuning technique?
	

 [Update on GitHub](https://github.com/huggingface/blog/blob/main/peft-beyond-lora.md)

[  Upvote 75 ](https://huggingface.co/login?next=%2Fblog%2Fpeft-beyond-lora)

![Benjamin Bossan's avatar](https://cdn-avatars.huggingface.co/v1/production/uploads/1656685953025-62bf03d1e80cec527083cd66.jpeg) 

  ![Sayak Paul's avatar](https://cdn-avatars.huggingface.co/v1/production/uploads/1649681653581-5f7fbd813e94f16a85448745.jpeg) 

  ![Marian Tietz's avatar](https://cdn-avatars.huggingface.co/v1/production/uploads/no-auth/upIyVlEpqWqoeFTvNzTf5.png) 

  ![Kashif Rasul's avatar](https://cdn-avatars.huggingface.co/v1/production/uploads/1669189789447-629f3b18ee05727ce328ccbe.jpeg) 
...
# 
	...
	](https://huggingface.co#when-you-plan-to-fine-tune-a-model-in-a-parameter-efficient-way-think-beyond-lora)
...
# 
	...
	](https://huggingface.co#what-is-peft-and-when-do-you-need-it)
...
At Hugging Face, we develop the [ PEFT library](https://github.com/huggingface/peft), which implements many PEFT techniques behind a unified API and integrates well with the ecosystem, for example 

[and](https://huggingface.co/docs/transformers/main/en/peft)

`Transformers`[. It also supports](https://huggingface.co/docs/diffusers/main/en/api/loaders/peft)

`Diffusers`[multiple quantization methods](https://huggingface.co/docs/peft/developer_guides/quantization), enabling further accessibility in parameter-efficient fine-tuning.

`PEFT` provides a good starting point, whether you want to fine-tune on your own data or you're researching a new PEFT method.# 
	[
		
	](https://huggingface.co#lora-the-queen-of-fine-tuning-techniques-👑)
...
# 
	...
	](https://huggingface.co#choosing-the-right-peft-technique-based-on-paper-results-is-problematic)
...
# 
	...
	](https://huggingface.co#how-we-approach-benchmarking-in-peft)
...
# 
	...
	](https://huggingface.co#our-findings-lora-works-well-but-is-not-necessarily-the-best-choice)
...
| ![](https://huggingface.co/datasets/peft-internal-testing/peft-blog-assets/resolve/main/peft-beyond-lora/peft-shop.png) | 
...
# 
	...
	](https://huggingface.co#conclusion-and-what-you-can-do)
