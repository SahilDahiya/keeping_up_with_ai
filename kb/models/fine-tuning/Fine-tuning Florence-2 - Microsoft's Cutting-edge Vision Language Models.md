...
secondary_topics: []
summary: 'Fine-tunes Microsoft''s Florence-2 vision-language model on DocVQA, which
  the released checkpoints don''t support: seq2seq task formulation, freezing the
  vision encoder, and a DDP training loop with batch collation for image+text pairs.'
triage: null
skip_reason: null
source: huggingface
...
fetched: '2026-07-14T22:11:48Z'
classifier: claude
taxonomy_rev: 1
words: 1327
content_sha256: 1185eb32ee86c7c65c6bb3c779aad2631d7554a801fad8538f9cadb502e3ebef
---

# Fine-tuning Florence-2 - Microsoft's Cutting-edge Vision Language Models

Image-Text-to-Text •  0.8B • Updated   •  624  •  65  
...
In this post, we show an example on fine-tuning Florence on DocVQA. The authors report that Florence 2 can perform visual question answering (VQA), but the released models don't include VQA capability. Let's see what we can do!
 ...
 ![VLM Structure](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/florence-2.png)
...
To give a solid example, below we provide two inference results before and after fine-tuning. You can also try the model [here](https://huggingface.co/spaces/andito/Florence-2-DocVQA).
 ...
 ![Before After Fine-tuning](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/before-after.png)
...
We would like to thank Pedro Cuenca for his reviews on this blog post.
 ...
 Image-Text-to-Text •  0.8B • Updated   •  816k  •  1.83k 

 Viewer • Updated  •  50k •  2.85k  •  46 
...
nlpcommunityresearch
 ...
 May 19, 2026 llmmoelong-context
