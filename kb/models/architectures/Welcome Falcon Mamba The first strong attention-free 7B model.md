...
secondary_topics: []
summary: 'Falcon Mamba 7B is a pure SSM (Mamba with extra RMSNorm for training stability)
  trained on 5.8T tokens: constant per-token generation time and flat memory regardless
  of context length, with throughput and benchmark comparisons against attention-based
  7Bs.'
triage: null
skip_reason: null
source: huggingface
...
fetched: '2026-07-14T22:09:55Z'
classifier: claude
taxonomy_rev: 1
words: 1702
content_sha256: 04a0183cac92251e7f2754a7be07d8e838eff634e28fdd402d6ee067ce0d9559
---

# Welcome Falcon Mamba: The first strong attention-free 7B model

Text Generation •  7B • Updated   •  166k  •  244  
...
- takes a constant amount of time to generate a new token, regardless of the size of the context (see this [section](https://huggingface.co#hardware-performance))
...
Next, we measure the generation throughput in a setting with a prompt of length 1 and up to 130k generated tokens, using batch size 1 and H100 GPU. The results are reported in the [figure](https://huggingface.co#throughput) below. We observe that our Falcon Mamba is generating all the tokens at constant throughput and without any increase in CUDA peak memory. For the transformer model, the peak memory grows, and generation speed slows down as the number of generated tokens grows.
...
The authors would also like to thank Tri Dao and Albert Gu for implementing and open-sourcing Mamba architecture to the community.
 ...
 Text Generation •  7B • Updated   •  14  •  11 

  7B • Updated   •  229  •  12 

 Viewer • Updated  •  14 •  8.82k   
