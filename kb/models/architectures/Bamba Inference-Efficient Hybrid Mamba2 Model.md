...
summary: Bamba-9B is a hybrid Mamba2/transformer model trained by IBM, Princeton,
  CMU and UIUC on 2.2T tokens of fully open data, delivering 2.5x throughput and 2x
  lower latency than a comparable transformer in vLLM by shrinking the KV-cache memory-bandwidth
  bottleneck. Covers the hybrid architecture, training lineage, checkpoints and vLLM/transformers/llama.cpp
  enablement.
triage: null
skip_reason: null
source: huggingface
url: https://huggingface.co/blog/bamba
author: LINSONG CHU; Divya Kumari; Tri Dao; Albert Gu; Raghu Ganti; Dakshi Agrawal;
  Mudhakar Srivatsa; Davis Wertheimer; Yu Chin Fabian Lim; Antoni Viros; Nelson Gonzalez;
  Tuan HoangTrong; Ofir Arviv; Yotam Perlitz; Michal Shmueli; Haochen Shen; Zhang;
  Gabe Goodhart; Naigang Wang; Nick Hill; Joshua Rosenkranz; Chi-Chun Liu; Adnan Hoque;
  Chih-Chieh Yang; Sukriti Sharma; Anh Uong; Jay Gala; Syed Zawad; Ryan Gordon
published: '2024-12-18'
fetched: '2026-07-14T22:09:25Z'
classifier: claude
taxonomy_rev: 1
words: 4582
content_sha256: f72040e7d835a8335c8433d7ab1ba808af4060fc9fa6cebd3036a88ff2d8ceb6
---

# Bamba: Inference-Efficient Hybrid Mamba2 Model

Text Generation •  8B • Updated   •  708k  •  296  
...
guest
  ...
  ![Bamba](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/bamba/bamba.jpeg) 
...
- [Hugging Face Bamba collection](https://huggingface.co/collections/ibm-fms/bamba-674f1388b9bbc98b413c7bab)
- [GitHub repo with inference, training, and tuning scripts](https://github.com/foundation-model-stack/bamba)
- [Data loader](https://github.com/foundation-model-stack/fms-fsdp/blob/main/fms_fsdp/utils/dataset_utils.py)
- [Quantization](https://github.com/foundation-model-stack/fms-model-optimizer)
- [Auto-pilot for cluster monitoring](https://github.com/IBM/autopilot)
...
| ![Figure 1 Figure 1](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/bamba/bamba_llama_txput_ratios.png) | 
|---|
| Figure 1:Throughput improvements of Bamba | 
| ![Figure 2 Figure 2](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/bamba/bamba_llama_latencies_ratios.png) | 
...
![Datamix](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/bamba/datamix.png) 
...
![Datamix](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/bamba/phonebook.png) 
...
- Enabling `fp8`kernels to make inference even faster.
- Training time improvements and applying `torch.compile`as well as`fp8`training, both of which our team has[demonstrated](https://pytorch.org/blog/training-using-float8-fsdp2/)on transformer architectures working with Meta.
- Long context length extensions up to 1M+
...
A comparison of compute flops during prefill stage and memory (read+write) sizes during decode stage between Bamba and LLaMa models is shown below. Note that ratios lesser than 1 are beneficial. With inference throughput primarily bottlenecked by decode stage, the potential speedup for Bamba (over LLaMa) is 5x for large sequence lengths (> 16K). Current measurements (on vLLM) hover at 2.5x, which we expect to improve in the near future.
  ...
  ![ArithmeticIntensity](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/bamba/ArithmeticIntensity.png) 
 ...
 Text Generation •  7B • Updated   •  55.3k  •  653 

 Text Generation •  7B • Updated   •  1.92k  •  14 

 Text Generation •  9B • Updated   •  80.4k  •  714 

 Text Generation •  8B • Updated   •  962  •  26 

 Text Generation •  Updated   •  122  •  4.51k 

 Text Generation •  8B • Updated   •  1.64M  •  2.32k 

 Text Generation •  7B • Updated   •  281  •  24 

 Viewer • Updated  •  3.5B •  362k  •  1.19k 

 Viewer • Updated  •  31.1M •  16.9k  •  725 

 Viewer • Updated  •  621M •  41.5k  •  88 

 Viewer • Updated  •  939k •  1.05k  •  60 

 Viewer • Updated  •  1.05M •  1.44k  •  465 

 Viewer • Updated  •  99.5k •  600  •  30 
...
Track, rank and evaluate open LLMs and chatbots
 ...
 Paper • 2312.00752 • Published  •  152 

 Paper • 2402.19427 • Published  •  58 

 Paper • 2403.19887 • Published  •  113 

 Paper • 2406.06484 • Published  •  4 
...
nlpcommunityresearch
 ...
 May 19, 2026 nlpevaluationretrieval
