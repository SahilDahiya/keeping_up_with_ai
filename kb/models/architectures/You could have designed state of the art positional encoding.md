...
secondary_topics: []
summary: Derives RoPE from first principles by iteratively fixing naive positional-encoding
  schemes (integer positions, binary, sinusoidal) until arriving at rotary embeddings
  as used in Llama 3.2, then extends to 2D/context-length scaling.
triage: null
skip_reason: null
source: huggingface
...
fetched: '2026-07-14T22:11:36Z'
classifier: claude
taxonomy_rev: 1
words: 2683
content_sha256: cc83375d82b7a68cffc58c585118592bfc7d194ef1a1b4ec37fbac1e8b4fd330
---
...
[Update on GitHub](https://github.com/huggingface/blog/blob/main/designing-positional-encoding.md)

[  Upvote 490 ](https://huggingface.co/login?next=%2Fblog%2Fdesigning-positional-encoding)

![Christopher Fleetwood's avatar](https://cdn-avatars.huggingface.co/v1/production/uploads/6597e9f42235d4056bc6980a/6N_Eira5Rj5e8ZdgekKPQ.jpeg) 
...
## 
	...
	](https://huggingface.co#problem-statement)
...
## 
	...
	](https://huggingface.co#motivating-example)
...
## 
	...
	](https://huggingface.co#desirable-properties)
...
#### 
	...
	](https://huggingface.co#property-1---unique-encoding-for-each-position-across-sequences)
...
#### 
	...
	](https://huggingface.co#property-2---linear-relation-between-two-encoded-positions)
...
#### 
	...
	](https://huggingface.co#property-3---generalizes-to-longer-sequences-than-those-encountered-in-training)
...
#### 
	...
	](https://huggingface.co#property-4---generated-by-a-deterministic-process-the-model-can-learn)
...
#### 
	...
	](https://huggingface.co#property-5---extensible-to-multiple-dimensions)
...
## 
	...
	](https://huggingface.co#integer-position-encoding)
...
In the above animation, we create our positional encoding vector for the token  from the index and add it to our token embedding. The embedding values here are a subset of the real values from **Llama 3.2 1B**. We can observe that they're clustered around 0. This
...
## 
	...
	](https://huggingface.co#binary-position-encoding)
...
## 
	...
	](https://huggingface.co#sinusoidal-positional-encoding)
...
in the positional encoding vector, and  is the model dimension.  is the **base wavelength** (henceforth referred to as ), which we stretch or compress as a function of the component index. I encourage you to plug in some realistic values to get a feel for this
geometric progression.

There's a few parts of this equation that are confusing at first glance. How did the
authors choose ? Why are we using  **and**  for even and odd positions respectively?
...
result of our derivation is oddly familiar. That's right, it's the [Rotation Matrix!](https://en.wikipedia.org/wiki/Rotation_matrix) . 
...
## 
	...
	](https://huggingface.co#absolute-vs-relative-position-encoding)
...
## 
	...
	](https://huggingface.co#positional-encoding-in-context)
...
## 
	...
	](https://huggingface.co#rotary-postional-encoding)
...
## 
	...
	](https://huggingface.co#extending-rope-to-katexparse79marker-dimensions)
