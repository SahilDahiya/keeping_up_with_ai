...
source: arize
url: https://arize.com/blog/two-labs-started-dreaming-and-they-built-two-different-architectures/
author: Jim Bennett
published: '2026-06-17'
fetched: '2026-07-11T04:56:51Z'
classifier: codex
taxonomy_rev: 1
words: 2125
content_sha256: 74cb2b855614c12f76793b2103cde31710f1591e6805b0ec771caab9a940324b
---
...
Anthropic preserves the input store and produces a parallel artifact. OpenAI rewrites the memory in place and lets the next pass condition on the previous one’s output. Both companies use the same word for the feature, but they made opposite bets about whether the dream should be reversible.![Two architectures of dreaming](https://arize.com/wp-content/uploads/2026/06/dreaming-piece-architectures-of-dreaming-scaled.png)
...
In May 2026, Dylan Zhang at the University of Illinois Urbana-Champaign published * Useful Memories Become Faulty When Continuously Updated by LLMs* (

[project page](https://dylanzsz.github.io/faulty-memory/), arXiv 2605.12978). The paper is the cleanest empirical case yet made against the iterated-consolidation pattern, and the central finding is striking.

![The consolidation collapse: three benchmarks, same pattern](https://arize.com/wp-content/uploads/2026/06/dreaming-piece-zhang-collapse-scaled.png)
...
If you are a team building memory consolidation into an agent, the practical takeaway from the launches and the research is straightforward.![Shipping dreaming: a four-step workflow](https://arize.com/wp-content/uploads/2026/06/dreaming-piece-what-to-do-workflow-scaled.png)
