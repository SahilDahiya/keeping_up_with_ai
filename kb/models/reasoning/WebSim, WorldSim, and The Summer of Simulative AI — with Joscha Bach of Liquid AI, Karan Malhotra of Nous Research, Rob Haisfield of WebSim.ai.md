---
title: WebSim, WorldSim, and The Summer of Simulative AI — with Joscha Bach of Liquid
  AI, Karan Malhotra of Nous Research, Rob Haisfield of WebSim.ai
topic: models
subtopic: reasoning
secondary_topics:
- models/multimodal
summary: Joscha Bach discussion of WebSim, WorldSim, and simulative AI as approaches
  to world modeling and reasoning.
source: latent-space
url: https://www.latent.space/p/sim-ai
author: Latent Space
published: '2024-04-27'
fetched: '2026-07-11T05:20:52Z'
classifier: codex
taxonomy_rev: 1
words: 11097
content_sha256: b5f825ec024ffb63877ccf062e206b05c695e99150061e0e2ce129e9b80d1496
---
...
*We are 200 people over our 300-person venue capacity for  AI UX 2024, but you can*


[subscribe to our YouTube](https://www.youtube.com/@latentspacetv)

*for the video recaps.*

*Our next event, and largest EVER, is the *[AI Engineer World’s Fair](https://ai.engineer/)*. See you there!*


Parental advisory: Adult language used in the first 10 mins of this podcast.

**Any accounting of Generative AI that ends with RAG as its “final form” is seriously lacking in imagination and missing out on its full potential.** While AI generation is very good for “spicy autocomplete” and “reasoning and retrieval with in context learning”, there’s a lot of untapped potential for **simulative AI*** *in exploring the [latent space of multiverses](https://www.latent.space/p/multiverse-not-metaverse) adjacent to ours.

## GANs

Many research scientists credit the 2017 Transformer for the modern foundation model revolution, but for many artists the origin of “generative AI” traces a little further back to the [Generative Adversarial Networks](https://arxiv.org/abs/1406.2661) proposed by Ian Goodfellow in 2014, spawning an army of variants and [Cats](https://thesecatsdonotexist.com/) and [People](https://en.wikipedia.org/wiki/StyleGAN#History) that do not exist:

![](https://substackcdn.com/image/fetch/$s_!gz6v!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Ffc82d999-5ab4-4afe-ab6e-4965959c91a3_653x497.png)

[swyx](https://x.com/swyx/status/1049412858755264512)

We can directly visualize the quality improvement in the decade since:

![](https://substackcdn.com/image/fetch/$s_!Noc1!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fc3f03fb1-32d8-45e4-b055-f99ee25e540a_646x400.png)

[Cris Valenzuela](https://twitter.com/c_valenzuelab/status/1562579547404455936)

## GPT-2

Of course, more recently, text generative AI started being [too dangerous to release in 2019](https://slate.com/technology/2019/02/openai-gpt2-text-generating-algorithm-ai-dangerous.html) and claiming headlines[1](https://www.latent.space#footnote-1). [AI Dungeon](https://en.wikipedia.org/wiki/AI_Dungeon) was the first to put GPT2 to a purely creative use, replacing human dungeon masters and DnD/[MUD](https://en.wikipedia.org/wiki/Multi-user_dungeon) games of yore.

![](https://substackcdn.com/image/fetch/$s_!PTdw!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F84a442b8-ad05-4dc8-ac5b-44e07c352130_672x395.jpeg)

More recent gamelike work like [the Generative Agents (aka Smallville) paper](https://arxiv.org/pdf/2304.03442) keep exploring the potential of simulative AI for game experiences.

## ChatGPT

Not long after ChatGPT broke the Internet, one of the most fascinating generative AI finds was [Jonas Degrave](https://twitter.com/317070) (of Deepmind!)’s [Building A Virtual Machine Inside ChatGPT](https://www.engraved.blog/building-a-virtual-machine-inside/):

![](https://substackcdn.com/image/fetch/$s_!duUp!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F497e6dc4-56fd-4eec-b09c-a464367b35be_727x878.png)
...
It is with this context we explain **WorldSim **and **WebSim**. We recommend you watch the WorldSim demo video on our YouTube for the best context, but basically if you are a developer it is a [Claude prompt](https://twitter.com/karan4d/status/1768836844207378463) that is a portal into another world of your own choosing, that you can navigate with bash commands that you **make up**.

![](https://substackcdn.com/image/fetch/$s_!ju_2!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F1d28ad77-8351-4bda-97f8-f43e264f3b01_649x744.png)

[Nous Research Twitter](https://x.com/NousResearch/status/1771735632035127594)

The live video demo was highly enjoyable:

![](https://substackcdn.com/image/fetch/$s_!GldZ!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F0aec95ba-0bb0-428e-a7c3-12ee4d82d3a0_640x661.png)

[the Claude “worldsim” prompt here](https://x.com/KevinAFischer/status/1770662161028874588)

Why Claude? Hints from Amanda Askell on the [Claude 3 system prompt](https://twitter.com/AmandaAskell/status/1765207842993434880) gave some inspiration, and subsequent discoveries that Claude 3 is "less nerfed” than GPT 4 Turbo turned the growing Simulative AI community into Anthropic stans.

## WebSim ([https://websim.ai/](https://websim.ai/))

This was a one day hackathon project [inspired by WorldSim](https://x.com/RobertHaisfield/status/1772830001853034975) that should have won:

![](https://substackcdn.com/image/fetch/$s_!ehSf!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F392db034-11c1-4b07-85ad-eee9290ea360_641x873.png)

In short, you type in a URL that you made up, and Claude 3 does its level best to generate a webpage that doesn’t exist, that would fit your URL. All form POST requests are intercepted and responded to, and all links lead to even more webpages, that don’t exist, that are generated when you make them. All pages are cachable, modifiable and regeneratable - see [WebSim for Beginners](https://websim.ai/c/lyIIJIEemsdt7wnJC) and [Advanced Guide](https://websim.ai/c/KGzeEDzv8IDXBOA2E).

In the demo I saw [we were able to “log in” to a simulation of Elon Musk’s Gmail account](https://x.com/swyx/status/1784178295950790671), and browse examples of emails that would have been in that universe’s Elon’s inbox. It was hilarious and impressive even back then.

Since then though, the project has become even more impressive, with both [Siqi Chen](https://x.com/blader/status/1783934771309253008) and [Dylan Field](https://x.com/zoink/status/1781536099351109875) singing its praises:

![](https://substackcdn.com/image/fetch/$s_!z8oe!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fc204ae84-46b8-412f-8eb1-67131dff876a_663x632.png)

## Joscha Bach

Joscha actually spoke at the [WebSim Hyperstition Night](https://partiful.com/e/5NR4Ax55HSQWGECzxvbl)[2](https://www.latent.space#footnote-2) this week, so we took the opportunity to get his take on Simulative AI, as well as a round up of all his other AI hot takes, for his first appearance on Latent Space. You can see it together with the **full 2hr uncut **demos of WorldSim and WebSim on YouTube[3](https://www.latent.space#footnote-3)!
...
We find this remarkably similar to [the concept of Reflexivity](https://twitter.com/swyx/status/1380218885761339394).

[3](https://www.latent.space#footnote-anchor-3)

Fun fact: the 5 hour process of creating this podcast was [also livestreamed](https://www.youtube.com/watch?v=s-KbmywhRqY), in case you’re curious to go behind the scenes.
