...
summary: Surveys open LLM research problems around hallucination, context length,
  efficiency, multimodality, agents, evaluation, and post-training behavior that shape
  engineering constraints.
source: chip-huyen
url: https://huyenchip.com/2023/08/16/llm-research-open-challenges.html
author: Chip Huyen
published: '2023-08-16'
fetched: '2026-07-11T05:08:50Z'
classifier: codex
taxonomy_rev: 1
words: 3639
content_sha256: d92fde7623d48ca11bcaabfac51af8f5d2d23468197d4241a7ace66f9f491337
---
...
![Context needed for a customer support query](https://huyenchip.com/assets/pics/llm-research/2-rag.jpg)
...
![Guanaco 7B's performance compared to ChatGPT GPT-3.5 and GPT-4](https://huyenchip.com/assets/pics/llm-research/4-llm-optimization.png)

    Four years ago, when I started working on the notes that would later become the section ** Model Compression** for the book

[, I wrote about four major techniques for model optimization/compression:](https://www.amazon.com/Designing-Machine-Learning-Systems-Production-Ready/dp/1098107969)

**Designing Machine Learning Systems**- **Quantization**: by far the most general model optimization method. Quantization reduces a model’s size by using fewer bits to represent its parameters, e.g. instead of using 32 bits to represent a float, use only 16 bits, or even 4 bits.
...
![Monarch Mixer architecture](https://huyenchip.com/assets/pics/llm-research/5-monarch-mixer.png)
...
![Timeline of advances of the three major methods in photonic matrix multiplication](https://huyenchip.com/assets/pics/llm-research/6-photonic-matrix-multiplication.png)
...
![Demographics of labelers for InstructGPT](https://huyenchip.com/assets/pics/llm-research/8-instructgpt-demographics.png)
...
![Self-reported demographics of contributors to OpenAssistant dataset](https://huyenchip.com/assets/pics/llm-research/8-openassistant-demographics.png)
...
![Chat has been used as the universal interface for superapps in China for over a decade](https://huyenchip.com/assets/pics/llm-research/9-superapp-chat-interface.png)
...
-
    Multiple messages per turn Currently, we pretty much assume one message per turn. This is not how my friends and I text. Often, I need multiple messages to complete my thought, because I need to insert different data (e.g. images, locations, links), I forgot something in the previous messages, or I just don’t feel like putting everything into a massive paragraph.
-
    Multimodal input In the realm of multimodal applications, most energy is spent on building better models, and very little on building better interfaces. Take [Nvidia’s NeVA chatbot](https://catalog.ngc.nvidia.com/orgs/nvidia/teams/playground/models/neva). I’m not a UX expert, but I suspect there might be room for UX improvement here.P.S. Sorry the NeVA team for calling you out. Even with this interface, your work is super cool! ![NVIDIA's NeVA interface](/assets/pics/llm-research/9-neva.png)
-
    Incorporating generative AI into your workflows Linus Lee covered this point well in his talk [Generative AI interface beyond chats](https://www.youtube.com/watch?v=rd-J3hmycQs). For example, if you want to ask a question about a column of a chart you’re working on, you should be able just point to that column and ask a question.
-
    Editing and deletion of messages How would editing or deletion of a user input change the conversation flow with the chatbot?
...
![Tokenization for non-English languages](https://huyenchip.com/assets/pics/llm-research/10-non-english-tokens.png)
