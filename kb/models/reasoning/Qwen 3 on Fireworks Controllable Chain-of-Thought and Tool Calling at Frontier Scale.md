...
secondary_topics:
- agents/tool-use
summary: Qwen 3 235B-A22B (128-expert MoE, 22B active) streams an explicit chain-of-thought
  trace alongside a structured tool call in the same completion, toggleable via reasoning_effort
  or /think //no_think tags, with recommended sampling params differing between thinking
