...
summary: Explores world models versus word models and why adversarial reasoning exposes
  limits in current LLM behavior.
source: latent-space
url: https://www.latent.space/p/adversarial-reasoning
author: Ankit Maloo
published: '2026-02-07'
fetched: '2026-07-11T05:14:56Z'
classifier: codex
taxonomy_rev: 1
words: 3770
content_sha256: 54bdd4864f8ae40fa7f7fc3bdf1eb0539c20d618050e08de246ac317f2931ce8
---
...
![](https://substackcdn.com/image/fetch/$s_!Pr4U!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fdd11f244-ccd7-4cdf-83ef-75c41099e276_1600x1220.png)
...
You don’t need a detailed model of your opponent’s mind[1](https://www.latent.space#footnote-1) as a requirement. Yes it helps, but you need only calculate: given this board, what is the best move assuming optimal play?
...
![](https://substackcdn.com/image/fetch/$s_!MzxQ!,w_2400,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F2d658e95-64d4-4549-b7a7-cd252cbedd95_1600x788.png)
...
Editor: we’re coming back into familiar territory and it may be a good time to revisit our conversation with Noam Brown on AI for imperfect information vs game-theory-optimal poker games, and what that tells us for his multi-agent work:## Scaling Test Time Compute to Multi-Agent Civilizations: Noam Brown
...
Humans can model the LLM. The LLM can’t model being modeled. That gap is exploitable[5](https://www.latent.space#footnote-5), and no amount of “think strategically” prompting fixes it because the model doesn’t know what the adversary has already learned about it.

![](https://substackcdn.com/image/fetch/$s_!KJGG!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F73e4b49c-9a48-4781-bcae-ebeb0e6835b1_3026x1702.png)

**Why “More Intelligence” Isn’t the Fix**

The natural response is: surely smarter models will figure this out. **Just scale everything up**? More compute on more data on more parameters in pre-train, better reasoning traces[6](https://www.latent.space#footnote-6) in post-train, longer chains of thought at test-time. But, more raw IQ doesn’t fix the missing training loop even for professionals.
...
Steps 2–4 are possible with good prompting as in the example above. Step 1 is the problem. The model has no default ontology that distinguishes “cooperative task” from “task that looks cooperative but will be evaluated adversarially.”[7](https://www.latent.space#footnote-7)

![](https://substackcdn.com/image/fetch/$s_!D23E!,w_2400,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F07f91258-e01d-4e3e-8868-4f357531efcf_1600x291.png)
...
![](https://substackcdn.com/image/fetch/$s_!2ITs!,w_2400,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fc6651e22-efa5-4500-ba6e-34fa98c17941_1600x909.png)
...
There’s a deeper reason LLMs are at a permanent handicap here: **the thing you’re trying to learn is not fully contained in the text**[8](https://www.latent.space#footnote-8). They can catch up by sheer brute force, but are far more inefficient than humans, and the debt is coming due now.
...
**Editor:**** ****Ankit Maloo blogs at **[https://ankitmaloo.com/](https://ankitmaloo.com/) **and** **is working on  applied RL for real world agents. Give him a follow and check out his work!**
