...
summary: In TRL's GRPO setup, running vLLM in server mode leaves generation and training
  GPUs idling in turn; co-locating vLLM in the same process/GPUs as the trainer (sharing
  memory via a gpu_memory_utilization split and sleep/wake between phases) removes
  the idle gap, with throughput and GPU-utilization numbers across model sizes and
  TP configs.
triage: null
skip_reason: null
source: huggingface
url: https://huggingface.co/blog/vllm-colocate
author: Mert Toslali; Yu Chin Fabian Lim; Quentin Gallouédec; Ed Snible; Raghu Ganti;
  Mudhakar Srivatsa
published: '2025-06-03'
fetched: '2026-07-14T22:13:32Z'
classifier: claude
taxonomy_rev: 1
words: 2835
content_sha256: b5bd139e0386b0f6d4e15bc9fc6c41f5787d90020fd441f40c30f408b35efc41
---
...
# 
	...
	](https://huggingface.co#no-gpu-left-behind-unlocking-efficiency-with-co-located-vllm-in-trl)
	
		No GPU left behind: Unlocking Efficiency with Co-located vLLM in TRL
	

 [Update on GitHub](https://github.com/huggingface/blog/blob/main/vllm-colocate.md)

[  Upvote 101 ](https://huggingface.co/login?next=%2Fblog%2Fvllm-colocate)

![Mert Toslali's avatar](https://cdn-avatars.huggingface.co/v1/production/uploads/683ddb3724742a21487cf626/nLJ6NF7GDxKj2lVBtxvoy.jpeg) 

  [Mert Toslalitoslali-ibm    ](https://huggingface.co/toslali-ibm)

![ibm-ai-platform's avatar](https://cdn-avatars.huggingface.co/v1/production/uploads/660eeae04f7a69c50cf2ab99/mutmOPu-hv2RTKg5xihuy.jpeg)

[ibm-ai-platform](https://huggingface.co/ibm-ai-platform)

![Yu Chin Fabian Lim's avatar](https://cdn-avatars.huggingface.co/v1/production/uploads/651ea78a174c81a77545048f/Fgkbu6RA891icD7cAj8ut.jpeg) 

  [Yu Chin Fabian Limmirinflim    ](https://huggingface.co/mirinflim)

![ibm-ai-platform's avatar](https://cdn-avatars.huggingface.co/v1/production/uploads/660eeae04f7a69c50cf2ab99/mutmOPu-hv2RTKg5xihuy.jpeg)

[ibm-ai-platform](https://huggingface.co/ibm-ai-platform)

![Quentin Gallouédec's avatar](https://cdn-avatars.huggingface.co/v1/production/uploads/1677431596830-631ce4b244503b72277fc89f.jpeg) 

  ![Ed Snible's avatar](https://cdn-avatars.huggingface.co/v1/production/uploads/6458dbeac16ecb4815de49de/bu2pIHAU9onlJAG_YnPt8.png) 

  [Ed Snibleesnible    ](https://huggingface.co/esnible)

![ibm-ai-platform's avatar](https://cdn-avatars.huggingface.co/v1/production/uploads/660eeae04f7a69c50cf2ab99/mutmOPu-hv2RTKg5xihuy.jpeg)

[ibm-ai-platform](https://huggingface.co/ibm-ai-platform)

[Raghu Gantirganti    ](https://huggingface.co/rganti)

![ibm-ai-platform's avatar](https://cdn-avatars.huggingface.co/v1/production/uploads/660eeae04f7a69c50cf2ab99/mutmOPu-hv2RTKg5xihuy.jpeg)

[ibm-ai-platform](https://huggingface.co/ibm-ai-platform)

[Mudhakar Srivatsamudhakar    ](https://huggingface.co/mudhakar)
...
## 
	...
	](https://huggingface.co#🧨-the-problem)
...
## 
	...
	](https://huggingface.co#💡-the-opportunity)
...
### 
	...
	](https://huggingface.co#what-it-enables)
...
## 
	...
	](https://huggingface.co#🧩-design-from-separate-servers-to-shared-gpus)
...
### 
	...
	](https://huggingface.co#server-trl-setup-top-row)
...
### 
	...
	](https://huggingface.co#co-located-trl-setup-bottom-row)
...
## 
	...
	](https://huggingface.co#🛠️-implementation-notes)
...
`GRPOConfig`to avoid underutilization or out-of-memory errors.

## 
	[
		
	](https://huggingface.co#📊-showcase-co-located-vs-plain-trl-performance)
...
### 
	...
	](https://huggingface.co#experiment-1-15b-model--varying-batch-sizes)
...
### 
	...
	](https://huggingface.co#experiment-2-15b-model--varying-tensor-parallelism-tp)
...
- **Takeaway**: For small models, avoid over-sharding in co-located mode.![small-tp](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/vllm-colocate/small-tp.png) 

### 
	[
		
	](https://huggingface.co#experiment-3-7b-model--varying-batch-sizes)
	
		Experiment 3: 7B Model — Varying Batch Sizes
	

- Again, co-located mode **scales better with batch size**.
- Gains reach **1.35× speedup**at the largest batch tested.![med-b](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/vllm-colocate/med-b.png) 

### 
	[
		
	](https://huggingface.co#experiment-4-7b-model--varying-tensor-parallelism-tp)
...
- **Larger models benefit from sharding**in co-located setups.![med-tp](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/vllm-colocate/med-tp.png) 

## 
	[
		
	](https://huggingface.co#📊-scaling-to-72b-model)
...
### 
	...
	](https://huggingface.co#sleep-mode-in-vllm)
...
### 
	...
	](https://huggingface.co#deepspeed-optimizations)
...
- `"offload_optimizer": {"device": "cpu"}`Moves optimizer states to CPU to free GPU memory — critical in co-located setups.
- `"overlap_comm": true`Enables communication overlap with computation, speeding up training.
- `"contiguous_gradients": true`Allocates gradients in a single memory block, improving memory access and reducing fragmentation.
...
### 
	...
	](https://huggingface.co#accelerate-integration)
...
### 
	...
	](https://huggingface.co#experiment-5-qwen25-math-72b--throughput-accuracy-and-benchmark-results)
...
#### 
	...
	](https://huggingface.co#reward-curve)
...
- There’s **no regression in model learning performance**![blogpost_72b_rewards](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/vllm-colocate/blogpost_72b_rewards.png) 

#### 
	[
		
	](https://huggingface.co#math500-benchmark)
...
## 
	...
	](https://huggingface.co#🎓-challenges--lessons-learned--next-steps)
...
### 
	...
	](https://huggingface.co#challenges)
...
### 
	...
	](https://huggingface.co#lessons-learned)
...
## 
	...
	](https://huggingface.co#✅-give-it-a-try)
...
### 
	...
	](https://huggingface.co#📄-train_grpo_colocatepy)
