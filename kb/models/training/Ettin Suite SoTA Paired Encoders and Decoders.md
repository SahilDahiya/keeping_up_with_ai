...
summary: Ettin is the first suite of paired encoder-only and decoder-only models (17M-1B
  params) trained on identical data (2T tokens), architecture and recipe, giving a
  true apples-to-apples MLM vs causal-LM comparison. The open ModernBERT-style recipe
  beats ModernBERT on encoder tasks and beats Llama 3.2 1B and SmolLM2 on decoder
  tasks; also tests cross-objective continued training.
triage: null
skip_reason: null
source: huggingface
url: https://huggingface.co/blog/ettin
author: Orion Weller; K Ricci; Marc Marone; Antoine Chaffin; Dawn Lawrie; Ben Van
  Durme
published: '2025-07-16'
fetched: '2026-07-14T22:08:57Z'
classifier: claude
taxonomy_rev: 1
words: 3211
content_sha256: 82ba7fd350b8d014e66ed6aee8305237d7469754db51d5582eb8d3090d0907ee
---

# Ettin Suite: SoTA Paired Encoders and Decoders

Fill-Mask •  Updated   •  1.33k  •  6  
...
If you are interested in trying out the models, some boilerplates are available [at the end of this blogpost!](https://huggingface.co#usage-examples)
...
- [📊 250+ Training Checkpoints](https://huggingface.co/jhu-clsp/ettin-checkpoints)for studying training dynamics or knowledge learning
 ...
 Fill-Mask •  Updated   •  564  •  1 

 Text Generation •  Updated   •  147   

 Text Generation •  Updated   •  142  •  4 

 Fill-Mask •  Updated   •  207  •  1 

 Fill-Mask •  Updated   •  5.63k  •  13 

 Fill-Mask •  Updated   •  3.34k  •  19 

 Feature Extraction •  Updated   •  1.32k  •  13 

 Fill-Mask •  Updated   •  7.43k  •  11 

 Fill-Mask •  Updated   •  64.4k  •  5 
...
- +2
 ...
 September 9, 2025 llmnlpreasoning
...
- +19
 ...
 July 8, 2025 Any chance you can add the trained sentence transformer versions of these models? It'd be very useful (And I lack compute for training from scratch :))

Yes, we’re working with some people to get some trained embeddings versions. Hopefully you won’t have to wait too long :)

Assim como aplicar uma receita de treino inovadora pode superar modelos de ponta, [FondecranVIP ](https://fondecranvip.com/) redefine o visual do seu dispositivo com wallpapers exclusivos e de alta qualidade, levando sua personalização a um nível superior. 

Thank you for an interesting study.

Do you have plans to create encoder-decoder models from these?
