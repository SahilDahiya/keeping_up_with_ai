---
title: Why P&C Insurers Use AI Agents for FNOL and Claims
kind: blog
topic: null
subtopic: null
secondary_topics: []
...
skip_reason: null
source: cresta
url: https://cresta.com/blog/why-p-c-insurers-are-turning-to-ai-agents-for-fnol-and-claims-support
author: Russell Banzon
published: '2026-01-29'
fetched: '2026-09-11T06:11:22Z'
classifier: null
taxonomy_rev: 2
words: 1127
content_sha256: 2acbdfb725326addc0982fe5780bd6c6c1835d24026df88e2410685d87daf7db
---

# Why P&C Insurers Use AI Agents for FNOL and Claims
...
The first interaction following an incident—the First Notice of Loss (FNOL)—is one of the most consequential moments in the insurance experience. According to [J.D. Power](https://appian.com/industries/insurance/solutions/first-notice-of-loss-coordination), FNOL accounts for 26% of the overall customer satisfaction index. This single interaction sets expectations for the entire claims journey. When handled well, it builds confidence and trust. When handled poorly, it can permanently damage the relationship.

The stakes are high. [Research](https://www.xtract360.com/resources/the-complete-guide-to-fnol-first-notice-of-loss) from Accenture shows that 83% of customers switch providers after a negative claims experience. For insurers, this makes the contact center not just a service function, but a critical driver of retention and brand perception.
...
AI agents (wether built in house or via [AI agent platforms for insurance](https://cresta.com/guides/best-ai-agent-insurance-contact-centers)) are well suited to address these challenges, particularly in high-volume, time-sensitive interactions where speed and accuracy directly influence customer trust.
...
This initial FNOL interaction is the foundation of the entire claims experience. Beyond its contribution to overall satisfaction, [87% of policyholders](https://info.fivesigmalabs.com/state-of-claims-intelligence-report-2023) report that the claims experience influences their decision to remain with their insurer.
...
- **Data quality issues:** Stress impairs recall, and manual entry increases the risk of missing or incorrect information. A[Pollfish survey](https://www.himarley.com/hi-marleys-frequently-asked-questions/) found satisfaction drops from 86% when details are shared once to just 7% when repeated six or more times
...
[Cresta AI Agent](https://cresta.com/ai-agent) delivers human-like conversations across channels while protecting your brand, data, and compliance requirements. Insurers no longer have to choose between operational efficiency and exceptional customer experience.
...
Learn more about Cresta AI Agent capabilities and connect with our team for a personalized [demo](https://cresta.com/request-a-demo).
