...
fetched: '2026-08-26T06:09:40Z'
classifier: null
taxonomy_rev: 2
words: 2403
content_sha256: 4c19c0ba665341c8cffb884e4dcd18cfd2ee563e4c636308ee8ea7acb50c074f
---
...
[See the demo Second Voice (opens in a new tab)](https://devpost.com/software/second-voice-uk1peq)

![Second Voice conversation support app welcome screen](https://developers.openai.com/images/blog/build-week-winners/second-voice.webp) 

 “The smallest UX decisions carried the most weight. For someone with limited motor control trying to get a word in mid-conversation, those choices are the product. A technically working app is not enough if it is unusable in practice.” — Ravitez Dondeti
...
[See the demo AirBridge for Windows (opens in a new tab)](https://devpost.com/software/airbridge-for-windows)

![AirBridge for Windows demo with an AirPlay speaker](https://developers.openai.com/images/blog/build-week-winners/airbridge-for-windows.webp) 

 “I’ve been a software engineer for over 10 years, although this was my first hackathon. No matter your skill level, or how big or small your idea is, it’s worth entering a hackathon. You can’t win if you don’t play.” – Adam Tarantino
...
[See the demo veTriage (opens in a new tab)](https://devpost.com/software/veterinary-four-color-triage-app)

![veTriage veterinary triage demo with a veterinary nurse and dog](https://developers.openai.com/images/blog/build-week-winners/vetriage.webp) 

 “At 61, I would hope to encourage other people with deep domain expertise to see that it is not too late to become builders. I have no coding background, but I discovered that domain expertise can be a starting point for building solutions.” – Erin Downes
...
[See the demo Pulse (opens in a new tab)](https://devpost.com/software/pulse-ewjaf9)

![Pulse cardiac arrest support demo in a hospital room](https://developers.openai.com/images/blog/build-week-winners/pulse.webp) 

 “Pulse was built in Cairo, between hospital shifts, with no team, no lab, and no funding. There is a quiet assumption that serious medical tools have to come from a university group or a well-funded startup. This is a small piece of evidence against that.”
...
[See the demo Echo Canvas (opens in a new tab)](https://devpost.com/software/echo-canvas-ujzksi)

![Echo Canvas spatial audio workbench interface](https://developers.openai.com/images/blog/build-week-winners/echo-canvas.webp) 

 “More rays do not automatically produce a better product. We also learned that AI is most reliable as a constrained authoring and explanation layer, not as a replacement for geometry or real-time DSP.”
...
[See the demo Sentinel (opens in a new tab)](https://devpost.com/software/sentinel-way5bd)

![Sentinel MCP server security analysis results in a terminal](https://developers.openai.com/images/blog/build-week-winners/sentinel.webp) 

 “Constraining a model is harder than prompting one. Most of my work wasn’t prompt engineering. It was building schema checks, rules against citing code that doesn’t exist, and probe templates [GPT-5.6] can parameterize but never write.”
...
[See the demo Mechanica (opens in a new tab)](https://devpost.com/software/xiaoqiang)

![Mechanica interactive reconstruction of an ancient Chinese machine](https://developers.openai.com/images/blog/build-week-winners/mechanica.webp) 

 “The limit really is my imagination. I’ve written software for 25 years, but 3D and animation were completely outside my lane, and that barrier is simply gone now. People can build far beyond their own specialty.” – Weiying Zhu
...
[See the demo Dấu (opens in a new tab)](https://devpost.com/software/d-u-see-your-vietnamese-tones)

![Dấu Vietnamese tone-learning interface with pitch curves and coaching](https://developers.openai.com/images/blog/build-week-winners/dau.webp) 

 “I went from wondering if I was technical enough to belong at a hackathon to having something I built solo become a finalist. AI is making it possible for way more people to become builders, and you don’t need to wait until you feel technical enough to do the thing.” – Robert Huynh
