...
author: Artem Chumachenko; Egor Timofeev; Jasmine Li; Ruslan Khaidurov; Nikita Smetanin;
  Sergei Vorobyov; Arseniy Belorukov; Denis Fedorenko; Alex Moldovan; Shadi Mokhtar;
...
![Metrics tab of a fine-tuning job showing live loss, gradient norm and learning rate curves for two runs.](https://cdn.prod.website-files.com/69654e88dce9154b5f12070c/6aa40241206309e4ded7e680_6aa4015e43a8c6939df58aad_ft-sep26-01-metrics-tab.png)

![Comparison view charting the training loss of two fine-tuning jobs on one set of axes.](https://cdn.prod.website-files.com/69654e88dce9154b5f12070c/6aa40241206309e4ded7e68a_6aa4019891ce073e979eafe1_ft-sep26-02-job-comparison.png)

![Terminal running together fine-tuning list-metrics, plotting loss, gradient norm and learning rate in place.](https://cdn.prod.website-files.com/69654e88dce9154b5f12070c/6aa40241206309e4ded7e686_6aa4019a7a0c9f069f0cf061_ft-sep26-03-cli-list-metrics.png)
...
![Bar chart: expert-touching LoRA beats attention-only adapters on knowledge injection, memorization and locality for gemma-4-26B-A4B and Qwen3.6-35B-A3B.](https://cdn.prod.website-files.com/69654e88dce9154b5f12070c/6aa40241206309e4ded7e67a_6aa4019a03bf0eb60a53a88b_ft-sep26-04-knowledge-injection.png)

![Line chart of dead experts as a share of routed experts across training steps: attention-only training lets experts die while expert LoRA keeps them engaged.](https://cdn.prod.website-files.com/69654e88dce9154b5f12070c/6aa40241206309e4ded7e692_6aa4019ad062cc7bae64dfa0_ft-sep26-05-expert-utilization.png)
...
Enabling expert adapters is simple: just add the expert modules to `lora_trainable_modules`. The rest of the fine-tuning workflow remains the same as it does for [any other LoRA job](https://docs.together.ai/docs/fine-tuning/lora-vs-full#target-moe-expert-layers).
...
1. Adaptive Data, which shapes data at scale
2. Adaptive Intelligence, which evolves models across industries and languages
3. Adaptive Interfaces, which reimagines human-AI interaction
...
![Tokenized dataset preview listing tokens, trained token count, truncation status, trained spans and a token preview for the first row.](https://cdn.prod.website-files.com/69654e88dce9154b5f12070c/6aa40241206309e4ded7e67d_6aa4019abdce8f79a40c3d0f_ft-sep26-06-tokenized-preview.png)

![Fine-tuning job details page with the Download link for the prepared tokenized dataset highlighted.](https://cdn.prod.website-files.com/69654e88dce9154b5f12070c/6aa40241206309e4ded7e68d_6aa4019b7a0c9f069f0cf160_ft-sep26-07-job-details-download.png)
...
![Diagram: short samples concatenated into one packed sequence, alongside the 2D attention mask that prevents cross-sample attention.](https://cdn.prod.website-files.com/69654e88dce9154b5f12070c/6aa40241206309e4ded7e683_6aa4019d63ec247b66abf456_ft-sep26-08-sequence-packing.png)

[here](https://www.researchgate.net/figure/sualization-of-sequence-packing-and-the-corresponding-2D-attention-mask-that-prevents_fig1_400971234)under
