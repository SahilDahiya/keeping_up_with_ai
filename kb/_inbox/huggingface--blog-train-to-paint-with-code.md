...
[Reinforcement Learning •  Updated   •  7  •  1](https://huggingface.co/HuggingEnvs/watercolour-grpo-hps-led)  

#### HuggingEnvs/watercolour-grpo-hps-led

![](https://cdn-avatars.huggingface.co/v1/production/uploads/6442d975ad54813badc1ddf7/geLwUK5ejvER1NTnVkKul.png) 
...
environment you need to build](https://huggingface.co#the-rl-environment-you-need-to-build).
...
`draw()` and what it renders to. The comments are the model's own. Reward 0.864, 129 lines, step 22. The full source of every painting is in the rollouts dataset.
...
`judge-led` run, best four of each. Whether step 12's paintings look half a point worse is for you to decide.
...
The method and original idea are Surya Narreddi's. The library is Alejandro Campos Uribe's.
 ...
 Reinforcement Learning •  Updated   •  24  •  1 

 Reinforcement Learning •  Updated   •  9  •  1 

 Image-Text-to-Text •  Updated   •  179  •  34 

 Text Generation •  80B • Updated   •  434k  •  1.63k 

 Image-Text-to-Text •  31B • Updated   •  397k  •  598 

 Image-Text-to-Text •  125B • Updated   •  697k  •  613 

 Image-Text-to-Text •  36B • Updated   •  2.36M  •  1.5k 

 Image-Text-to-Text •  2.8T • Updated   •  2.62M  •  11.2k 

 Text Generation •  753B • Updated   •  1.19M  •  5.07k 

 Viewer • Updated  •  178 •  45  •  1 

 Viewer • Updated  •  872    

 Viewer • Updated  •  470 •  40   
