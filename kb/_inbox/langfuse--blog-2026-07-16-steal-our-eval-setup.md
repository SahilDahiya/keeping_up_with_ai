...
skip_reason: null
source: langfuse
url: https://langfuse.com/blog/2026-07-16-steal-our-eval-setup
author: null
...
# Yes, you can copy our eval setup - Langfuse
...
Annabell Schäfer"Build custom evals," they say. Yes, but "custom" doesn't mean "from scratch." For a huge chunk of eval design, especially for something as well-trodden as a chatbot, teams are solving a problem thousands of teams have already solved. Here's our setup for our docs chatbot, in full. Ready to copy.

To follow along, explore the [Langfuse example project](https://langfuse.com/docs/demo), the public Langfuse
...
[The chatbot we evaluate](https://langfuse.com#the-chatbot-we-evaluate)
...
[Trace every step](https://langfuse.com#trace-every-step)
...
![Trace detail view showing user ID, session ID, tool use, scores, input, and output](https://langfuse.com/_next/image?url=%2Fimages%2Fblog%2F2026-07-16-steal-our-eval-setup%2Fchatbot-trace-detail.png&w=3840&q=75)
...
![User detail view showing a focused list of chatbot traces for one returning user](https://langfuse.com/_next/image?url=%2Fimages%2Fblog%2F2026-07-16-steal-our-eval-setup%2Fuser-focused-traces.png&w=3840&q=75)
...
[Monitor what is going on in prod](https://langfuse.com#monitor-what-is-going-on-in-prod)
...
![Running evaluator scores for the docs chatbot including disagreement, relevance, cursing, and user intent](https://langfuse.com/_next/image?url=%2Fimages%2Fblog%2F2026-07-16-steal-our-eval-setup%2Frunning-evaluator-scores.png&w=3840&q=75)


[What counts as interesting?](https://langfuse.com#what-counts-as-interesting)
...
[How do we define quality?](https://langfuse.com#how-do-we-define-quality)
...
[These signals reach us through dashboards and alerts](https://langfuse.com#these-signals-reach-us-through-dashboards-and-alerts)
...
![Production score monitoring dashboard for the docs chatbot](https://langfuse.com/_next/image?url=%2Fimages%2Fblog%2F2026-07-16-steal-our-eval-setup%2Fscore-monitoring-dashboard.png&w=3840&q=75)


![Monitor configuration for high user disagreement with warning and alert thresholds](https://langfuse.com/_next/image?url=%2Fimages%2Fblog%2F2026-07-16-steal-our-eval-setup%2Fmonitor-configuration.png&w=3840&q=75)


[Annotation queues, and why we still look ourselves](https://langfuse.com#annotation-queues-and-why-we-still-look-ourselves)
...
![Annotation queue item with pass/fail assessment and open coding fields](https://langfuse.com/_next/image?url=%2Fimages%2Fblog%2F2026-07-16-steal-our-eval-setup%2Fannotation-queue-item.png&w=3840&q=75)
...
[From annotations to a dataset](https://langfuse.com#from-annotations-to-a-dataset)
...
![General QA chatbot dataset with production and synthetic examples](https://langfuse.com/_next/image?url=%2Fimages%2Fblog%2F2026-07-16-steal-our-eval-setup%2Fgeneral-qa-chatbot-dataset.png&w=3840&q=75)
...
![Expected output on a chatbot dataset item with sample reply, keyword overlap, and behavior label](https://langfuse.com/_next/image?url=%2Fimages%2Fblog%2F2026-07-16-steal-our-eval-setup%2Fdataset-expected-output.png&w=3840&q=75)
...
[Datasets for domain-specific failures](https://langfuse.com#datasets-for-domain-specific-failures)
...
![SDK integration grounding dataset item with input and metadata](https://langfuse.com/_next/image?url=%2Fimages%2Fblog%2F2026-07-16-steal-our-eval-setup%2Fsdk-grounding-dataset-item.png&w=3840&q=75)
...
[Keep the loop running](https://langfuse.com#keep-the-loop-running)
