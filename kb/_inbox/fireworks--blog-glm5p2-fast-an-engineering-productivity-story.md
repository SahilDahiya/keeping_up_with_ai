...
GLM 5.2 Fast runs 2 to 3x faster than the standard path on shared serverless, keeps the full context window, and rewards cached input heavily, which is what makes long agentic coding loops practical and cheap. More on the serving details in [GLM 5.2 Fast is live on Fireworks](https://fireworks.ai/blog/glm-5p2-fast).
