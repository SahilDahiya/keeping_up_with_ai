...
fetched: '2026-07-28T06:51:32Z'
classifier: null
taxonomy_rev: 2
words: 1611
content_sha256: 06172d844e848e80d3df34cd74c838dfd49027906052319b011a3dbfbdae02cd
---
...
- •**#1 World Rank in Front-End Code**: K3 topped Arena's[Frontend Code Arena](https://x.com/arena/status/2077824029126504525?s=20)at 1,679 points, surpassing Fable 5. This makes it the first open model to sit ahead of every closed one. It also claims top spot on[Vercel's own Next.js evaluation suite](https://x.com/rauchg/status/2077900518404321759?s=20).
- •**Frontier Full Stack Coding:**It ranked #3 on[DeepSWE (Datacurve)](https://x.com/datacurve/status/2078189882707730535?s=20), only behind Fable 5 and GPT-5.6 Sol.
- •**Top Open Model for General Intelligence:**It is ranked #3 in the world on the[Artificial Analysis Intelligence Index](https://x.com/ArtificialAnlys/status/2077832874183860404?s=20)at 57, comparable to Opus and GPT-5.5-class models.
- •**#1 for writing in editorial voice on**: surpassing Claude Fable 5. That is a jump from #21 to #1 over its predecessor, Kimi K2.6.[2840 Elo](https://x.com/Whats_AI/status/2077860441380798908)
- •**Sets a New Standard for Legal Analysis**: K3 achieved a 26.7% all-pass rate on[Harvey’s LAB legal benchmark](https://artificialanalysis.ai/evaluations/harvey-lab-aa?eval-score=all-pass-rate), outperforming Fable 5 by nearly**2x**.
- •**Unmatched Performance for Customer service:**On[Sierra’s Tau3-Banking](https://artificialanalysis.ai/evaluations/tau3-banking)benchmark, K3 scored 33.4%, narrowly beating GPT 5.6 Sol.
- •**Top Tier on Multimodal Intelligence:**It ranks in the top two models globally for complex chart, screenshot, and dense document analysis ([CharXiv and Zerobench](https://x.com/Kimi_Moonshot/status/2077830229968683203?s=20)).
- •**High-End Cybersecurity:**Similar recall as GPT 5.5 on[Vercel’s private cybersecurity eval](https://x.com/cramforce/status/2078574147333152957?s=20)at a much lower price.
- •**Top Tier for Autonomous Game Development:**The developer community is buzzing about the new frontier for Agentic Game Development, from[Night Rider](https://x.com/HakeemPH41/status/2078219978395054341)to[Fluppy Bird](https://x.com/Sonika_KK/status/2078068051614859621)
...
- •Run Kimi K3 inference — [serverless quickstart](https://docs.fireworks.ai)
- •Review the Kimi K3 Model Card to get started — [here](https://fireworks.ai/models/fireworks/kimi-k3)
- •Train Kimi K3 on your data — [training docs](https://docs.fireworks.ai)
- •Want into the Serverless Training preview? — [reach out to the training team](https://fireworks.ai/contact-training)
