---
title: 'Real-time, performant code assistance: How Sourcegraph scaled with Fireworks'
kind: blog
topic: null
subtopic: null
secondary_topics: []
...
fetched: '2026-08-12T06:29:37Z'
classifier: null
taxonomy_rev: 2
words: 1200
content_sha256: 6e4f7ed703ec5e367797defa3b53da5d4f22b118f1fb1852528fb2fdbb6da50c
---

# Real-time, performant code assistance: How Sourcegraph scaled with Fireworks

[Sourcegraph](https://sourcegraph.com/) helps enterprises industrialize software development with AI. They have empowered developers with enterprise-grade code search and analysis for over a decade at companies like Stripe, Uber, government organizations, and top US banks. With the increasing demand for AI-driven coding assistants, Sourcegraph’s AI is designed to enhance code understanding and developer productivity even further.
...
1. **Real-time performance** : Sub-second latency was essential for features like multi-line code completion and autopilot-like coding assistance.
2. **Model limitations** : Other models were optimized for chat, not code completion, leading to quality issues.
3. **Context handling** : The need to process 1–2k tokens of context and generate 50–100 tokens of completion swiftly.
4. **Cost management** : Maintaining high performance while controlling costs was key to staying competitive.
...
- •**Model flexibility** : Fireworks supports a wide range of LLMs, enabling Sourcegraph to seamlessly integrate and test models like[DeepSeek-Coder-V2 and StarCoder](https://sourcegraph.com/changelog/default-enterprise-models) . The ability to quickly evaluate new models sped up iteration cycles and avoided vendor lock-in.
...
- •**Implementation support** : “Enterprise optimizations like[prompt speculation and training a draft model for speculative decoding](https://fireworks.ai/blog/accelerating-code-completion-with-fireworks-fast-llm-inference) were game-changers for reducing latency.”
...
1. **Optimize extensively** : Advanced techniques like FireAttention and speculative decoding can dramatically improve latency and user experience.
2. **Leverage model flexibility** : Incorporating specialized and OSS models accelerates iteration and enhances performance.
3. **Collaborate closely** : Strong partnerships drive faster innovation and better solutions.
4. **Stay agile** : Rapid deployment and flexible infrastructure are critical for maintaining a competitive edge.
...
Keep in touch with us on [Discord](https://discord.gg/fireworks-ai) or [Twitter](https://x.com/FireworksAI_HQ). Stay tuned for more updates coming soon!
