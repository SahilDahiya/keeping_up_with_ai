---
title: Architectural visualization with Astra | OpenAI Developers
kind: blog
topic: null
subtopic: null
secondary_topics: []
...
fetched: '2026-09-05T06:08:56Z'
classifier: null
taxonomy_rev: 2
words: 3883
content_sha256: 90765d2977fc53d708824ae68ccd1d7be45e4a792299f8c60fcd93ff0a98d29a
---
...
![The first Solace house rendered in Blender, with a low white roof, open furnished pavilion, timber screens, garden, and rectangular pool](https://cdn.openai.com/devhub/blog/architectural-visualization/original-courtyard-house-09be999ecfd3.webp)
...
![The original Solace pavilion surrounded by dense woodland, with low sunlight filtering through the trees toward the pool and illuminated living room](https://cdn.openai.com/devhub/blog/architectural-visualization/golden-hour-forest-f6761339ea68.webp)
...
![Solace Garden House concept floor plan: a central living, dining, and kitchen pavilion, three bedrooms and an office in two wings, a planted courtyard, and a pool terrace](https://cdn.openai.com/devhub/blog/architectural-visualization/garden-house-concept-plan-36481903216b.webp)

The concept floor plan we reviewed before rebuilding the house. Select the image to open it at full size.
...
![The expanded U-shaped Garden House rendered in Blender, with two furnished wings facing a planted courtyard and pool in the forest](https://cdn.openai.com/devhub/blog/architectural-visualization/garden-house-exterior-822ca33fb418.webp)

The expanded Garden House, rendered in Blender after the architectural and cinematic finishing passes.
...
![A Blender render of the Garden House living room showing the shaped sofa cushions, rounded coffee table, floor lamp, books, and ceramics on a full-height timber bookcase](https://cdn.openai.com/devhub/blog/architectural-visualization/garden-house-living-room-1c0e7ed4fa8f.webp)
...
![The Garden House kitchen and dining room rendered in Blender, with a timber dining table, curved chairs, pale island, brass tap, and large windows looking into the forest](https://cdn.openai.com/devhub/blog/architectural-visualization/garden-house-kitchen-dining-0c42f5052fd9.webp)

The kitchen and dining area, with the same restrained palette as the first house and more detail in the furniture and joinery.
...
![Close Blender render of the kitchen sink with a hollow steel bowl, rounded rim, brass tap, pale countertop, and oak cabinet front](https://cdn.openai.com/devhub/blog/architectural-visualization/garden-house-kitchen-detail-fa857a81e21e.webp)
...
![Untextured solid view of the actual Garden House Blender model, with the roof and surrounding forest hidden to reveal the U-shaped layout and furnished rooms](https://cdn.openai.com/devhub/blog/architectural-visualization/garden-house-solid-cutaway-bc0ed029bcfb.webp)

The actual Blender geometry in solid mode. The roof, surrounding forest, and window panes are hidden for this inspection view; the source model is unchanged.
...
![Later Blender render of the living room, with warm shelf lighting, timber grain, cushions, and an open journal, mug, phone, and keys on the coffee table](https://cdn.openai.com/devhub/blog/architectural-visualization/atelier-living-library-887b57a4de62.webp)

The living room after the detail and lighting pass, from a native 4K Cycles render.
...
![Later Blender render of the kitchen and dining room, with a set table, ribbed glasses, folded napkins, timber furniture, and warm light from modeled ceiling fixtures](https://cdn.openai.com/devhub/blog/architectural-visualization/atelier-kitchen-dining-57bd6510a4e7.webp)

The dining table and kitchen after the same pass. The table settings and lighting fixtures are geometry in the editable scene.
...
A poolside approach and a tour of the rooms, rendered in Blender using Cycles.
...
![Unreal Engine 5 still of the Garden House kitchen showing a pale island, curved timber stools, oven, coffee machine, sink, and woodland through the windows](https://cdn.openai.com/devhub/blog/architectural-visualization/ue5-kitchen-closeup-9dbf0b8bdf8b.webp)

A closer Unreal view of the kitchen, showing the island, stools, appliances, and timber surfaces. Captured from the packaged application with settings chosen for still images.
...
The updated house in Unreal Engine 5, including an interactive coffee machine.
...
![Blender storyboard for the Garden House, with a large woodland exterior above six labeled images of the living room, kitchen, office, bedroom, bathroom, and garden](https://cdn.openai.com/devhub/blog/architectural-visualization/solace-atelier-blender-storyboard-inline-1111c7788f77.webp)

The Blender storyboard, assembled from Cycles renders.

![Unreal Engine 5 storyboard for the Garden House, using the same seven subject labels and layout with still captures of the exterior, rooms, and courtyard](https://cdn.openai.com/devhub/blog/architectural-visualization/solace-atelier-ue5-storyboard-inline-ecd466e31e18.webp)
...
![Blender render of HELIOS showing a bright Sun inside an open spherical structure of triangular collector panels, trusses, and machinery, with planets around it](https://cdn.openai.com/devhub/blog/architectural-visualization/helios-stellar-collector-8f89b625bd2f.webp)

The original HELIOS collector, with an open shell revealing the Sun. The sizes and distances are composed for cinema rather than shown at a uniform astronomical scale.
...
![Blender render of a nearly closed HELIOS collector with three shafts of light escaping above Earth's curved horizon and illuminated cities](https://cdn.openai.com/devhub/blog/architectural-visualization/helios-earthward-closed-collector-ff43b5366b9b.webp)

The Earthward composition, with a nearly closed shell of 5,120 panels and three light openings. This view also uses cinematic scale and lighting.
...
![Blender render of AURELION-07's tapered ceramic hull, supporting struts, and segmented ring against a blue planet](https://cdn.openai.com/devhub/blog/architectural-visualization/aurelion-far-meridian-6f95d4a76080.webp)

AURELION-07, an individually modeled ship from the Shipyard project, rendered in Blender.
...
![Rear Blender render of AURELION-07 showing four detailed drive pods with service lines, metal bands, and luminous concentric nozzles](https://cdn.openai.com/devhub/blog/architectural-visualization/aurelion-fusion-departure-00fae78e55f3.webp)

A second view of the same ship makes the engine construction and surface details visible.
...
![Blender render of a Giverny-inspired garden, with a green Japanese bridge over a reflective lily pond, pink and white flowers, and dense willow foliage](https://cdn.openai.com/devhub/blog/architectural-visualization/giverny-water-garden-cec7107eed5b.webp)

A Cycles render of the Giverny-inspired water garden. Selected plants, textures, and the sky environment come from Poly Haven.
