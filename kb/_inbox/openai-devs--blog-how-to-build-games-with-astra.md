...
![Generated concept art of an ivory ship above a faceted cyan planet, with magenta accents and two warm suns](https://cdn.openai.com/devhub/blog/how-to-build-games/orbital-concept-8438a6ea8e6c.webp)

Generated concept art that established the game’s palette and visual direction.
...
![Void Explorer gameplay showing the four-wing ship, a cyan planet, magenta rings, twin suns, and the navigation display](https://cdn.openai.com/devhub/blog/how-to-build-games/orbital-flight-579e20d663e3.webp)
...
![Line chart of discarded scheduled terrain jobs over nine simulated seconds. The previous selector reaches 6,074 jobs; the revised selector stays at 13. The camera stops after six seconds.](https://cdn.openai.com/devhub/blog/how-to-build-games/discarded-terrain-jobs-a88fe5e91e99.webp)

In a controlled simulation with two workers and 100 ms simulated worker latency, discarded scheduled jobs fell from 6,074 to 13. This measures terrain scheduling, not frame rate.
...
![Generated top-view concept showing four separate wings, pink wingtip lights, an ivory hull, and a green canopy](https://cdn.openai.com/devhub/blog/how-to-build-games/ship-concept-cf334106573d.webp)

The generated ship concept I approved.

![Blender render of the ship's ceramic hull, four separate wings, and twin cyan engines](https://cdn.openai.com/devhub/blog/how-to-build-games/ship-blender-0a5568d4adec.webp)
...
![Sunwake gameplay showing an orange boat leaving a foamy wake across blue faceted waves under a pink sunrise](https://cdn.openai.com/devhub/blog/how-to-build-games/sunwake-water-f1c48b3f7fe8.webp)
...
![A pixel adventurer wades through a glowing teal river in Hollowflux, surrounded by ripples, creatures, and dark cave walls](https://cdn.openai.com/devhub/blog/how-to-build-games/hollowflux-water-15cd30282861.webp)

Hollowflux draws its game art in code, with water that reacts to movement and combat.
...
Sharing a browser game is straightforward too. With the [Sites plugin](https://developers.openai.com/codex/sites), you can ask Astra:

Publish it with public access, and anyone can play directly in their browser.

You can play [Void Explorer](https://developers.openai.com/showcase/void-explorer), [Sunwake](https://developers.openai.com/showcase/sunwake), and [Hollowflux](https://developers.openai.com/showcase/hollowflux) in your browser.
