...
skip_reason: null
source: fireworks
url: https://fireworks.ai/blog/fireworks-on-microsoft-foundry
author: null
published: '2026-03-08'
fetched: '2026-08-12T06:30:10Z'
classifier: null
taxonomy_rev: 2
words: 725
content_sha256: af85320fa33c3f5dae87a66aa9ba4c99ccd82e8bce935ccf2b0724717fa46ff7
---

# Fireworks AI

We are excited to announce the [Public Preview of Fireworks on Microsoft Foundry](https://azure.microsoft.com/en-us/blog/introducing-fireworks-ai-on-microsoft-foundry-bringing-high-performance-low-latency-open-model-inference-to-azure/), bringing our best-in-class fast open-model serving directly into Azure. This partnership integrates Fireworks’ high-performance inference and State-of-the-Art (SOTA) open models into the unified Microsoft Foundry platform, which already offers a wide selection of models. By empowering developers with the fastest path to production-grade open-models, this milestone ensures teams using this new solution have one place to use any model, any framework, with enterprise‑grade controls to build and run AI applications and agents at scale.
...
__Start Building with Fireworks on Microsoft Foundry Today__

**Fireworks Models in Microsoft Foundry: A Single Place for Open Models**
...
**Evaluate models faster with day‑zero access and support.** Start building immediately with access to SOTA open-weight models from Fireworks through a single Azure endpoint, available as first‑party models in Microsoft Foundry.
