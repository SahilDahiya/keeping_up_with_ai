---
title: When Your Customer's AI Is the One Calling
kind: blog
topic: null
subtopic: null
secondary_topics: []
...
skip_reason: null
source: cresta
url: https://cresta.com/blog/meet-customers-where-they-are----when-their-ai-is-the-one-calling
author: Chris Reese
published: '2026-05-11'
fetched: '2026-08-20T06:13:33Z'
classifier: null
taxonomy_rev: 2
words: 975
content_sha256: 802f00cf7ccf0228da7e9ee773fe2cdf7be579d369acd640cdc353cf3b1c2617
---

# When Your Customer's AI Is the One Calling
...
[Propel Holdings](https://cresta.com/customers/propel-holdings) implemented Cresta, and quickly saw a 50% reduction in ACW (After Call Work), from 3 minutes to 90 seconds. [Oportun](https://cresta.com/customers/oportun), meanwhile, went from resource-intensive sampling of calls to understanding 100% – and saw quality management (QM) workload drop by 50%. 

That work still matters.

Automation is what's in the limelight now, with Cresta leading the way and releasing our [generative AI Agent](https://cresta.com/ai-agent) more than a year ago. The appeal is obvious: predictable outcomes, systems that scale up and down with demand, and less reliance on staffing models that are expensive, volatile, and hard to manage in real time.
...
1. **A consumer AI–initiated interaction should never spend time with a human agent.**
2. **When AI-led contacts become the dominant pattern, a customer who chooses to show up on their own behalf is making a deliberate choice.**
...
This is where [**Cresta’s Agent Operations Center**](https://cresta.com/agent-operations-center) comes into play—not as a replacement for automation, but as a control plane for it. A way to observe agent-led decisions across channels, understand what’s happening, and step in when needed.
...
The companies that get this right won’t just reduce cost; they’ll earn trust in a world where the customer has leverage again. Cresta is the partner that helps them do it. [Schedule your personalized demo today](https://cresta.com/request-a-demo).
