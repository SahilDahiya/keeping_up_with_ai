...
subtopic: hardware
secondary_topics: []
summary: Runs a custom text-generation pipeline for Llama-2-7b on Intel Gaudi 2 via
  Optimum Habana, covering HPU graph warmup, bf16, batching and static shapes, and
  plugging the pipeline into LangChain for a RAG-style prompt template.
triage: null
skip_reason: null
source: huggingface
url: https://huggingface.co/blog/textgen-pipe-gaudi
author: Siddhant Jagtap
published: '2024-02-29'
fetched: '2026-07-14T22:10:41Z'
classifier: claude
taxonomy_rev: 1
words: 1182
content_sha256: 43179ff7ce8dd959625950d6afda9eae97eca5ca340100f8342060b8c1b062cc
---
...
`python <name_of_script>.py --model_name_or_path a_model_name`as`--model_name_or_path`is a required argument. However, the model name can be programmatically changed as shown in the python snippet.
...
Use of the pretrained model is subject to compliance with third party licenses, including the “Llama 2 Community License Agreement” (LLAMAV2). For guidance on the intended use of the LLAMA2 model, what will be considered misuse and out-of-scope uses, who are the intended users and additional terms please review and read the instructions in this link

[https://ai.meta.com/llama/license/](https://ai.meta.com/llama/license/). Users bear sole liability and responsibility to follow and comply with any third party licenses, and Habana Labs disclaims and will bear no liability with respect to users’ use or compliance with third party licenses. To be able to run gated models like this Llama-2-70b-hf, you need the following:
...
habanapartnershipshardware
 ...
 March 28, 2023 partnershipshardwarenvidia
