...
summary: George Hotz interview on commoditizing petaflop-scale compute and what low-cost
  AI hardware means for builders.
source: latent-space
url: https://www.latent.space/p/geohot
author: Latent Space
published: '2023-06-20'
fetched: '2026-07-11T05:22:58Z'
classifier: codex
taxonomy_rev: 1
words: 17914
content_sha256: aacdff00a7b0f07a521501eb9b5f453f028362ad4fa4dc66878315c39341417b
---
...
We are excited to share the world’s first interview with **George Hotz** on [the tiny corp](https://geohot.github.io/blog/jekyll/update/2023/05/24/the-tiny-corp-raised-5M.html)!

If you don’t know [George](https://en.wikipedia.org/wiki/George_Hotz), he was the first person to unlock the iPhone, jailbreak the PS3, went on to start [Comma.ai](https://www.comma.ai/), and briefly “interned” at the Elon Musk-run Twitter.

Tinycorp is the company behind the deep learning framework ** tinygrad**, as well as the recently announced

**, a new $15,000 “**

[tinybox](https://tinygrad.org)**luxury AI computer**” aimed at local model training and inference, aka your “personal compute cluster”:
...
![](https://substackcdn.com/image/fetch/$s_!IrEX!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F31ced19c-bfc4-4bb1-9c7d-c47a921f26b4_1905x780.png)
...
Outside of tiny, we also talked about one of George’s favorite units of measure “[a person of compute](https://geohot.github.io/blog/jekyll/update/2023/04/26/a-person-of-compute.html)”. Much of the AGI talk has been benchmark-driven, but looking at it from a compute throughput can also be interesting. **One person of compute is roughly 20 PFLOPS** (64 A100s, or a single dense 42U A100 rack); one A100 is ~$10-15,000, so the GPUs by themselves will come out at **$640,000-$1,000,000**.

We also covered a wide range of topics, including his self analysis on GPT-4, Elon Musk, Remote Work, [Computer Vision](https://www.latent.space/p/segment-anything-roboflow#%C2%A7sam-zero-shot-transfer) and [the Comma Body](https://blog.comma.ai/commabody/), and [life above/below the API](https://rein.pk/replacing-middle-management-with-apis) (and [above/below the Kanban board](https://www.swyx.io/api-economy)). See show notes and timestamps for more!

![Image Image](https://substackcdn.com/image/fetch/$s_!TECH!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F8e7e2d9a-d05b-432b-836f-cd8572e11d19_3384x2784.jpeg)

## Show Notes

- [“Unlocked iPhone”](https://www.youtube.com/watch?v=tvJ1RGlxe8Q)on YouTube (August 21st, 2007)
- [“The Light It Up Contest”](https://www.youtube.com/watch?v=9iUvuaChDEg)on YouTube (February 13th, 2011)
- George’s email to Lisa Su, AMD’s CEO:

![](https://substackcdn.com/image/fetch/$s_!49wm!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F591556cf-578a-4470-91a0-eb1027098e2c_708x682.png)
...
- [00:37:00] - [Shoutout to our MosaicML podcast](https://twitter.com/karpathy/status/1660824101412548609)
...
- [00:55:40] Comma Bodies & - [Computer Vision](https://www.latent.space/p/segment-anything-roboflow#%C2%A7sam-zero-shot-transfer)
...
**Swyx**: Hey everyone, welcome to the Latent Space podcast. This is Swyx, writer and editor of Latent Space. And Alessio is taking over with the intros, Alessio is Partner and CTO in residence at [Decibel Partners](https://decibel.vc/). [00:00:20]
