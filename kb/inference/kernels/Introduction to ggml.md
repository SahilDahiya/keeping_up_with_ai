...
secondary_topics:
- infra-platform/edge
summary: A hands-on introduction to ggml — the C/C++ tensor library behind llama.cpp,
  whisper.cpp, ollama and LM Studio — covering its context/graph memory model, GGUF
  file format, quantized tensor types, and backend dispatch (CPU/CUDA/Metal) via a
...
fetched: '2026-07-14T22:06:02Z'
classifier: claude
taxonomy_rev: 1
words: 2383
content_sha256: 4c9f614476e45f4a237b003c54051e915da93d3587ec95c463a53decb696517b
---
...
# 
	...
	](https://huggingface.co#introduction-to-ggml)
...
[  Upvote 295 ](https://huggingface.co/login?next=%2Fblog%2Fintroduction-to-ggml)

![Xuan-Son Nguyen's avatar](https://cdn-avatars.huggingface.co/v1/production/uploads/1674191139776-noauth.png) 

  ![Georgi Gerganov's avatar](https://cdn-avatars.huggingface.co/v1/production/uploads/63148d3b996c52bf0142cdbe/ec7pRNrQQy70d-11FiACq.jpeg) 

  [Georgi Gerganovggerganov    ](https://huggingface.co/ggerganov)

![ggml-org's avatar](https://cdn-avatars.huggingface.co/v1/production/uploads/63148d3b996c52bf0142cdbe/HXyNkyB0_nHI5WDNdiKHZ.png)

[ggml-org](https://huggingface.co/ggml-org)

[slarenslaren    ](https://huggingface.co/slaren)
...
## 
	...
	](https://huggingface.co#terminology-and-concepts)
...
## 
	...
	](https://huggingface.co#simple-example)
	
		Simple example
	

In this example, we'll go through the steps to replicate the code we ran in [Getting Started](https://huggingface.co#getting-started). We need to create 2 matrices, multiply them and get the result. Using PyTorch, the code looks like this:
...
## 
	...
	](https://huggingface.co#example-with-a-backend)
...
- Allocate `ggml_context`to store tensor metadata (we**don't need**to allocate tensor data right away)
...
## 
	...
	](https://huggingface.co#printing-the-computational-graph)
