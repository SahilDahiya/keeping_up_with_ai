...
With current Diffusers, loading a Nunchaku checkpoint is as simple as calling `from_pretrained()`, with no local CUDA compilation required thanks to the [ kernels](https://github.com/huggingface/kernels) package. In addition, the companion 

- [Getting started with Nunchaku Lite](https://huggingface.co#getting-started-with-nunchaku-lite)
- [Background: SVDQuant and Nunchaku](https://huggingface.co#background-svdquant-and-nunchaku)
- [Introducing Nunchaku Lite](https://huggingface.co#introducing-nunchaku-lite)
- [Native loading in Diffusers](https://huggingface.co#native-loading-in-diffusers)
- [Getting more speed and lower memory](https://huggingface.co#getting-more-speed-and-lower-memory)
- [Benchmarks](https://huggingface.co#benchmarks)
- [Quantizing your own model](https://huggingface.co#quantizing-your-own-model)
- [Ready-to-use checkpoints](https://huggingface.co#ready-to-use-checkpoints)
...
[hardware support](https://huggingface.co#hardware-support)table below for details.
...
- `svdq_w4a4`
- `awq_w4a16`- `adanorm_single`/- `adanorm_zero`or Qwen-Image modulation layers. These layers are memory-bound and precision-sensitive, making AWQ a good fit to preserve precision while still saving memory and space.
...
- +1
 ...
 June 19, 2025 guidediffusersquantization
