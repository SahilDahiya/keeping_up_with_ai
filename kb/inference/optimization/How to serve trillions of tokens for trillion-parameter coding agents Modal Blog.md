...
# How to serve trillions of tokens for trillion-parameter coding agents | Modal Blog
...
![](https://modal-cdn.com/blog/images/trillion-tokens-trillion-parameters-throughput-interactivity-improvement.webp) 
...
![](https://modal-cdn.com/blog/images/trillion-tokens-trillion-parameters-cumulative-tokens.webp) 
...
![](https://modal-cdn.com/blog/images/trillion-tokens-trillion-parameters-bad-perf-baseline.webp) 
...
![](https://modal-cdn.com/blog/images/trillion-tokens-trillion-parameters-agent-session.png) 
...
![](https://modal-cdn.com/blog/images/trillion-tokens-trillion-parameters-littles-law.png) 
...
![](https://modal-cdn.com/blog/images/trillion-tokens-trillion-parameters-inferencex-kimi-b200.webp) 
...
![](https://modal-cdn.com/blog/images/trillion-tokens-trillion-parameters-tp4-pd-vs-tp8-p.webp) 
...
![](https://modal-cdn.com/blog/images/trillion-tokens-trillion-parameters-block-quant-viz.webp) 
...
![](https://modal-cdn.com/blog/images/trillion-tokens-trillion-parameters-tpm-chr-vs-users-baseline.webp) 
...
![](https://modal-cdn.com/blog/images/trillion-tokens-trillion-parameters-tpm-chr-vs-users-hicache-comp.webp) 
...
1. There were recurring spikes in queued requests and tail time-to-first-token (TTFT) and end-to-end (e2e) latencies.
2. Per-replica throughput was lower than expected.

![](https://modal-cdn.com/blog/images/trillion-tokens-trillion-parameters-ttft-queueing-before-routing.png) 
...
Based on this work, we’ve updated our routing layer to support stateful and KV cache-aware routing algorithms. Modal Servers can use it via the `kv_aware_routing` [experimental option](https://modal.com/docs/guide/feature-maturity):
...
By default, [Modal Servers](https://modal.com/blog/serverless-servers) use uniform random routing for all requests. To make certain requests “stick” to a particular container, clients can provide a header, `Modal-Session-Id`. This is then hashed and mapped onto a replica, something like this:

![](https://modal-cdn.com/blog/images/trillion-tokens-trillion-parameters-requests-per-replica-poisson.webp) 
...
![](https://modal-cdn.com/blog/images/trillion-tokens-trillion-parameters-requests-per-replica-observed-stateless.webp) 
...
![](https://modal-cdn.com/blog/images/trillion-tokens-trillion-parameters-requests-per-replica-observed-optimized.webp) 
...
![](https://modal-cdn.com/blog/images/trillion-tokens-trillion-parameters-concurrent-requests-per-replica.png) 
...
![](https://modal-cdn.com/blog/images/trillion-tokens-trillion-parameters-ttft-before-after-routing.png) 
