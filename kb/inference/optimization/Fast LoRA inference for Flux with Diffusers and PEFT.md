...
secondary_topics:
- models/fine-tuning
summary: Gets ~2.3x faster LoRA inference for Flux.1-Dev by combining LoRA hotswapping
  with torch.compile without recompilation — using peft's hotswap_adapter, max-rank
  padding so shapes stay static, and flags to avoid recompiles when adapters have
  different ranks and target layers. Also covers fusing/unfusing and FP8 quantization
  on top.
triage: null
skip_reason: null
source: huggingface
...
fetched: '2026-07-14T22:04:20Z'
classifier: claude
taxonomy_rev: 1
words: 1975
content_sha256: a247fab16fd203f42f085c79f8e6cc81833a1e421d9c49e7a74882f4c7072573
---

# Fast LoRA inference for Flux with Diffusers and PEFT

Text-to-Image •  Updated   •  50.8k  •  1.34k  

#### ByteDance/Hyper-SD

![](https://cdn-avatars.huggingface.co/v1/production/uploads/6535c9e88bde2fae19b6fb25/0clr54wj5Ly-RkYU9OXPp.png) 
...
- [Hurdles in optimizing LoRA inference](https://huggingface.co#hurdles-in-optimizing-lora-inference)
- [Optimization recipe](https://huggingface.co#optimization-recipe)
- [Optimized LoRA inference on a consumer GPU](https://huggingface.co#optimized-lora-inference-on-a-consumer-gpu)
...
guidecollaborationdiffusers
 ...
 January 2, 2024 peftloraguide

  75

 June 18, 2026 I enjoyed your post! May I ask what version of PyTorch you used for the test results?
