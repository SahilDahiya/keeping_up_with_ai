...
author: Amir Haghighat; Tri Dao; Abu Qader; Bryce Dubayah; Philip Kiely
published: '2025-08-07'
fetched: '2026-07-11T04:07:42Z'
classifier: codex
taxonomy_rev: 1
words: 1109
content_sha256: 7e986332d54a142a39d02b5e2da30c3c6141f3c2d03f8fd25d63f426f1830409
triage: keep
skip_reason: null
---
...
![GPT OSS 120B](https://www.baseten.co/_next/image/?url=https%3A%2F%2Fwww.datocms-assets.com%2F104802%2F1754532241-gpt-oss-2.png%3Fauto%3Dformat%26fit%3Dcrop%26h%3D630%26w%3D1200&w=3840&q=100)
...
**Update**: we've [made our GPT OSS implementation even faster](https://www.baseten.co/blog/how-we-made-the-fastest-gpt-oss-on-nvidia-gpus-60-percent-faster/), reaching speeds of over 650 tokens per second on Artificial Analysis and higher on OpenRouter.
...
![What matters is having the inference optimization muscle to immediately push on latency and throughput](https://www.baseten.co/_next/image/?url=https%3A%2F%2Fwww.datocms-assets.com%2F104802%2F1754532343-screenshot-2025-08-06-at-2-45-29-pm.png%3Fauto%3Dformat%26w%3D1200&w=3840&q=75) What matters is having the inference optimization muscle to immediately push on latency and throughput

What matters is having the inference optimization muscle to immediately push on latency and throughputOptimizing performance on a new model is a substantial engineering challenge. Thanks to our flexible [inference stack](https://www.baseten.co/resources/guide/the-baseten-inference-stack/) and the collective expertise of our model performance engineering team, we are able to roll out performance improvements by the hour on new models.

In fact, in the time it took to write this blog post, we added another 100 tokens per second while maintaining 100% uptime.

![OpenRouter performance for GPT OSS, 6:45 PM August 6, 2025](https://www.baseten.co/_next/image/?url=https%3A%2F%2Fwww.datocms-assets.com%2F104802%2F1754532371-screenshot-2025-08-06-at-6-49-49-pm.png%3Fauto%3Dformat%26w%3D1200&w=3840&q=75) OpenRouter performance for GPT OSS, 6:45 PM August 6, 2025

OpenRouter performance for GPT OSS, 6:45 PM August 6, 2025Model performance efforts included:
...
Inspired by GPUs, we parallelized this effort across multiple engineers. One engineer tried vLLM, another SGLang, and a third worked on TensorRT-LLM. We were able to quickly get TensorRT-LLM working, which was fortunate as it is usually the most performant inference framework for LLMs. In most cases, we use an overnight or dev build rather than a full release, as inference framework maintainers are simultaneously working on supporting the new model.

![NVIDIA cut a dev release of TensorRT-LLM to support GPT OSS](https://www.baseten.co/_next/image/?url=https%3A%2F%2Fwww.datocms-assets.com%2F104802%2F1754532392-catalog-ngc-nvidia-com_orgs_nvidia_teams_tensorrt-llm_containers_release_tags.png%3Fauto%3Dformat%26w%3D1200&w=3840&q=75) NVIDIA cut a dev release of TensorRT-LLM to support GPT OSS

NVIDIA cut a dev release of TensorRT-LLM to support GPT OSSWith TensorRT-LLM, it was important to serve the model on both Hopper and Blackwell architectures to support widely-available H100 GPUs and access the speed of B200 GPUs for our public model APIs.
...
Romain Huet of OpenAI warns that implementation details affect performance and output quality.A large part of our engineering work was iteratively fixing bugs and testing models for both speed and correctness. Where we could, we [contributed back to open source](https://github.com/openai/harmony/pull/13) with the fixes that worked for us.
...
![Tensor Parallelism vs Expert Parallelism for mixture of experts models](https://www.baseten.co/_next/image/?url=https%3A%2F%2Fwww.datocms-assets.com%2F104802%2F1752686946-diagram-4-2.png%3Fauto%3Dformat%26w%3D1200&w=3840&q=75) Tensor Parallelism vs Expert Parallelism for mixture of experts models

Tensor Parallelism vs Expert Parallelism for mixture of experts modelsWe found that Tensor Parallelism offered better latency, while Expert Parallelism offered better system throughput. As we are prioritizing latency, we selected Tensor Parallelism.
...
![GPT OSS 120B Model API on Baseten, optimized for performance with full context window support](https://www.baseten.co/_next/image/?url=https%3A%2F%2Fwww.datocms-assets.com%2F104802%2F1754532484-screenshot-2025-08-06-at-5-11-41-pm.png%3Fauto%3Dformat%26w%3D1200&w=3840&q=75) GPT OSS 120B Model API on Baseten, optimized for performance with full context window support

GPT OSS 120B Model API on Baseten, optimized for performance with full context window support## Next steps in performance optimization
