...
secondary_topics:
- models/releases
summary: Details how Fireworks served Llama 4 Maverick within minutes of weight release
  using FireOptimizer-tuned FP8 quantization, tensor+expert parallelism, a custom
  FireAttention kernel extended for Maverick's chunked local attention, and a trained
  speculative-decoding drafter, reaching 145 tok/s on H200 (10-20% faster than the
  nearest competitor per Artificial Analysis).
triage: null
skip_reason: null
source: fireworks
