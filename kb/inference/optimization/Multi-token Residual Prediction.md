...
secondary_topics:
- models/reasoning
summary: Explains multi-token residual prediction as an inference acceleration technique
  for generating multiple tokens per step.
source: modal
url: https://modal.com/blog/multi-token-residual-prediction
author: null
published: '2026-06-30'
fetched: '2026-07-11T04:26:41Z'
classifier: codex
taxonomy_rev: 1
words: 2974
content_sha256: 44e6be8b0950df9d437a1cc3cc4f4821b1db1e846b028ba9b2759b55e69bacfb
triage: keep
skip_reason: null
---
...
[Yufeng Xu](https://twitter.com/Zephyr271828)

[Rahul Chalamala](https://twitter.com/rchalamala)

[Yucheng Lu](https://twitter.com/_yucheng_lu)

Editor's Note: this guest blog post describes the results of a research collaboration between Modal Research and NYU Shanghai's[HeavyBall Research](https://www.yucheng-lu.me/lab.html).

![](https://modal-public-assets.s3.us-east-1.amazonaws.com/blog/images/multi-token-residual-prediction-headline-results.png)
...
![](https://modal-cdn.com/blog/images/multi-token-residual-prediction-arch-diagram.png)
