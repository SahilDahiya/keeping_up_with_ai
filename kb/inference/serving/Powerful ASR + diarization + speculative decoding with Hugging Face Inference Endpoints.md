...
summary: Walks through a custom Inference Endpoints handler that chains Whisper-large-v3
  ASR, Pyannote diarization and speculative decoding (with a distil-whisper assistant
  model and SDPA/Flash Attention 2) into one deployable pipeline, including the pre/post-processing
  needed to align transcript timestamps with speaker turns.
triage: null
skip_reason: null
source: huggingface
...
fetched: '2026-07-14T22:03:55Z'
classifier: claude
taxonomy_rev: 1
words: 1358
content_sha256: 1815e824703b4d2a6da5cbd0e280a9a7837f2eb866a1a41eb490e405f84008ea
---

# Powerful ASR + diarization + speculative decoding with Hugging Face Inference Endpoints

Automatic Speech Recognition •  2B • Updated   •  5.97M  •  5.94k  
...
There is a [repo](https://github.com/plaggy/fast-whisper-server) that implements the same pipeline along with the server part (FastAPI+Uvicorn). It may come in handy if you'd like to customize it even further or host somewhere else.
 ...
 Automatic Speech Recognition •  Updated   •  8.45M  •  2.7k 
...
- +2
 ...
 May 13, 2025 audiospeech-to-speechinference

  45

 October 22, 2024 hi naveen how are you
