...
summary: TGI 1.4 adds an OpenAI Chat Completions-compatible Messages API, so open
  models on Inference Endpoints become a drop-in swap for GPT-4 by only changing base_url
  and api_key — shown with the OpenAI Python/JS clients, LangChain and LlamaIndex,
  and a Nous-Hermes-2-Mixtral migration.
triage: null
skip_reason: null
source: huggingface
url: https://huggingface.co/blog/tgi-messages-api
author: Andrew Reed; Philipp Schmid; Joffrey THOMAS; David Holtz
published: '2024-02-08'
fetched: '2026-07-14T22:06:54Z'
classifier: claude
taxonomy_rev: 1
words: 1550
content_sha256: 9362c4e985a50b884055c33317f9ab61ba2b420f0990db3b76709e5ee1138262
---

# From OpenAI to Open LLMs with Messages API on Hugging Face

Text Generation •  47B • Updated   •  29.5k  •  456  
...
- [Create an Inference Endpoint](https://huggingface.co#create-an-inference-endpoint)
- [Using Inference Endpoints with OpenAI client libraries](https://huggingface.co#using-inference-endpoints-with-openai-client-libraries)
- [Integrate with LangChain and LlamaIndex](https://huggingface.co#integrate-with-langchain-and-llamaindex)
...
[💡 Certain OpenAI features, like function calling, are not compatible with TGI. Currently, the Messages API supports the following chat completion parameters:](https://huggingface.co#💡-certain-openai-features-like-function-calling-are-not-compatible-with-tgi-currently-the-messages-api-supports-the-following-chat-completion-parameters-stream-max_tokens-frequency_penalty-logprobs-seed-temperature-and-top_p)`stream`,`max_tokens`,`frequency_penalty`,`logprobs`,`seed`,`temperature`, and`top_p`.
