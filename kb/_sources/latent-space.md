...
- **2026-07-01** — [🔬 The Coolest Diffusion Research Isn't in LLMs — Evan Feinberg & Sergey Edunov, Genesis Molecular AI](<../models/multimodal/🔬 The Coolest Diffusion Research Isn't in LLMs — Evan Feinberg & Sergey Edunov, Genesis Molecular AI.md>) · `multimodal` · latent-space
...
- **2026-06-25** — [[AINews] It's Meta-Harness Summer](<../agents/planning/[AINews] It's Meta-Harness Summer.md>) · `planning` · latent-space
...
- **2026-05-01** — [[AINews] Agents for Everything Else: Codex for Knowledge Work, Claude for Creative Work](<../agents/planning/[AINews] Agents for Everything Else Codex for Knowledge Work, Claude for Creative Work.md>) · `planning` · latent-space
...
- **2026-04-22** — [[AINews] OpenAI launches GPT-Image-2](<../models/multimodal/[AINews] OpenAI launches GPT-Image-2.md>) · `multimodal` · latent-space
...
- **2026-04-02** — [Moonlake: Causal World Models should be Multimodal, Interactive, and Efficient — with Chris Manning and Fan-yun Sun](<../models/multimodal/Moonlake Causal World Models should be Multimodal, Interactive, and Efficient — with Chris Manning and Fan-yun Sun.md>) · `multimodal` · latent-space
  Moonlake interview on causal world models that are multimodal, interactive, and efficient.
- **2026-03-30** — [Mistral: Voxtral TTS, Forge, Leanstral, & what's next for Mistral 4 — w/ Pavan Kumar Reddy & Guillaume Lample](<../models/multimodal/Mistral Voxtral TTS, Forge, Leanstral, & what's next for Mistral 4 — w Pavan Kumar Reddy & Guillaume Lample.md>) · `multimodal` · latent-space
...
- **2026-03-12** — [[AINews] Replit Agent 4: The Knowledge Work Agent](<../agents/computer-use/[AINews] Replit Agent 4 The Knowledge Work Agent.md>) · `computer-use` · latent-space
  Covers Replit Agent 4 as a knowledge-work agent and what that implies for coding-agent workflows.
- **2026-03-12** — [Retrieval After RAG: Hybrid Search, Agents, and Database Design — Simon Hørup Eskildsen of Turbopuffer](<../rag-retrieval/search/Retrieval After RAG Hybrid Search, Agents, and Database Design — Simon Hørup Eskildsen of Turbopuffer.md>) · `search` · latent-space
...
- **2026-02-12** — [[AINews] Z.ai GLM-5: New SOTA Open Weights LLM](<../models/releases/[AINews] Z.ai GLM-5 New SOTA Open Weights LLM.md>) · `releases` · latent-space
  Covers GLM-5 as an open-weights model release and tracks benchmark/capability claims for open models.
- **2026-02-11** — [[AINews] Qwen Image 2 and Seedance 2](<../models/multimodal/[AINews] Qwen Image 2 and Seedance 2.md>) · `multimodal` · latent-space
...
- **2026-01-23** — [Captaining IMO Gold, Deep Think, On-Policy RL, Feeling the AGI in Singapore — Yi Tay](<../models/reasoning/Captaining IMO Gold, Deep Think, On-Policy RL, Feeling the AGI in Singapore — Yi Tay.md>) · `reasoning` · latent-space
...
- **2025-12-31** — [[State of Post-Training] From GPT-4.1 to 5.1: RLVR, Agent & Token Efficiency — Josh McGrath, OpenAI](<../models/fine-tuning/[State of Post-Training] From GPT-4.1 to 5.1 RLVR, Agent & Token Efficiency — Josh McGrath, OpenAI.md>) · `fine-tuning` · latent-space
...
- **2025-07-31** — [The RLVR Revolution — with Nathan Lambert (AI2, Interconnects.ai)](<../models/fine-tuning/The RLVR Revolution — with Nathan Lambert (AI2, Interconnects.ai).md>) · `fine-tuning` · latent-space
...
- **2025-06-13** — [The Shape of Compute — with Chris Lattner for Modular](<../inference/hardware/The Shape of Compute — with Chris Lattner for Modular.md>) · `hardware` · latent-space
...
- **2025-04-11** — [SF Compute: Commoditizing Compute to solve the GPU Bubble forever](<../infra-platform/gpu-clusters/SF Compute Commoditizing Compute to solve the GPU Bubble forever.md>) · `gpu-clusters` · latent-space
...
- **2025-03-11** — [⚡️The new OpenAI Agents Platform](<../agents/planning/⚡️The new OpenAI Agents Platform.md>) · `planning` · latent-space
...
- **2024-12-24** — [2024 in Synthetic Data and Smol Models [LS Live @ NeurIPS]](<../models/fine-tuning/2024 in Synthetic Data and Smol Models [LS Live @ NeurIPS].md>) · `fine-tuning` · latent-space
...
- **2024-12-23** — [2024 in Open Models [LS Live @ NeurIPS]](<../models/releases/2024 in Open Models [LS Live @ NeurIPS].md>) · `releases` · latent-space
  Reviews the 2024 open model landscape, including capability gains, benchmark movement, and deployment implications.
- **2024-12-22** — [2024 in Vision [LS Live @ NeurIPS]](<../models/multimodal/2024 in Vision [LS Live @ NeurIPS].md>) · `multimodal` · latent-space
...
- **2024-12-10** — [Generative Video WorldSim, Diffusion, Vision, Reinforcement Learning and Robotics — ICML 2024 Part 1](<../models/multimodal/Generative Video WorldSim, Diffusion, Vision, Reinforcement Learning and Robotics — ICML 2024 Part 1.md>) · `multimodal` · latent-space
...
- **2024-09-27** — [Language Agents: From Reasoning to Acting](<../agents/planning/Language Agents From Reasoning to Acting.md>) · `planning` · latent-space
  Shunyu Yao interview on language agents, reasoning-to-acting patterns, planning, and tool use.
- **2024-09-20** — [The Ultimate Guide to Prompting](<../prompt-engineering/techniques/The Ultimate Guide to Prompting.md>) · `techniques` · latent-space
...
- **2024-07-23** — [Llama 2, 3 & 4: Synthetic Data, RLHF, Agents on the path to Open Source AGI](<../models/releases/Llama 2, 3 & 4 Synthetic Data, RLHF, Agents on the path to Open Source AGI.md>) · `releases` · latent-space
...
- **2024-07-05** — [The 10,000x Yolo Researcher Metagame — with Yi Tay of Reka](<../models/reasoning/The 10,000x Yolo Researcher Metagame — with Yi Tay of Reka.md>) · `reasoning` · latent-space
...
- **2024-05-27** — [ICLR 2024 — Best Papers & Talks (ImageGen, Vision, Transformers, State Space Models) ft. Durk Kingma, Christian Szegedy, Ilya Sutskever](<../models/reasoning/ICLR 2024 — Best Papers & Talks (ImageGen, Vision, Transformers, State Space Models) ft. Durk Kingma, Christian Szegedy, Ilya Sutskever.md>) · `reasoning` · latent-space
  ICLR 2024 recap covering image generation, vision, Transformers, and state-space model research.
- **2024-04-27** — [WebSim, WorldSim, and The Summer of Simulative AI — with Joscha Bach of Liquid AI, Karan Malhotra of Nous Research, Rob Haisfield of WebSim.ai](<../models/reasoning/WebSim, WorldSim, and The Summer of Simulative AI — with Joscha Bach of Liquid AI, Karan Malhotra of Nous Research, Rob Haisfield of WebSim.ai.md>) · `reasoning` · latent-space
...
- **2024-02-08** — [Cloud Intelligence at the speed of 5000 tok/s - with Ce Zhang and Vipul Ved Prakash of Together AI](<../inference/serving/Cloud Intelligence at the speed of 5000 toks - with Ce Zhang and Vipul Ved Prakash of Together AI.md>) · `serving` · latent-space
...
- **2024-01-19** — [How to train your own Large Multimodal Model — with Hugo Laurençon & Leo Tronchon of HuggingFace M4 Research](<../models/multimodal/How to train your own Large Multimodal Model — with Hugo Laurençon & Leo Tronchon of HuggingFace M4 Research.md>) · `multimodal` · latent-space
...
- **2023-12-23** — [NeurIPS 2023 Recap — Best Papers](<../models/benchmarks/NeurIPS 2023 Recap — Best Papers.md>) · `benchmarks` · latent-space
...
- **2023-08-10** — [LLMs Everywhere: Running 70B models in browsers and iPhones using MLC — with Tianqi Chen of CMU / OctoML](<../inference/optimization/LLMs Everywhere Running 70B models in browsers and iPhones using MLC — with Tianqi Chen of CMU OctoML.md>) · `optimization` · latent-space
...
- **2023-07-19** — [Llama 2: The New Open LLM SOTA (ft. Nathan Lambert, Matt Bornstein, Anton Troynikov, Russell Kaplan, Whole Mars Catalog et al.)](<../models/releases/Llama 2 The New Open LLM SOTA (ft. Nathan Lambert, Matt Bornstein, Anton Troynikov, Russell Kaplan, Whole Mars Catalog et al.).md>) · `releases` · latent-space
...
- **2023-04-29** — [Mapping the future of *truly* Open Models and Training Dolly for $30 — with Mike Conover of Databricks](<../models/releases/Mapping the future of truly Open Models and Training Dolly for $30 — with Mike Conover of Databricks.md>) · `releases` · latent-space
...
- **2023-03-29** — [Grounded Research: From Google Brain to MLOps to LLMOps — with Shreya Shankar of UC Berkeley](<../evals-observability/testing/Grounded Research From Google Brain to MLOps to LLMOps — with Shreya Shankar of UC Berkeley.md>) · `testing` · latent-space
...
- **2022-12-28** — [Reverse Prompt Engineering for Fun and (no) Profit](<../prompt-engineering/techniques/Reverse Prompt Engineering for Fun and (no) Profit.md>) · `techniques` · latent-space
