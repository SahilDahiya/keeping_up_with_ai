...
- agents/computer-use
- models/fine-tuning
summary: Dense 2026 crossover on AI engineering trends, coding agents, context engineering,
  RL, memory, and specialized models.
source: latent-space
url: https://www.latent.space/p/unsupervised-learning-2026
author: Latent Space
published: '2026-04-23'
fetched: '2026-07-11T05:12:14Z'
classifier: codex
taxonomy_rev: 1
words: 13763
content_sha256: 2fe55aa1dae3756173472deb30d10b2e871251062c8d7ee4521105f7ac416675
---

# AIE Europe Debrief + Agent Labs Thesis: Unsupervised Learning x Latent Space Crossover Special (2026)

Today, we check in a year after the [first ](https://www.latent.space/p/unsupervised-learning)** Unsupervised Learning x Latent Space Crossover special **to discuss everything that has changed (there is a lot) in the world of AI.

*This episode was recorded just after*

[AIE Europe](https://www.ai.engineer/europe/), but before[the Cursor-xAI deal](https://cursor.com/blog/spacex-model-training).**Unsupervised Learning** is a podcast that interviews the sharpest minds in AI about what’s real today, what will be real in the future and what it means for businesses and the world - helping builders, researchers and founders deconstruct and understand the biggest breakthroughs.
