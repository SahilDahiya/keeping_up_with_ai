...
- **2026-07-10** — 📄 [Failure as a Process: An Anatomy of CLI Coding Agent Trajectories](<../agents/planning/Failure as a Process An Anatomy of CLI Coding Agent Trajectories.md>) · `planning` · arxiv
