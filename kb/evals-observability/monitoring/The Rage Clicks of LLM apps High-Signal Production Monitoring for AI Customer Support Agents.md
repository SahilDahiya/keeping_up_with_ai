---
title: 'The Rage Clicks of LLM apps: High-Signal Production Monitoring for AI Customer
  Support Agents'
...
source: langfuse
url: https://langfuse.com/blog/2026-04-01-llm-as-a-judge-production-monitoring
author: null
published: '2026-04-01'
fetched: '2026-07-11T04:36:24Z'
classifier: codex
taxonomy_rev: 1
words: 4102
content_sha256: 1b1287df5ac687e902aa999c9b8b2eb3da4351462fde3c55fe1f3fff9abd7d35
---
...
![Picture Annabell Schäfer](https://langfuse.com/_next/image?url=%2Fimages%2Fpeople%2Fannabellschafer.jpg&w=96&q=75) Annabell Schäfer

Annabell SchäferTraditional production apps are monitored for high-signal indicators that something's going wrong: rage clicks, error rates, timeouts. These are binary, easy-to-detect signals that tell you immediately when users are unhappy or the app is misbehaving.
...
![Boris Cherny tweet about the fucks chart](https://langfuse.com/_next/image?url=%2Fimages%2Fblog%2F2026-03-25-llm-as-a-judge-production-monitoring%2Fboris_cherny_tweet.png&w=3840&q=75)
...
[Four Events Worth Detecting in a Customer Support Agent](https://langfuse.com#four-events-worth-detecting-in-a-customer-support-agent)
...
We built template [evaluators](https://langfuse.com/docs/evaluation/evaluation-methods/llm-as-a-judge) in Langfuse for each of these, available to copy.

![Evaluator scores on a trace in Langfuse](https://langfuse.com/_next/image?url=%2Fimages%2Fblog%2F2026-03-25-llm-as-a-judge-production-monitoring%2Fscores_in_ui.png&w=3840&q=75)


You can see these evaluators live in our [public demo project](https://cloud.langfuse.com/project/clkpwwm0m000gmm094odg11gi/traces?viewId=cmmkkfk1a03jiad07lkjcuir7&orderBy=order-DESC_column-startTime&dateRange=7d&search=&peek=ec3d57e9040f0f8f&observation=ec3d57e9040f0f8f&traceId=76eef62999b4ee69f1eae83dcbafcb47×tamp=2026-03-27T11%3A53%3A01.922Z).

[1. User curses](https://langfuse.com#1-user-curses)

**What it detects:** The user expressed profanity or intense frustration during the conversation.

![User cur
sing evaluator example](https://langfuse.com/_next/image?url=%2Fimages%2Fblog%2F2026-03-25-llm-as-a-judge-production-monitoring%2Fexample-user-cursing.png&w=3840&q=75)
...
\`\`\`
```
[2. User Disagreement](https://langfuse.com#2-user-disagreement)

**What it detects:** The user explicitly pushed back on or corrected the assistant's response.

![User disagreement evaluator example](https://langfuse.com/_next/image?url=%2Fimages%2Fblog%2F2026-03-25-llm-as-a-judge-production-monitoring%2Fexample-user-disagreement.png&w=3840&q=75)
...
**What to do with it:** Filter [traces](https://langfuse.com/docs/observability/overview) where this fires and look for patterns. The same topic triggering disagreement repeatedly is a documentation or system prompt fix waiting to happen. This evaluator helps us to quickly detect potential docs gaps.
...
\`\`\`
```
[3. Out-of-Scope Request](https://langfuse.com#3-out-of-scope-request)

**What it detects:** A mismatch between what the user asked and what the agent is designed to do.

![Out-of-scope request evaluator example](https://langfuse.com/_next/image?url=%2Fimages%2Fblog%2F2026-03-25-llm-as-a-judge-production-monitoring%2Fexample-out-of-scope.png&w=3840&q=75)
...
\`\`\`
```
[4. Insufficient Answer](https://langfuse.com#4-insufficient-answer)
...
![Insufficient answer evaluator example](https://langfuse.com/_next/image?url=%2Fimages%2Fblog%2F2026-03-25-llm-as-a-judge-production-monitoring%2Fexample-insufficient-answer.png&w=3840&q=75)
...
- **Review the results.**Use Langfuse's filtering to find flagged traces. Review where valuable info is included. Use what you find to improve your agent's system prompt -- [automatic prompt improvement](https://langfuse.com/blog/2026-02-16-prompt-improvement-claude-skills)is a natural next step here.
- **Finetune your evaluators.**To keep your evaluators high signal you want to adjust them over time. LLM as a judge instructions are prompts, and they equally- [need to be improved as the prompts](https://langfuse.com/blog/2026-02-16-prompt-improvement-claude-skills)in your production system.
