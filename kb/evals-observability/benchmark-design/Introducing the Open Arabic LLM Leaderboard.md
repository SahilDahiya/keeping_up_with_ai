...
secondary_topics: []
summary: The Open Arabic LLM Leaderboard evaluates models on native and human-verified
  translated Arabic benchmarks (AlGhafa, Arabic MMLU/EXAMS/ARC/HellaSwag), covering
  translation quality control and the dialect/culture gaps English benchmarks miss.
triage: null
skip_reason: null
source: huggingface
url: https://huggingface.co/blog/leaderboard-arabic
author: Ali El Filali; Hamza Alobeidli; Ruxandra Cojocaru; Basma Boussaha; Clémentine
  Fourrier
published: '2024-05-14'
fetched: '2026-07-14T22:10:19Z'
classifier: claude
taxonomy_rev: 1
words: 1546
content_sha256: 62c8c4bf268337c2bf0b631f37dc4a018dc9f365c8f35400c38b3afd4fc29a23
---
...
# 
	...
	](https://huggingface.co#introducing-the-open-arabic-llm-leaderboard)
	
		Introducing the Open Arabic LLM Leaderboard
	

 [Update on GitHub](https://github.com/huggingface/blog/blob/main/leaderboard-arabic.md)

[  Upvote 104 ](https://huggingface.co/login?next=%2Fblog%2Fleaderboard-arabic)
...
![2A2I's avatar](https://cdn-avatars.huggingface.co/v1/production/uploads/626237d9bbcbd1c34f1bb231/Y6wf-wqs4UgTcYL50_Uye.png)

[2A2I](https://huggingface.co/2A2I)

[Hamza AlobeidliHamza-Alobeidli    ](https://huggingface.co/Hamza-Alobeidli)

![Technology Innovation Institute's avatar](https://cdn-avatars.huggingface.co/v1/production/uploads/61a8d1aac664736898ffc84f/AT6cAB5ZNwCcqFMal71WD.jpeg)

[tiiuae](https://huggingface.co/tiiuae)

![Ruxandra Cojocaru's avatar](https://cdn-avatars.huggingface.co/v1/production/uploads/6460bc5a933afb0106a7b31c/ps-YRqNufnVi_lP7CL05-.jpeg) 

  [Ruxandra Cojocarurcojocaru    ](https://huggingface.co/rcojocaru)

![Technology Innovation Institute's avatar](https://cdn-avatars.huggingface.co/v1/production/uploads/61a8d1aac664736898ffc84f/AT6cAB5ZNwCcqFMal71WD.jpeg)

[tiiuae](https://huggingface.co/tiiuae)

[Basma Boussahabasma-b    ](https://huggingface.co/basma-b)
...
## 
	...
	](https://huggingface.co#benchmarks-metrics--technical-setup)
...
### 
	...
	](https://huggingface.co#benchmark-datasets)
...
- front- and back-ends inspired by the `demo-leaderboard`
...
## 
	...
	](https://huggingface.co#submit-your-model-)
...
### 
	...
	](https://huggingface.co#model-submission-process)
...
- **Pre-Submission Checks:**- **Load Model and Tokenizer:**Confirm that your model and tokenizer can be successfully loaded using AutoClasses. Use the following commands:- `from transformers import AutoConfig, AutoModel, AutoTokenizer config = AutoConfig.from_pretrained("your model name", revision=revision) model = AutoModel.from_pretrained("your model name", revision=revision) tokenizer = AutoTokenizer.from_pretrained("your model name", revision=revision)`- If you encounter errors, address them by following the error messages to ensure your model has been correctly uploaded. 
...
- **Convert Model Weights to Safetensors:**- Convert your model weights to safetensors, a safer and faster format for loading and using weights. This conversion also enables the inclusion of the model's parameter count in the `Extended Viewer`.
...
- **License and Model Card:**- **Open License:**Verify that your model is openly licensed. This leaderboard promotes the accessibility of open LLMs to ensure widespread usability.
...
### 
	...
	](https://huggingface.co#in-case-of-model-failure)
...
## 
	...
	](https://huggingface.co#citations-and-references)
