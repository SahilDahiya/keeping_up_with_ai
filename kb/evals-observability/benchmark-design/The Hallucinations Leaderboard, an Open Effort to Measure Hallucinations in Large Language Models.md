...
secondary_topics: []
summary: The Hallucinations Leaderboard scores LLMs across in-context-learning tasks
  split into factuality (contradicting real-world facts) and faithfulness (contradicting
  the given context/instruction) hallucinations, spanning QA, summarization, fact-checking
  and self-consistency tasks.
triage: null
skip_reason: null
source: huggingface
url: https://huggingface.co/blog/leaderboard-hallucinations
author: Pasquale Minervini; Ping Nie; Clémentine Fourrier; Rohit Saxena; Aryo Pradipta
  Gema; Xuanli He
published: '2024-01-29'
fetched: '2026-07-14T22:20:20Z'
classifier: claude
taxonomy_rev: 1
words: 2694
content_sha256: 4decfff4bc543f60d56f403df62e632096b4eb7d32d4a6230484af4020ab1396
---

# The Hallucinations Leaderboard, an Open Effort to Measure Hallucinations in Large Language Models

Viewer • Updated  •  227k •  18.4k  •  148  

# 
	[
		
	](https://huggingface.co#the-hallucinations-leaderboard-an-open-effort-to-measure-hallucinations-in-large-language-models)
	
		The Hallucinations Leaderboard, an Open Effort to Measure Hallucinations in Large Language Models
	

 [Update on GitHub](https://github.com/huggingface/blog/blob/main/leaderboard-hallucinations.md)

[  Upvote 38 ](https://huggingface.co/login?next=%2Fblog%2Fleaderboard-hallucinations)

![Pasquale Minervini's avatar](https://cdn-avatars.huggingface.co/v1/production/uploads/61001311e043e15c13412d30/6yAbTweYR16XtxMBEyOWl.png) 

  [Ping Niepingnieuk    ](https://huggingface.co/pingnieuk)

![Clémentine Fourrier's avatar](https://cdn-avatars.huggingface.co/v1/production/uploads/1644340617257-noauth.png) 

  [Rohit Saxenarohitsaxena    ](https://huggingface.co/rohitsaxena)

[Xuanli Hezodiache    ](https://huggingface.co/zodiache)
...
## 
	...
	](https://huggingface.co#what-are-hallucinations)
...
## 
	...
	](https://huggingface.co#the-hallucinations-leaderboard)
	
		The Hallucinations Leaderboard
	

The ** Hallucinations Leaderboard** evaluates LLMs on an array of hallucination-related benchmarks. The leaderboard leverages the 
...
[Leaderboard Template](https://huggingface.co/demo-leaderboard-backend). Experiments are conducted mainly on the

[Edinburgh International Data Facility (EIDF)](https://edinburgh-international-data-facility.ed.ac.uk/)and on the internal clusters of the

[School of Informatics, University of Edinburgh](https://www.ed.ac.uk/informatics/), on NVIDIA A100-40GB and A100-80GB GPUs.
...
## 
	...
	](https://huggingface.co#a-glance-at-the-results-so-far)
...
### 
	...
	](https://huggingface.co#closed-book-open-domain-question-answering)
...
### 
	...
	](https://huggingface.co#instruction-following)
...
### 
	...
	](https://huggingface.co#summarisation)
...
### 
	...
	](https://huggingface.co#reading-comprehension)
...
### 
	...
	](https://huggingface.co#hallucination-detection)
...
## 
	...
	](https://huggingface.co#wrapping-up)
