...
author: Eric Bezzam; Shobhit Banga; Manas Dhir; Bhaskar Singh; Manmeet Kaur; Aaditya
...
[Automatic Speech Recognition •  3B • Updated   •  208k  •  55](https://huggingface.co/ibm-granite/granite-speech-3.3-2b)  
...
These four sets are part of Monsoon, Voice Arena's broader dataset initiative for the Global South.
 ...
 Audio-Text-to-Text •  8B • Updated   •  72.2k  •  176 

  5B • Updated   •  536k  •  673 

 Automatic Speech Recognition •  0.8B • Updated   •  7.04M  •  3.27k 

 Viewer • Updated  •  2.1k •  100  •  1 

 Viewer • Updated  •  753 •  55  •  1 

🏆

 1.44k

Explore and compare speech‑recognition models by WER and speed
