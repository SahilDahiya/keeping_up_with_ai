...
summary: Digital Green's agricultural advisory RAG chatbot for smallholder farmers
  adds an LLM-as-a-Judge evaluation loop, with judge prompt/criteria design and human-alignment
  checks used to iterate on retrieval and answer quality.
triage: null
skip_reason: null
source: huggingface
...
fetched: '2026-07-14T22:04:03Z'
classifier: claude
taxonomy_rev: 1
words: 2211
content_sha256: f085fd0bb0ed95a6614aac1842d200c18913b8384033e4c0a193f22cb269d6ba
---

# Expert Support case study: Bolstering a RAG app with LLM-as-a-Judge

Paper • 2409.08916 • Published  •  5 

# 
	[
		
	](https://huggingface.co#expert-support-case-study-bolstering-a-rag-app-with-llm-as-a-judge)
	
		Expert Support case study: Bolstering a RAG app with LLM-as-a-Judge
	

 [Update on GitHub](https://github.com/huggingface/blog/blob/main/digital-green-llm-judge.md)

[  Upvote 30 ](https://huggingface.co/login?next=%2Fblog%2Fdigital-green-llm-judge)

![Vineet Singh's avatar](https://cdn-avatars.huggingface.co/v1/production/uploads/64f708c57a4a5902e2ece8e9/18N5A8pl8x93Ix2Xcf_No.jpeg) 

  [Vineet SinghVinsingh    ](https://huggingface.co/Vinsingh)

![Digital Green's avatar](https://cdn-avatars.huggingface.co/v1/production/uploads/64f708c57a4a5902e2ece8e9/rQASgOhrKD2Nge5dHr_ex.png)

[DigiGreen](https://huggingface.co/DigiGreen)

[Rajsekar Manokaranrajgreen    ](https://huggingface.co/rajgreen)
...
![Aymeric Roucher's avatar](https://cdn-avatars.huggingface.co/v1/production/uploads/63d10d4e8eaa4831005e92b5/7p7-OmWM6PqqCs7ZStPGD.jpeg) 
  ...
  This is a guest blog post authored by[Digital Green](https://huggingface.co/DigiGreen). Digital green is participating in a[CGIAR](https://huggingface.co/CGIAR)-led collaboration to bring agricultural support to smallholder farmers.
...
## 
	...
	](https://huggingface.co#system-architecture)
	
		System architecture
	

    ![System architecture](https://miro.medium.com/v2/resize:fit:4800/format:webp/1*L8epmSjWRweoVhQoLlAbuQ.png) 
...
- **Knowledge base:**- Preprocessing: The first step was to ingest the pdf documents into the Farmer.chat pipeline with the help of APIs maintained by [Scio](https://scio.systems/). The in the knowledge base, topics were auto categorized for relevant geographic areas and semantically grouped together.
...
- Preprocessing: The first step was to ingest the pdf documents into the Farmer.chat pipeline with the help of APIs maintained by 
- **RAG pipeline:**It is what ensures that the information delivered is grounded in the content and not outside. It consists in two parts:- Information retrieval: Searching the knowledge base for relevant information that matches the user’s query. This involves calling the vector database API created in knowledge base builder to get necessary text chunks.
...
- **User-facing Agent:**The planning agent leverages GPT-4o under the hood.- Its task is to:  - Understand the user intent
...
- The agent runs a ReAct based prompt to think in step by step manner and call the respective tools and analyze the responses. Then it can leverage its tools to answer: Currently, the agent uses the following set of tools:  - Converse more
- RAG QA endpoint
...
## 
	...
	](https://huggingface.co#the-power-of-llms-as-judges)
...
## 
	...
	](https://huggingface.co#results-benchmarking-llms-for-rag)
...
The results were published recently in [this scientific article](https://huggingface.co/papers/2409.08916), focusing on the quantitative study of user research.
    ...
    ![System demo](https://cdn.prod.website-files.com/659d11eefb40654676991482/65e612f59aa42d0216e15236_Map%20and%20data%20(3).gif) 


If you are interested in the Hugging Face Expert Support program for your company, don't hesitate to contact us

[here](https://huggingface.co/contact/sales?from=support)- our sales team will get in touch to discuss your needs!
