...
secondary_topics:
- models/benchmarks
summary: HELMET is a long-context benchmark spanning 7 application-centric categories
  (RAG, passage re-ranking, many-shot ICL, long-doc QA, summarization, cite/attribution)
  up to 128K tokens, built because synthetic probes like needle-in-a-haystack correlate
  poorly with real downstream long-context ability. Reports rankings that shift by
  category and shows open models lag closed ones most on tasks requiring full-context
  reasoning.
triage: null
skip_reason: null
source: huggingface
url: https://huggingface.co/blog/helmet
author: Howard Yen; Tianyu Gao; Minmin Hou; Ke Ding; Daniel Fleischer; Moshe Wasserblat;
  Danqi Chen
published: '2025-04-16'
fetched: '2026-07-14T22:09:05Z'
classifier: claude
taxonomy_rev: 1
words: 2191
content_sha256: c011a8ee5a35029e1ccf12d07ec00098dc988fbd28c0af1aaa130ca3bc49e780
---
...
# 
 ...
 [Update on GitHub](https://github.com/huggingface/blog/blob/main/helmet.md)

[  Upvote 42 ](https://huggingface.co/login?next=%2Fblog%2Fhelmet)

![Howard Yen's avatar](https://cdn-avatars.huggingface.co/v1/production/uploads/64261b91c71d90951ea50363/d64ZPCZrA5SezPXL4Pbbi.png) 

  [Howard Yenhyen    ](https://huggingface.co/hyen)

![Princeton NLP group's avatar](https://cdn-avatars.huggingface.co/v1/production/uploads/1618969698200-noauth.png)

[princeton-nlp](https://huggingface.co/princeton-nlp)

[Tianyu Gaogaotianyu1350    ](https://huggingface.co/gaotianyu1350)

![Princeton NLP group's avatar](https://cdn-avatars.huggingface.co/v1/production/uploads/1618969698200-noauth.png)

[princeton-nlp](https://huggingface.co/princeton-nlp)

[Minmin Houhouminmin    ](https://huggingface.co/houminmin)
...
[Ke Dingkding1    ](https://huggingface.co/kding1)

![Intel's avatar](https://cdn-avatars.huggingface.co/v1/production/uploads/1616186257611-60104afcc75e19ac1738fe70.png)

[Intel](https://huggingface.co/Intel)

![Daniel Fleischer's avatar](https://cdn-avatars.huggingface.co/v1/production/uploads/62d93cd728f9c86a4031562e/ix_LD-wjW8vCltosCVUmV.jpeg) 

  [Daniel Fleischerdanf    ](https://huggingface.co/danf)
...
[Danqi Chencdq10131    ](https://huggingface.co/cdq10131)

![Princeton NLP group's avatar](https://cdn-avatars.huggingface.co/v1/production/uploads/1618969698200-noauth.png)

[princeton-nlp](https://huggingface.co/princeton-nlp)

[hyen@cs.princeton.edu](mailto:hyen@cs.princeton.edu)

Paper:

[https://arxiv.org/abs/2410.02694](https://arxiv.org/abs/2410.02694)
...
[https://github.com/princeton-nlp/HELMET](https://github.com/princeton-nlp/HELMET)
...
## 
	...
	](https://huggingface.co#evaluating-long-context-language-models-is-challenging-but-important)
...
![logo](https://huggingface.co/blog/assets/helmet/teaser.png) 
...
## 
	...
	](https://huggingface.co#existing-evaluations-overly-rely-on-synthetic-tasks)
...
![logo](https://huggingface.co/blog/assets/helmet/model_eval_comparison.png) 
...
![syn](https://huggingface.co/blog/assets/helmet/correlation_syn.png) 
...
## 
	...
	](https://huggingface.co#crafting-diverse-controllable-and-reliable-evaluation-for-lclms)
...
![logo](https://huggingface.co/blog/assets/helmet/data_summary.png) 

  ### 
	[
		
	](https://huggingface.co#key-improvements-over-existing-benchmarks)
...
* Reliable evaluation*: Many existing benchmarks still use n-gram-based metrics, such as ROUGE, despite their poor correlation with human judgments (

[Goyal et al., 2023](https://arxiv.org/abs/2209.12356)). We employ model-based evaluations that show better distinguishability between models and different input lengths (Figure 3). Furthermore, our human studies show that our metrics have a high agreement with human judgments.

![logo](https://huggingface.co/blog/assets/helmet/model_eval.png) 
...
## 
	...
	](https://huggingface.co#lclms-still-have-a-long-way-to-go-on-real-world-tasks)
...
### 
	...
	](https://huggingface.co#diverse-evaluation-is-needed-for-assessing-long-context-abilities)
...
![syn](https://huggingface.co/blog/assets/helmet/correlation_category_inst.png) 
...
### 
	...
	](https://huggingface.co#models-degrade-with-increasing-lengths-and-task-complexity)
...
![syn](https://huggingface.co/blog/assets/helmet/results_length_main.png) 
...
## 
	...
	](https://huggingface.co#using-helmet-for-future-developments)
...
### 
	...
	](https://huggingface.co#how-to-run-helmet)
...
#### 
	...
	](https://huggingface.co#option-1-using-huggingfaces-transformers-library)
...
#### 
	...
	](https://huggingface.co#option-2-using-huggingfaces-tgi)
...
#### 
	...
	](https://huggingface.co#option-3-using-huggingfaces-inference-endpoints)
...
#### 
	...
	](https://huggingface.co#option-4-using-vllm)
...
#### 
	...
	](https://huggingface.co#option-5-using-model-providers-apis)
...
### 
	...
	](https://huggingface.co#faster-development)
...
### 
	...
	](https://huggingface.co#quick-comparison-with-existing-models)
