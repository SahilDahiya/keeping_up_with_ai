...
subtopic: evaluation
secondary_topics: []
summary: Patronus AI's Enterprise Scenarios Leaderboard evaluates LLMs on six real-world
  enterprise tasks — FinanceBench, Legal Confidentiality, Creative Writing, Customer
  Support Dialogue, Toxicity and Enterprise PII — with metrics like accuracy, engagingness,
  toxicity and PII leakage, arguing academic benchmarks miss enterprise failure modes.
triage: null
skip_reason: null
source: huggingface
url: https://huggingface.co/blog/leaderboard-patronus
author: Selvan Sunitha Ravi; Rebecca Qian; Anand Kannappan; Clémentine Fourrier
published: '2024-01-31'
fetched: '2026-07-14T22:20:14Z'
classifier: claude
taxonomy_rev: 1
words: 1283
content_sha256: 351e420778e7aad9bd2b05509bf369f5fe88f49dd39e76d3d342b1757497340a
---
...
# 
	...
	](https://huggingface.co#introducing-the-enterprise-scenarios-leaderboard-a-leaderboard-for-real-world-use-cases)
	
		Introducing the Enterprise Scenarios Leaderboard: a Leaderboard for Real World Use Cases
	

 [Update on GitHub](https://github.com/huggingface/blog/blob/main/leaderboard-patronus.md)

[  Upvote 3 ](https://huggingface.co/login?next=%2Fblog%2Fleaderboard-patronus)

![Selvan Sunitha Ravi's avatar](https://cdn-avatars.huggingface.co/v1/production/uploads/631f35b6e488fcef857cdbda/XZsR6bfelyUX32-T8UTtu.jpeg) 

  ![Rebecca Qian's avatar](https://cdn-avatars.huggingface.co/v1/production/uploads/1670593076071-noauth.jpeg) 

  [Rebecca Qianrebeccaqian    ](https://huggingface.co/rebeccaqian)

![Anand Kannappan's avatar](https://cdn-avatars.huggingface.co/v1/production/uploads/64800401dd29d0de8121fa3d/jQyJeDW1-NsX5sd1tsRjF.jpeg) 

  ![Clémentine Fourrier's avatar](https://cdn-avatars.huggingface.co/v1/production/uploads/1644340617257-noauth.png) 

  [Enterprise Scenarios Leaderboard](https://huggingface.co/spaces/PatronusAI/leaderboard), built using the Hugging Face

[Leaderboard Template](https://huggingface.co/demo-leaderboard-backend)in collaboration with their teams.
...
## 
	...
	](https://huggingface.co#why-do-we-need-a-leaderboard-for-real-world-use-cases)
...
## 
	...
	](https://huggingface.co#our-tasks)
...
- **Legal Confidentiality**: We use a subset of 100 labeled prompts from- [LegalBench](https://arxiv.org/abs/2308.11462)to measure the ability of LLMs to reason over legal causes. We use few shot prompting and ask the model to respond with a yes/no. We measure the exact match accuracy of the generated output with labels for Legal Confidentiality. Example:
...
- **Creative Writing**: We use 100 prompts to evaluate the story-writing and creative abilities of the LLM. The dataset is a mix of human annotated samples from the reddit community- `r/WritingPrompts`, and red-teaming generations. We measure the engagingness of the text generated by the LLM, using the- [EnDEX model](https://aclanthology.org/2022.findings-emnlp.359/), trained on an 80k Reddit-based engagement dataset to evaluate whether the text generated for Writing Prompts is engaging or not. Example:
...
- **Enterprise PII**: We use 100 prompts from- [EnterprisePII](https://www.patronus.ai/announcements/patronus-ai-launches-enterprisepii-the-industrys-first-llm-dataset-for-detecting-business-sensitive-information)to evaluate the business safety of the model by using prompts to elicit business-sensitive information from LLMs. If the model generates any business sensitive information, including performance reports of employees, it is marked as a failure. We use a classifier trained on 3000 labeled examples of enterprise-PII to evaluate the generated output. Example:
...
## 
	...
	](https://huggingface.co#submitting-to-the-leaderboard)
...
## 
	...
	](https://huggingface.co#how-to-view-your-results-on-the-validation-set)
