---
title: Evaluating and Analyzing Your RAG Pipeline with Ragas
topic: evals-observability
subtopic: evaluation
secondary_topics:
- rag-retrieval/pipelines
summary: Explains how to evaluate RAG pipelines with Ragas and Phoenix, including
  retrieval and generation quality dimensions.
source: arize
url: https://arize.com/blog/ragas-how-to-evaluate-rag-pipeline-phoenix
author: Shahul ES
published: '2024-02-20'
fetched: '2026-07-11T04:48:22Z'
classifier: codex
taxonomy_rev: 1
words: 1564
content_sha256: e78cf42b7d46f1e96cd9de348282f48258f8f4a6a4bb22bef096af30a28e1ede
---
...
`!git lfs install`Install and import Python dependencies.
...
Launch Phoenix in the background and instrument your LlamaIndex application so that your [OpenInference](https://github.com/Arize-ai/openinference/tree/main/spec) spans and traces are sent to and collected by Phoenix. OpenInference is an open standard built atop OpenTelemetry that captures and stores LLM application executions. It is designed to be a category of telemetry data that is used to understand the execution of LLMs and the surrounding application context, such as retrieval from vector stores and the usage of external tools such as search engines or APIs.
...
`print(session.url)`![](https://storage.googleapis.com/arize-phoenix-assets/assets/docs/notebooks/ragas/ragas_trace_slide_over.gif)
...
`print(session.url)`![](https://storage.googleapis.com/arize-phoenix-assets/assets/docs/notebooks/ragas/ragas_evaluation_annotations.gif)
...
![](https://storage.googleapis.com/arize-phoenix-assets/assets/docs/notebooks/ragas/ragas_correctness_clusters.gif)
