...
- models/benchmarks
- infra-platform/cost
summary: Describes predictive human preference for model ranking and model routing,
  using preference models and evaluations to choose among LLMs by quality, cost, and
  latency.
source: chip-huyen
url: https://huyenchip.com/2024/02/28/predictive-human-preference.html
author: Chip Huyen
published: '2024-02-28'
fetched: '2026-07-11T05:08:56Z'
classifier: codex
taxonomy_rev: 1
words: 2656
content_sha256: 34320a11d55eefcfa7337c50334bc92dabb7556f53849ee417bb1d398577e909
---
...
![Predictive human preference for all LLM model pairs](https://huyenchip.com/assets/pics/predictive-preference/1-cluster.png)
...
![Predictive human preference for all LLM model pairs](https://huyenchip.com/assets/pics/predictive-preference/2-chatgpt.png)
...
![Predictive human preference for all LLM model pairs](https://huyenchip.com/assets/pics/predictive-preference/3-bradley-terry.png)
...
| All matches | model_a winsmodel_b winstie
 | 3,300 | 53.33% |
| Non-tie matches | model_a winsmodel_b wins
 | 2,367 | 74.1% |
| Non-tie matches involving GPT-4 | model_a winsmodel_b wins
...
![Predictive human preference for all LLM model pairs](https://huyenchip.com/assets/pics/predictive-preference/4-preference-predictor.png)
...
![Predictive human preference for all LLM model pairs](https://huyenchip.com/assets/pics/predictive-preference/5-predictive-preference-architecture.png)
...
![Predictive human preference for all LLM model pairs](https://huyenchip.com/assets/pics/predictive-preference/6-model-pairs.png)
...
![Predictive human preference for all LLM model pairs](https://huyenchip.com/assets/pics/predictive-preference/7-derive.png)
...
![Predictive human preference for all LLM model pairs](https://huyenchip.com/assets/pics/predictive-preference/8-easy-hard-prompts.png)
...
![Predictive human preference for all LLM model pairs](https://huyenchip.com/assets/pics/predictive-preference/10-ranking.png)
...
![Predictive human preference for all LLM model pairs](https://huyenchip.com/assets/pics/predictive-preference/9-russian.png)
