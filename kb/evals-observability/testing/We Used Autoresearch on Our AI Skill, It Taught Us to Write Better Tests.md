---
title: We Used Autoresearch on Our AI Skill, It Taught Us to Write Better Tests
topic: evals-observability
subtopic: testing
secondary_topics:
- agents/tool-use
summary: Case study of using Autoresearch to improve an AI skill, with emphasis on
  writing better tests and using research-agent output to harden behavior.
source: langfuse
url: https://langfuse.com/blog/2026-03-24-optimizing-ai-skill-with-autoresearch
author: Tobi Lutke · Follow
published: '2026-03-24'
fetched: '2026-07-11T04:36:18Z'
classifier: codex
taxonomy_rev: 1
words: 2847
content_sha256: 6eac77ca4e002f5f47e8360cba5f9729870c4c983c072165ede60e1544c5a465
---

# We Used Autoresearch on Our AI Skill, It Taught Us to Write Better Tests

![tobi lutke](https://pbs.twimg.com/profile_images/1999293930936909824/_HWYanot_normal.jpg)
...
March 24, 2026# We Used Autoresearch on Our AI Skill, It Taught Us to Write Better Tests
...
![Autoresearch loop](https://langfuse.com/_next/image?url=%2Fimages%2Fblog%2F2026-03-24-optimizing-ai-skill-with-autoresearch%2Fautoresearch-loop.png&w=3840&q=75)
...
`score = (correctness * 0.5) + (completeness * 0.3) + (efficiency * 0.2)`- **Correctness**is determined using static code checks: original prompts removed,- `get_prompt()`and- `.compile()`present,- `label="production"`used, prompts created in Langfuse with correct content,- `{{var}}`syntax, correct type
...
![Score progression across 14 autoresearch experiments](https://langfuse.com/_next/image?url=%2Fimages%2Fblog%2F2026-03-24-optimizing-ai-skill-with-autoresearch%2Fscore-progression.png&w=3840&q=75)
...
![Doc fetching diff](https://langfuse.com/_next/image?url=%2Fimages%2Fblog%2F2026-03-24-optimizing-ai-skill-with-autoresearch%2Fdoc-fetching-diff.png&w=3840&q=75)
...
- **Spend enough time on the setup**to get the harness and target function right. As the- [community around autoresearch has noted](https://github.com/karpathy/autoresearch/issues/22), the human job moves from "can you implement this?" to "can you write a good program.md that produces useful research?"
- **Let it run**
