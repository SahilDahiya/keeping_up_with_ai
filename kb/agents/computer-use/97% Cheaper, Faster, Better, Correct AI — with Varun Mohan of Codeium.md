...
- Blogpost: - [Are GPUs Worth it for ML](https://exafunction.com/blog/are-gpus-worth-it)

- Copilot for X
- Scaling Laws - [Training Compute-Optimal Large Language Models - arXiv](https://arxiv.org/abs/2203.15556)(Chinchilla paper)
- [chinchilla's wild implications](https://www.lesswrong.com/posts/6Fpvch8RR29qLEWNH/chinchilla-s-wild-implications)(LessWrong)

- Paper - - [Deepmind Retro](https://www.deepmind.com/publications/improving-language-models-by-retrieving-from-trillions-of-tokens)
- [HumanEval benchmark](https://github.com/openai/human-eval)/dataset
- [NVIDIA H100 specs](https://www.nvidia.com/en-us/data-center/h100/)- 3TB/s GPU memory, 900GB/s NVLink Interconnect
- Optimizer state is 14x size of model - 175B params => 2.5TB to store state → needs at least 30 H100 machines with 80GB each

**Lightning Rounds**

- Favorite AI Product: - [Midjourney](https://midjourney.com/)
