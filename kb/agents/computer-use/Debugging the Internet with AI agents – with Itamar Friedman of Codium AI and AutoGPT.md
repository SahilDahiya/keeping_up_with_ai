---
title: Debugging the Internet with AI agents – with Itamar Friedman of Codium AI and
  AutoGPT
topic: agents
subtopic: computer-use
secondary_topics:
- evals-observability/testing
summary: Interview on debugging the internet with AI agents, Codium AI, and AutoGPT-style
  agent workflows.
source: latent-space
url: https://www.latent.space/p/codium-agents
author: Itamar Friedman
published: '2023-05-25'
fetched: '2026-07-11T05:23:06Z'
classifier: codex
taxonomy_rev: 1
words: 13062
content_sha256: 759f76cec3b19d3acac5833299ff7a328bf653f0bcab3880648e951c362c1196
---
...
- Then we attended - [Agent Weekend](https://www.youtube.com/watch?v=xFL_WtISd4k), where the founders of multiple AI/agent projects- [1](https://www.latent.space#footnote-1)got together with a presentation from Toran Bruce Richards on Auto-GPT’s roadmap and then from Itamar on Codium’s roadmap
- Then some of us stayed to take part in the NextGen Hackathon and - [won first place](https://twitter.com/bemyapp/status/1661184420588539907?s=20)with the new- [AI Maintainer](https://youtu.be/WE3UmpkMa3s)project.

So… that makes it really hard to recap everything for you. But we’ll try!

## Podcast: Codium: Code Integrity with Zero Bugs

When it launched in **2021**, there was [a](https://news.ycombinator.com/item?id=27678885) [lot](https://news.ycombinator.com/item?id=27680715) [of](https://news.ycombinator.com/item?id=27678603) [skepticism](https://news.ycombinator.com/item?id=27678728) around Github Copilot.

Fast forward to **2023**, and 40% of all code is checked in unmodified from Copilot[2](https://www.latent.space#footnote-2).

Codium[3](https://www.latent.space#footnote-3) burst on the scene this year, emerging from stealth with an [$11m seed](https://www.codium.ai/blog/codiumai-powered-by-testgpt-accounces-beta-and-raised-11m/), their own foundation model (TestGPT-1) and a vision to revolutionize coding by **2025**.
...
![](https://substackcdn.com/image/fetch/$s_!bkOY!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Ffc075487-fa6b-47bf-b2b3-2b93c21aa452_1786x1006.png)
...
- AutoGPT was released on GitHub in March 2023, and - [went viral on April 1](https://twitter.com/SigGravitas/status/1642181498278408193?s=20)with a video showing automatic code generation.- **2 months later it has 132k+ stars**, is the- **29th highest ranked open-source project of all-time**, a thriving community of 37.5k+ Discord members, 1M+ downloads.
- **What’s next for AutoGPT?**The initial release required users to know how to build and run a codebase. They- [recently announced plans](https://news.agpt.co/development/gui-coming-open-source-vs-closed/)for a web/desktop UI and mobile app to enable nontechnical/everyday users to use AutoGPT. They are also working on an extensible plugin ecosystem called the- **Abilities Hub**also targeted at nontechnical users.
- **Improving Efficacy**. AutoGPT has many well documented cases where it trips up. Getting stuck in loops, using <placeholders> instead of actual content in- commands, and making obvious mistakes like - `execute_code("write`- `a cookbook"'`. The plan is a new design called- **Challenge Driven Development**- Challenges are goal-orientated tasks or problems that- Auto-GPT has difficulty solving or has not yet been able to accomplish. These may include improving specific functionalities, enhancing the model's understanding of specific domains, or even developing new features that the current version of Auto-GPT lacks. (AI Maintainer was born out of one such challenge). Itamar compared this with Software 1.0 (Test Driven Development), and Software 2.0 (Dataset Driven Development).
- **Self-Improvement**. Auto-GPT will analyze its own codebase and contribute to its own improvement. AI Safety (aka- [not-kill-everyone-ists](https://twitter.com/AISafetyMemes/status/1653429652252131333?s=20)) people like- [Connor Leahy](https://www.youtube.com/watch?v=tYGMfd3_D1o&pp=ygUMY29ubm9yIGxlYWh5)might freak out at this, but for what it’s worth we were pleasantly surprised to learn that Itamar and many other folks on the Auto-GPT team are equally concerned and mindful about x-risk as well.
...
![](https://substackcdn.com/image/fetch/$s_!mX8l!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F3323eb52-db1f-456b-9f48-e10c6374e23c_2110x1304.png)

## Transcript

**Alessio:** [00:00:00] Hey everyone. Welcome to the Latent Space podcast. This is Alessio, Partner and CTO-in-Residence at [Decibel Partners](https://decibel.vc/). I'm joined by my co-host, Swyx, writer and editor of Latent Space.
...
**Itamar:** **O**ne thing I didn't share with you is like, when you say virality, there is like inter virality and intra virality. Okay. Like within the company and outside the company. So which teams are using us? I can't say, but I can tell you that a lot of San Francisco companies are using us.
...
AutoGPT, Codium, E2B, Roboflow, Brev, Ben’s Bites, and smol! It was a stacked room.

![](https://substackcdn.com/image/fetch/$s_!DfC6!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fbbc11efc-f34a-4080-a536-477f13a11759_2208x1132.png)
