...
summary: Benchmarks single-agent ReAct-style performance and discusses evaluation
  methodology for agent reasoning/tool-use loops.
source: langchain
url: https://www.langchain.com/blog/react-agent-benchmarking
author: The LangChain Team
published: '2025-02-10'
fetched: '2026-07-11T04:37:52Z'
classifier: codex
taxonomy_rev: 1
words: 2920
content_sha256: 973cd3be7b92a1fb47b6a172bb2ef0def2847f34c01d3e7ae3f6101770d2fe00
---

# Benchmarking Single Agent Performance

![](https://cdn.prod.website-files.com/65c81e88c254bb0f97633a71/69cbadf31082f68faaec62ab_customer_support-2.png)
...
As we increase the number ofdomainsthat a ReAct agent is given, how does this affect the agent’s ability to perform tasks?
...
There are many [existing benchmarks](https://www.langchain.com/resources/llm-evaluation-benchmarks) for tool-use and tool-calling, but for the purposes of this experiment, we wanted to evaluate a practical agent that we actually use. This agent is our internal **Email Assistant**, which is responsible for two main **domains** of work - responding to and **scheduling** meeting requests, and **supporting customers** with their questions . In this study, we focus on evaluating **tasks** related to the above mentioned two domains. In more detail:

- **Calendar Scheduling Domain**- **Instructions:**Guidelines for when to schedule certain meetings with different parties and restrictions on meeting times.
- **Tools:**- `get_cal, schedule_cal`

- **Customer Support Domain**- **Instructions:**Guidelines for how to provide support to customers by fetching information, editing organization settings, etc.
...
![](https://cdn.prod.website-files.com/65c81e88c254bb0f97633a71/69cbadf51082f68faaec62dd_Screenshot-2025-02-10-at-8.41.50-AM.png)

![](https://cdn.prod.website-files.com/65c81e88c254bb0f97633a71/69cbadf51082f68faaec62cc_calendar_scheduling.png)
...
![](https://cdn.prod.website-files.com/65c81e88c254bb0f97633a71/69cbadf51082f68faaec62da_Screenshot-2025-02-10-at-8.42.58-AM.png)
...
![](https://cdn.prod.website-files.com/65c81e88c254bb0f97633a71/69cbadf51082f68faaec62cf_support_sonnet_traj.png)

![](https://cdn.prod.website-files.com/65c81e88c254bb0f97633a71/69cbadf51082f68faaec62d2_support_o1_traj.png)

![](https://cdn.prod.website-files.com/65c81e88c254bb0f97633a71/69cbadf51082f68faaec62e0_support_o3_mini_traj.png)
