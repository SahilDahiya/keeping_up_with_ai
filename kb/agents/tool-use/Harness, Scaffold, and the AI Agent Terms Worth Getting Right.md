...
summary: A working glossary that disentangles the overloaded agent vocabulary — model
  vs scaffolding vs harness vs agent, plus context engineering, policy, tool use,
  skills, sub-agents and orchestrators — using Claude Code, Codex and RL-environment
  framing as reference points. Defines 'harness engineering' (stop conditions, error
  handling, guardrails) and the eval-harness variant.
triage: null
skip_reason: null
source: huggingface
...
fetched: '2026-07-14T22:04:58Z'
classifier: claude
taxonomy_rev: 1
words: 2303
content_sha256: f473cf5f7d8528a800291d4f1c8ff7553864167d24804cf0c9b4966c58392298
---
...
- [Scaffolding](https://huggingface.co#scaffolding)
- [Harness](https://huggingface.co#harness)
- [Agent](https://huggingface.co#agent)
- [Context Engineering](https://huggingface.co#context-engineering)
- [Policy](https://huggingface.co#policy)
- [Tool Use](https://huggingface.co#tool-use)
- [Skills](https://huggingface.co#skills)
- [Sub-agents](https://huggingface.co#sub-agents)
- [Training](https://huggingface.co#training)
- [Learn More](https://huggingface.co#learn-more)
...
- +16
 ...
 June 8, 2026 guideroboticsreachy
