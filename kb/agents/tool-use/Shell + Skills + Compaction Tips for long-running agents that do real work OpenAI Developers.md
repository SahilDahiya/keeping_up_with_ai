...
summary: Nonobvious patterns for three new Responses API primitives for long-running
  ...
  internals and Glean's production use.
source: openai-devs
url: https://developers.openai.com/blog/skills-shell-tips/
author: null
published: '2026-02-11'
fetched: '2026-07-11T04:12:19Z'
classifier: claude
taxonomy_rev: 1
words: 1683
content_sha256: 4e72f97050b9101a1be6fc6e3f4bb7cc0a1e6e215d8d407fc1d49c2bb9ba6cf7
---
...
- Keep the org allowlist small and stable (the “approved destinations you trust” set).
- Keep request allowlists even smaller (the “destinations needed for this one job” set).
...
- Move to hosted containers when you want repeatability, isolation, and deployment consistency.
...
- Encode the workflow (steps, guardrails, templates) in a skill.
- Mount the skill into your shell environment.
- Have the agent follow the skill to produce artifacts deterministically.
