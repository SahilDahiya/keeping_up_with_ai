...
subtopic: tool-use
secondary_topics: []
summary: 'Introduces smolagents and argues for code agents: having the LLM write executable
  Python actions instead of emitting JSON tool calls yields fewer steps and better
  benchmark performance, since code composes, loops and reuses variables natively.
  Frames ''agency'' as a spectrum, and covers the sandboxed execution and multi-agent/managed-agent
  primitives in ~1,000 lines of library code.'
triage: null
skip_reason: null
source: huggingface
...
fetched: '2026-07-14T22:09:19Z'
classifier: claude
taxonomy_rev: 1
words: 1925
content_sha256: 799703bdd12c2cf4f83f50e13eec3b936e0cb85259f5af4ebe0ddde2a603519d
---

# Introducing smolagents: simple agents that write actions in code.

Viewer • Updated  •  142 •  52  •  11  

# 
	[
		
	](https://huggingface.co#introducing-smolagents-a-simple-library-to-build-agents)
	
		Introducing *smolagents*, a simple library to build agents
	

 [Update on GitHub](https://github.com/huggingface/blog/blob/main/smolagents.md)

[  Upvote 1203 ](https://huggingface.co/login?next=%2Fblog%2Fsmolagents)
...
![Aymeric Roucher's avatar](https://cdn-avatars.huggingface.co/v1/production/uploads/63d10d4e8eaa4831005e92b5/7p7-OmWM6PqqCs7ZStPGD.jpeg) 
  ...
  [, a very simple library that unlocks agentic capabilities for language models. Here’s a glimpse:](https://github.com/huggingface/smolagents)
...
- [🤔 What are agents?](https://huggingface.co#%F0%9F%A4%94-what-are-agents)
- [✅ When to use agents / ⛔ when to avoid them](https://huggingface.co#%E2%9C%85-when-to-use-agents--%E2%9B%94-when-to-avoid-them)
- [Code agents](https://huggingface.co#code-agents)
- [Introducing](https://huggingface.co#introducing-smolagents-making-agents-simple-%F0%9F%A5%B3)- *smolagents*: making agents simple 🥳
- [Next steps 🚀](https://huggingface.co#next-steps-%F0%9F%9A%80)

## 
	[
		
	](https://huggingface.co#🤔-what-are-agents)
...
## 
	...
	](https://huggingface.co#✅-when-to-use-agents--⛔-when-to-avoid-them)
...
## 
	...
	](https://huggingface.co#code-agents)
...
## 
	...
	](https://huggingface.co#introducing-smolagents-making-agents-simple-🥳)
...
- On top of this `CodeAgent``ToolCallingAgent`
...
[ smolagents](https://github.com/huggingface/smolagents) is the successor to 

[, and will be replacing it as](https://huggingface.co/blog/agents)

`transformers.agents`[gets deprecated in the future.](https://huggingface.co/blog/agents)

`transformers.agents`### 
	[
		
	](https://huggingface.co#building-an-agent)
...
### 
	...
	](https://huggingface.co#how-strong-are-open-models-for-agentic-workflows)
	
		How strong are open models for agentic workflows?
	

We've created [ CodeAgent](https://huggingface.co/docs/smolagents/reference/agents#smolagents.CodeAgent) instances with some leading models, and compared them on 

[this benchmark](https://huggingface.co/datasets/m-ric/agents_medium_benchmark_2)that gathers questions from a few different benchmarks to propose a varied blend of challenges.
...
- Read more on agents:- [This excellent blog post](https://www.anthropic.com/research/building-effective-agents)by Anthropic gives solid general knowledge.
