---
title: 'Emergency Pod: ChatGPT''s App Store Moment (w/ OpenAI''s Logan Kilpatrick,
  LindyAI''s Florent Crivello and Nader Dabit)'
topic: agents
subtopic: tool-use
secondary_topics:
- product-engineering/architecture
summary: Emergency pod on ChatGPT plugins as an app-store moment, covering tool ecosystems
  and agent product surfaces.
source: latent-space
url: https://www.latent.space/p/chatgpt-plugins
author: Alessio Fanelli; Latent Space
published: '2023-03-24'
fetched: '2026-07-11T05:23:40Z'
classifier: codex
taxonomy_rev: 1
words: 20226
content_sha256: 53034745e24d2396d03fa1bc7d108d9235aa5926cbee5e5d60f121bf75dd3b1f
---
...
The [ChatGPT Plugins announcement](https://openai.com/blog/chatgpt-plugins) today could be viewed as the launch of ChatGPT’s “App Store”, a moment as significant as when Apple opened its App Store for the iPhone in 2008[1](https://www.latent.space#footnote-1) or when Facebook let developers loose on its [Open Graph](https://www.wired.co.uk/article/facebook-cambridge-analytica-mark-zuckerberg-mission-data-privacy#:~:text=In%20April%202010%2C%20a%20fresh,to%20irreparably%20tarnish%20Facebook's%20reputation.) in 2010. With a dozen lines of simple JSON and a mostly-english prompt to help ChatGPT understand what the plugin does, developers will be able to add extensions to ChatGPT to get information and trigger actions in the real world.

OpenAI itself launched with some killer first party plugins for:

- [writing AND executing Python code](https://twitter.com/gdb/status/1638971232443076609?s=20)(in an- [effortlessly multimodal](https://lspace.swyx.io/p/multimodal-gpt4)way- [2](https://www.latent.space#footnote-2)),
- as well as 11 launch partner plugins from - [Expedia](https://twitter.com/ExpediaGroup/status/1638963397361545216)- [4](https://www.latent.space#footnote-4)to- [Milo](https://twitter.com/APatelThompson/status/1638974980594757632)to- [Zapier](https://twitter.com/wadefoster/status/1638958299935801344).
...
I immediately started [my first AI Twitter Space](https://twitter.com/swyx/status/1638976454485766145) to process this historical moment with Alessio and friends of the pod live. OpenAI’s Logan (see [Episode 1 from *last month*](https://www.latent.space/p/chatgpt-gpt4-hype-and-building-llm)…) suggested that you might be able to link ChatGPT up with Zapier triggers to do arbitrary tasks! and then Flo Crivello, who [just launched his AI Assistant startup Lindy](https://twitter.com/Altimor/status/1638571677490774017), joined us to discuss the builder perspective.
...
![X avatar for @amasad](https://substackcdn.com/image/fetch/$s_!TnFC!,w_40,h_40,c_fill,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack.com%2Fimg%2Favatars%2Fdefault-light.png)
...
Fun fact, [Steve Jobs first gave the idea](https://techcrunch.com/2020/01/02/the-story-of-why-marc-benioff-gifted-the-appstore-com-domain-to-steve-jobs/) to Marc Benioff, who then launched Salesforce AppExchange a full year before the Apple App Store.

[2](https://www.latent.space#footnote-anchor-2)

Andrew Mayne, OpenAI’s original Prompt Whisperer, has been tweeting more demos of this - the Python Interpreter can [make a chess library ](https://twitter.com/AndrewMayne/status/1638959855959683072)[that you can play](https://twitter.com/AndrewMayne/status/1638959855959683072)[, and then export as a GIF](https://twitter.com/AndrewMayne/status/1638959855959683072), [OCR an image and give you back a text file, create an audio file, QR Code, Calendar Invites, convert images to ASCII, create generative animation, simulate Pac-Man, the orbits of planets, and of course chess.](https://andrewmayneblog.wordpress.com/2023/03/23/chatgpt-code-interpreter-magic/).

[3](https://www.latent.space#footnote-anchor-3)

Led by [Isabella Fulford](https://twitter.com/OfficialLoganK/status/1638959530213011466). This works nicely with LangChain’s DocumentLoaders as well:

![X avatar for @hwchase17](https://substackcdn.com/image/fetch/$s_!TnFC!,w_40,h_40,c_fill,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack.com%2Fimg%2Favatars%2Fdefault-light.png)

![](https://substackcdn.com/image/fetch/$s_!Z0As!,w_64,h_64,c_fill,f_auto,q_auto:good,fl_progressive:steep,g_auto/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fddc7ae98-8a14-4ec2-9672-924079e76e5c_1280x640.png)

[4](https://www.latent.space#footnote-anchor-4)

Expedia source prompt here

![X avatar for @wskish](https://substackcdn.com/image/fetch/$s_!TnFC!,w_40,h_40,c_fill,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack.com%2Fimg%2Favatars%2Fdefault-light.png)

![](https://pbs.substack.com/media/Fr8VnZnaMAAeW84.jpg)
