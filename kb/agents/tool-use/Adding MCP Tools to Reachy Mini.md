...
subtopic: tool-use
secondary_topics: []
summary: Walks through how the Reachy Mini conversation app exposes tools to the LLM
  (move_head, dance, camera) and how remote MCP tools hosted as Gradio Spaces are
  added with one command, plus tool profiles that gate what the robot may call and
  the latency limits of the remote path.
triage: null
skip_reason: null
source: huggingface
...
fetched: '2026-07-14T22:04:56Z'
classifier: claude
taxonomy_rev: 1
words: 1981
content_sha256: b6efd0d55c0f7e41dca7480c2670b1ca7385bff9806b45c48cd00560a03fdf4e
---
...
MCP Space for Reachy Mini weather briefs.
...
guideroboticsaudio
 ...
 May 27, 2026 partnershipsnvidiarobotics

  67

 January 5, 2026 Great work on making Reachy even easier to customize!

How can I add these MCP tools on a wireless Reachy Mini with a preinstalled conversation app?
