...
secondary_topics:
- models/reasoning
summary: Fireworks' f1 is a 'compound AI' model that interleaves generation from multiple
  open models at the inference layer to handle complex reasoning via declarative prompting,
  aiming to match or exceed closed frontier models on coding, math, and reasoning
  benchmarks.
triage: null
skip_reason: null
source: fireworks
