...
summary: Works through the actual cost and latency math of running 1 billion text
  classifications with encoder models (gte-modernbert-base), comparing batch inference
  vs heavy-usage serving across hardware and optimizations (ONNX, TensorRT, quantization).
  Includes a reproducible encoder-analysis repo and per-configuration cost tables.
triage: null
skip_reason: null
source: huggingface
...
fetched: '2026-07-14T22:09:13Z'
classifier: claude
taxonomy_rev: 1
words: 3756
content_sha256: 31f713700e0158d380406693db93d69cfb5c6daf1c3a75af87eaf8a439faabd2
---

# 1 Billion Classifications

Sentence Similarity •  0.1B • Updated   •  144k  •  200  
...
- I don’t treat the results as exactly repeatable   - If you run the same test multiple times you will get slightly different results
...
- [DistilBERT](https://huggingface.co/docs/transformers/model_doc/distilbert)- Good task performance, Great Engineering performance
- It made some architectural changes from OG Bert and is not compatible for classification with TEI
 
- [DeBERTa-v3](https://huggingface.co/microsoft/deberta-v3-base)- Great task performance
- Very slow engineering performance†† as its unique attention mechanism is hard to optimize
 
- [ModernBERT](https://huggingface.co/blog/modernbert)- Uses Sequence Packing and Flash-Attention-2
...
- API Costs:  - Sending images over an API is slower than sending text.
...
- Look at more diverse datasets and see how that impacts the numbers
 ...
 Image-Text-to-Text •  2B • Updated   •  3.48M  •  514 

 Text Classification •  0.1B • Updated   •  773k  •  315 

 Fill-Mask •  Updated   •  2.66M  •  430 

 Visual Document Retrieval •  2B • Updated     •  19 

 Preview • Updated   •  1.38k  •  215 

 Viewer • Updated  •  52.9M •  493  •  9 

 Viewer • Updated  •  591k •  1.65k  •  55 

🐨

 3

A visualization for optimizing classification
...
hubapiapps
 ...
 August 22, 2024 guidellmnlp

  86

 February 16, 2024 infinity bussin [@michaelfeil](https://huggingface.co/michaelfeil)  
...
You showed you can damn write! Keep these coming! Very well written 😍

Thanks a bunch bro. Your words mean a lot!
